...
* [`2`, `2-scratch`, `2.4.1`, `2.4.1-scratch-r0`, `latest` (2/scratch/Dockerfile)](https://github.com/bitnami/bitnami-docker-kubeapps-apprepository-controller/blob/2.4.1-scratch-r0/2/scratch/Dockerfile)
