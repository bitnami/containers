...
* [`1-scratch`, `1.10.3-scratch-r0`, `1`, `1.10.3`, `latest` (1/scratch/Dockerfile)](https://github.com/bitnami/bitnami-docker-kubeapps-apprepository-controller/blob/1.10.3-scratch-r0/1/scratch/Dockerfile)
