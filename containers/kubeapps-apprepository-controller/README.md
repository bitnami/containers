...
* [`1-scratch`, `1.8.1-scratch-r0`, `1`, `1.8.1`, `1.8.1-r0`, `latest` (1/scratch/Dockerfile)](https://github.com/bitnami/bitnami-docker-kubeapps-apprepository-controller/blob/1.8.1/1/scratch/Dockerfile)
