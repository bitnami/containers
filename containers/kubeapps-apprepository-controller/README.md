...
* [`1-scratch`, `1.9.0-scratch-r0`, `1`, `1.9.0`, `latest` (1/scratch/Dockerfile)](https://github.com/bitnami/bitnami-docker-kubeapps-apprepository-controller/blob/1.9.0/1/scratch/Dockerfile)
