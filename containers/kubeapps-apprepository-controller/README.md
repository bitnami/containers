...
* [`2`, `2-scratch`, `2.0.0-beta.2`, `2.0.0-beta.2-scratch-r0` (2/scratch/Dockerfile)](https://github.com/bitnami/bitnami-docker-kubeapps-apprepository-controller/blob/2.0.0-beta.2-scratch-r0/2/scratch/Dockerfile)
