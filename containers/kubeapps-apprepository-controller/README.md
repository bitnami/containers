...
* [`1-scratch`, `1.8.0-scratch-r0`, `1`, `1.8.0`, `1.8.0-r0`, `latest` (1/scratch/Dockerfile)](https://github.com/bitnami/bitnami-docker-kubeapps-apprepository-controller/blob/1.8.0/1/scratch/Dockerfile)
