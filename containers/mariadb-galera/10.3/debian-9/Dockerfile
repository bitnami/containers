...
RUN . ./libcomponent.sh && component_unpack "mariadb-galera" "10.3.18-3" --checksum dfd91d61f7e5893092a549c40e8617b181f7eeb70084dba5089b79caa1541443
RUN mkdir /docker-entrypoint-initdb.d

COPY rootfs /
RUN /postunpack.sh
ENV BITNAMI_APP_NAME="mariadb-galera" \
    BITNAMI_IMAGE_VERSION="10.3.18-debian-9-r15" \
