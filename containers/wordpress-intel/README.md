...
- [`5`, `5-debian-10`, `5.9.3`, `5.9.3-debian-10-r27`, `latest` (5/debian-10/Dockerfile)](https://github.com/bitnami/bitnami-docker-wordpress/blob/5.9.3-debian-10-r27/5/debian-10/Dockerfile)
...
```console
$ docker build -t bitnami/wordpress-intel:latest 'https://github.com/bitnami/bitnami-docker-wordpress.git#master:5/debian-10'
```
