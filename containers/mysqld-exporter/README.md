...
* [`0-debian-9`, `0.12.1-debian-9-r14`, `0`, `0.12.1`, `0.12.1-r14`, `latest` (0/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-mysqld-exporter/blob/0.12.1-debian-9-r14/0/debian-9/Dockerfile)

* [`0-centos-7`, `0.12.1-centos-7-r11` (0/centos-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-mysqld-exporter/blob/0.12.1-centos-7-r11/0/centos-7/Dockerfile)
...
```bash
$ docker build -t bitnami/mysqld-exporter:latest https://github.com/bitnami/bitnami-docker-mysqld-exporter.git
```
