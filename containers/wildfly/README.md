...
* [`13`, `13.0.0-r1`, `latest` (13/Dockerfile)](https://github.com/bitnami/bitnami-docker-wildfly/blob/13.0.0-r1/13/Dockerfile)
...
* [`12`, `12.0.0-r41` (12/Dockerfile)](https://github.com/bitnami/bitnami-docker-wildfly/blob/12.0.0-r41/12/Dockerfile)
