...
* [`13`, `13.0.0-r3`, `latest` (13/Dockerfile)](https://github.com/bitnami/bitnami-docker-wildfly/blob/13.0.0-r3/13/Dockerfile)
...
* [`12`, `12.0.0-r42` (12/Dockerfile)](https://github.com/bitnami/bitnami-docker-wildfly/blob/12.0.0-r42/12/Dockerfile)
