...
* [`1`, `1-debian-11`, `1.4.0`, `1.4.0-debian-11-r11`, `latest` (1/debian-11/Dockerfile)](https://github.com/bitnami/bitnami-docker-prometheus-rsocket-proxy/blob/1.4.0-debian-11-r11/1/debian-11/Dockerfile)
...
```console
$ docker build -t bitnami/prometheus-rsocket-proxy:latest 'https://github.com/bitnami/bitnami-docker-prometheus-rsocket-proxy.git#master:1/debian-11'
```
