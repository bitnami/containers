...
* [`4-ol-7`, `4.0.0-ol-7-r110` (4/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-oauth2-proxy/blob/4.0.0-ol-7-r110/4/ol-7/Dockerfile)
* [`4-debian-9`, `4.0.0-debian-9-r94`, `4`, `4.0.0`, `4.0.0-r94`, `latest` (4/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-oauth2-proxy/blob/4.0.0-debian-9-r94/4/debian-9/Dockerfile)
...
```bash
$ docker build -t bitnami/oauth2-proxy:latest 'https://github.com/bitnami/bitnami-docker-oauth2-proxy.git#master:4/debian-9'
```
