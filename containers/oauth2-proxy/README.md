...
* [`2`, `2.2.0-r32`, `latest` (2/Dockerfile)](https://github.com/bitnami/bitnami-docker-oauth2-proxy/blob/2.2.0-r32/2/Dockerfile)
* [`2-ol-7`, `2.2.0-ol-7-r8` (2/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-oauth2-proxy/blob/2.2.0-ol-7-r8/2/ol-7/Dockerfile)
