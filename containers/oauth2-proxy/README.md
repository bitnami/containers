...
* [`7`, `7-debian-11`, `7.3.0`, `7.3.0-debian-11-r11`, `latest` (7/debian-11/Dockerfile)](https://github.com/bitnami/bitnami-docker-oauth2-proxy/blob/7.3.0-debian-11-r11/7/debian-11/Dockerfile)
...
```console
$ docker build -t bitnami/oauth2-proxy:latest 'https://github.com/bitnami/bitnami-docker-oauth2-proxy.git#master:7/debian-11'
```
