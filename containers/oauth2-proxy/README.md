...
* [`6`, `6-debian-10`, `6.1.1`, `6.1.1-debian-10-r118`, `latest` (6/debian-10/Dockerfile)](https://github.com/bitnami/bitnami-docker-oauth2-proxy/blob/6.1.1-debian-10-r118/6/debian-10/Dockerfile)
* [`5`, `5-debian-10`, `5.1.1`, `5.1.1-debian-10-r172` (5/debian-10/Dockerfile)](https://github.com/bitnami/bitnami-docker-oauth2-proxy/blob/5.1.1-debian-10-r172/5/debian-10/Dockerfile)
...
```console
$ docker build -t bitnami/oauth2-proxy:latest 'https://github.com/bitnami/bitnami-docker-oauth2-proxy.git#master:6/debian-10'
```
