...
* [`3-ol-7`, `3.2.0-ol-7-r68` (3/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-oauth2-proxy/blob/3.2.0-ol-7-r68/3/ol-7/Dockerfile)
* [`3-debian-9`, `3.2.0-debian-9-r67`, `3`, `3.2.0`, `3.2.0-r67`, `latest` (3/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-oauth2-proxy/blob/3.2.0-debian-9-r67/3/debian-9/Dockerfile)
...
```bash
$ docker build -t bitnami/oauth2-proxy:latest 'https://github.com/bitnami/bitnami-docker-oauth2-proxy.git#master:3/debian-9'
```
