...
* [`0`, `0.1.22-r6`, `latest` (0/Dockerfile)](https://github.com/bitnami/bitnami-docker-user-broker/blob/0.1.22-r6/0/Dockerfile)
* [`0-ol-7`, `0.1.22-ol-7-r4` (0/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-user-broker/blob/0.1.22-ol-7-r4/0/ol-7/Dockerfile)
