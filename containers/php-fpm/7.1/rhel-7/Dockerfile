...
RUN wget -nc -P /tmp/bitnami/pkg/cache/ https://downloads.bitnami.com/files/stacksmith/php-7.1.28-0-linux-x86_64-rhel-7.tar.gz && \
    echo "4bcfde04706f209d9bb8ba19f8fa5632c41726697e7b11bff412d9e66e2c6f0a  /tmp/bitnami/pkg/cache/php-7.1.28-0-linux-x86_64-rhel-7.tar.gz" | sha256sum -c - && \
    tar -zxf /tmp/bitnami/pkg/cache/php-7.1.28-0-linux-x86_64-rhel-7.tar.gz -P --transform 's|^[^/]*/files|/opt/bitnami|' --wildcards '*/files' && \
    rm -rf /tmp/bitnami/pkg/cache/php-7.1.28-0-linux-x86_64-rhel-7.tar.gz
...
ENV BITNAMI_APP_NAME="php-fpm" \
    BITNAMI_IMAGE_VERSION="7.1.28-rhel-7-r12" \
