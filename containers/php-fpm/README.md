...
* [`7.0`, `7.0.30-r11` (7.0/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.0.30-r11/7.0/Dockerfile), [`7.0-prod`, `7.0.30-r11-prod` (7.0/prod/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.0.30-r11/7.0/prod/Dockerfile)
