...
* [`7.4-ol-7-prod`, `7.4.1-ol-7-r13-prod` (7.4-prod/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.4.1-ol-7-r13-prod/7.4-prod/ol-7/Dockerfile)
* [`7.4-debian-9-prod`, `7.4.1-debian-9-r11-prod`, `7.4-prod`, `7.4.1-prod`, `7.4.1-r11-prod` (7.4-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.4.1-debian-9-r11-prod/7.4-prod/debian-9/Dockerfile)
* [`7.4-debian-9`, `7.4.1-debian-9-r11`, `7.4`, `7.4.1`, `7.4.1-r11` (7.4/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.4.1-debian-9-r11/7.4/debian-9/Dockerfile)
...
* [`7.2-ol-7-prod`, `7.2.26-ol-7-r9-prod` (7.2-prod/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.2.26-ol-7-r9-prod/7.2-prod/ol-7/Dockerfile)
