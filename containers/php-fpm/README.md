...
* [`7.3-debian-9-prod`, `7.3.4-debian-9-r9-prod`, `7.3-prod`, `7.3.4-prod`, `7.3.4-r9-prod` (7.3-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.3.4-debian-9-r9-prod/7.3-prod/debian-9/Dockerfile)
