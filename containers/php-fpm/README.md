...
* [`7.3-debian-9-prod`, `7.3.10-debian-9-r10-prod`, `7.3-prod`, `7.3.10-prod`, `7.3.10-r10-prod`, `latest-prod` (7.3-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.3.10-debian-9-r10-prod/7.3-prod/debian-9/Dockerfile)
