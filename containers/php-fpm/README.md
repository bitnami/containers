...
* [`7.2`, `7.2.6-r9` (7.2/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.2.6-r9/7.2/Dockerfile)
* [`7.1`, `7.1.18-r7`, `latest` (7.1/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.1.18-r7/7.1/Dockerfile)
...
* [`7.0`, `7.0.30-r33` (7.0/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.0.30-r33/7.0/Dockerfile)
