...
* [`7.4-debian-10`, `7.4.6-debian-10-r1`, `7.4`, `7.4.6` (7.4/debian-10/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.4.6-debian-10-r1/7.4/debian-10/Dockerfile)
...
* [`7.2-debian-10-prod`, `7.2.31-debian-10-r1-prod`, `7.2-prod`, `7.2.31-prod` (7.2-prod/debian-10/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.2.31-debian-10-r1-prod/7.2-prod/debian-10/Dockerfile)
