...
* [`7.3-debian-9-prod`, `7.3.10-debian-9-r12-prod`, `7.3-prod`, `7.3.10-prod`, `7.3.10-r12-prod`, `latest-prod` (7.3-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.3.10-debian-9-r12-prod/7.3-prod/debian-9/Dockerfile)
...
* [`7.2-debian-9-prod`, `7.2.23-debian-9-r9-prod`, `7.2-prod`, `7.2.23-prod`, `7.2.23-r9-prod` (7.2-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.2.23-debian-9-r9-prod/7.2-prod/debian-9/Dockerfile)
