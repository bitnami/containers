...
* [`7.3-ol-7-prod`, `7.3.9-ol-7-r1-prod` (7.3-prod/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.3.9-ol-7-r1-prod/7.3-prod/ol-7/Dockerfile)
...
* [`7.1-debian-9-prod`, `7.1.32-debian-9-r1-prod`, `7.1-prod`, `7.1.32-prod`, `7.1.32-r1-prod` (7.1-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.1.32-debian-9-r1-prod/7.1-prod/debian-9/Dockerfile)
