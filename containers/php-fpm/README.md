...
* [`7.3-ol-7-prod`, `7.3.5-ol-7-r23-prod` (7.3-prod/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.3.5-ol-7-r23-prod/7.3-prod/ol-7/Dockerfile)
...
* [`7.3-debian-9-prod`, `7.3.5-debian-9-r13-prod`, `7.3-prod`, `7.3.5-prod`, `7.3.5-r13-prod`, `latest-prod` (7.3-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.3.5-debian-9-r13-prod/7.3-prod/debian-9/Dockerfile)
...
* [`7.2-ol-7-prod`, `7.2.18-ol-7-r25-prod` (7.2-prod/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.2.18-ol-7-r25-prod/7.2-prod/ol-7/Dockerfile)
