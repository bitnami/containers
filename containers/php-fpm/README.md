...
* [`7.3-debian-9-prod`, `7.3.6-debian-9-r32-prod`, `7.3-prod`, `7.3.6-prod`, `7.3.6-r32-prod`, `latest-prod` (7.3-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.3.6-debian-9-r32-prod/7.3-prod/debian-9/Dockerfile)
