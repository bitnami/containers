...
# Supported tags and respective `Dockerfile` links
 ...
 - [`7.2`, `7.2.5-r3` (7.2/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.2.5-r3/7.2/Dockerfile), [`7.2-prod`, `7.2.5-r3-prod` (7.2/prod/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.2.5-r3/7.2/prod/Dockerfile)
