...
* [`7.3-ol-7`, `7.3.8-ol-7-r3` (7.3/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.3.8-ol-7-r3/7.3/ol-7/Dockerfile)
...
* [`7.1-debian-9-prod`, `7.1.31-debian-9-r2-prod`, `7.1-prod`, `7.1.31-prod`, `7.1.31-r2-prod` (7.1-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.1.31-debian-9-r2-prod/7.1-prod/debian-9/Dockerfile)
...
* [`5.6-ol-7`, `5.6.40-ol-7-r196` (5.6/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/5.6.40-ol-7-r196/5.6/ol-7/Dockerfile)
* [`5.6-ol-7-prod`, `5.6.40-ol-7-r174-prod` (5.6-prod/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/5.6.40-ol-7-r174-prod/5.6-prod/ol-7/Dockerfile)
* [`5.6-debian-9`, `5.6.40-debian-9-r184`, `5.6`, `5.6.40`, `5.6.40-r184` (5.6/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/5.6.40-debian-9-r184/5.6/debian-9/Dockerfile)
* [`5.6-debian-9-prod`, `5.6.40-debian-9-r166-prod`, `5.6-prod`, `5.6.40-prod`, `5.6.40-r166-prod` (5.6-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/5.6.40-debian-9-r166-prod/5.6-prod/debian-9/Dockerfile)
