...
* [`7.3-debian-10-prod`, `7.3.14-debian-10-r7-prod`, `7.3-prod`, `7.3.14-prod`, `latest-prod` (7.3-prod/debian-10/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.3.14-debian-10-r7-prod/7.3-prod/debian-10/Dockerfile)
