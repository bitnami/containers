...
* [`7.2-debian-9-prod`, `7.2.23-debian-9-r20-prod`, `7.2-prod`, `7.2.23-prod`, `7.2.23-r20-prod` (7.2-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.2.23-debian-9-r20-prod/7.2-prod/debian-9/Dockerfile)
