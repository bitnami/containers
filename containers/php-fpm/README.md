...
* [`7.1-debian-9-prod`, `7.1.29-debian-9-r22-prod`, `7.1-prod`, `7.1.29-prod`, `7.1.29-r22-prod` (7.1-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.1.29-debian-9-r22-prod/7.1-prod/debian-9/Dockerfile)
...
* [`5.6-ol-7-prod`, `5.6.40-ol-7-r106-prod` (5.6-prod/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/5.6.40-ol-7-r106-prod/5.6-prod/ol-7/Dockerfile)
