...
* [`7.4-debian-10`, `7.4.4-debian-10-r3`, `7.4`, `7.4.4` (7.4/debian-10/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.4.4-debian-10-r3/7.4/debian-10/Dockerfile)
...
* [`7.3-debian-10-prod`, `7.3.16-debian-10-r3-prod`, `7.3-prod`, `7.3.16-prod`, `latest-prod` (7.3-prod/debian-10/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.3.16-debian-10-r3-prod/7.3-prod/debian-10/Dockerfile)
