...
# Supported tags and respective `Dockerfile` links
 ...
 - [`5.6`, `5.6.35-r3` (5.6/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/5.6.35-r3/5.6/Dockerfile), [`5.6-prod`, `5.6.35-r3-prod` (5.6/prod/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/5.6.35-r3/5.6/prod/Dockerfile)
