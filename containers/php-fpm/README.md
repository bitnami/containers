...
* [`7.3-debian-9-prod`, `7.3.8-debian-9-r6-prod`, `7.3-prod`, `7.3.8-prod`, `7.3.8-r6-prod`, `latest-prod` (7.3-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.3.8-debian-9-r6-prod/7.3-prod/debian-9/Dockerfile)
* [`7.3-debian-9`, `7.3.8-debian-9-r6`, `7.3`, `7.3.8`, `7.3.8-r6`, `latest` (7.3/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.3.8-debian-9-r6/7.3/debian-9/Dockerfile)
...
* [`7.2-ol-7-prod`, `7.2.21-ol-7-r6-prod` (7.2-prod/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.2.21-ol-7-r6-prod/7.2-prod/ol-7/Dockerfile)
...
* [`5.6-ol-7`, `5.6.40-ol-7-r199` (5.6/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/5.6.40-ol-7-r199/5.6/ol-7/Dockerfile)
