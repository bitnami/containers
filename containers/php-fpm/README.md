...
* [`7.1`, `7.1.17-r17`, `latest` (7.1/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.1.17-r17/7.1/Dockerfile)
* [`7.1-prod`, `7.1.17-r17-prod` (7.1/prod/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.1.17-r17/7.1/prod/Dockerfile)
...
* [`7.2-rhel-7`, `7.2.5-r0-rhel-7` (7.2/rhel-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.2.5-r0-rhel-7/7.2/rhel-7/Dockerfile)
