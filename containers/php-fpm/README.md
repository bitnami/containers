...
* [`7.2`, `7.2.6-r19` (7.2/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.2.6-r19/7.2/Dockerfile)
...
* [`7.1`, `7.1.18-r16`, `latest` (7.1/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.1.18-r16/7.1/Dockerfile)
...
* [`7.0`, `7.0.30-r42` (7.0/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.0.30-r42/7.0/Dockerfile)
...
* [`5.6`, `5.6.36-r42` (5.6/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/5.6.36-r42/5.6/Dockerfile)
