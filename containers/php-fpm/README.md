...
* [`7.2-debian-9-prod`, `7.2.25-debian-9-r9-prod`, `7.2-prod`, `7.2.25-prod`, `7.2.25-r9-prod` (7.2-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.2.25-debian-9-r9-prod/7.2-prod/debian-9/Dockerfile)
...
* [`7.1-ol-7`, `7.1.33-ol-7-r40` (7.1/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.1.33-ol-7-r40/7.1/ol-7/Dockerfile)
