...
* [`7.3-debian-9-prod`, `7.3.9-debian-9-r9-prod`, `7.3-prod`, `7.3.9-prod`, `7.3.9-r9-prod`, `latest-prod` (7.3-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.3.9-debian-9-r9-prod/7.3-prod/debian-9/Dockerfile)
...
* [`7.1-debian-9-prod`, `7.1.32-debian-9-r9-prod`, `7.1-prod`, `7.1.32-prod`, `7.1.32-r9-prod` (7.1-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.1.32-debian-9-r9-prod/7.1-prod/debian-9/Dockerfile)
* [`7.1-debian-9`, `7.1.32-debian-9-r9`, `7.1`, `7.1.32`, `7.1.32-r9` (7.1/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.1.32-debian-9-r9/7.1/debian-9/Dockerfile)
* [`5.6-ol-7`, `5.6.40-ol-7-r234` (5.6/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/5.6.40-ol-7-r234/5.6/ol-7/Dockerfile)
...
* [`5.6-debian-9-prod`, `5.6.40-debian-9-r201-prod`, `5.6-prod`, `5.6.40-prod`, `5.6.40-r201-prod` (5.6-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/5.6.40-debian-9-r201-prod/5.6-prod/debian-9/Dockerfile)
