...
# Supported tags and respective `Dockerfile` links
 ...
 - [`7.0`, `7.0.30-r6` (7.0/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.0.30-r6/7.0/Dockerfile), [`7.0-prod`, `7.0.30-r6-prod` (7.0/prod/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.0.30-r6/7.0/prod/Dockerfile)
 - [`5.6`, `5.6.36-r8` (5.6/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/5.6.36-r8/5.6/Dockerfile), [`5.6-prod`, `5.6.36-r8-prod` (5.6/prod/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/5.6.36-r8/5.6/prod/Dockerfile)
