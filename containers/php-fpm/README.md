...
* [`7.3-ol-7`, `7.3.13-ol-7-r9` (7.3/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.3.13-ol-7-r9/7.3/ol-7/Dockerfile)
...
* [`7.3-debian-9-prod`, `7.3.13-debian-9-r4-prod`, `7.3-prod`, `7.3.13-prod`, `7.3.13-r4-prod`, `latest-prod` (7.3-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.3.13-debian-9-r4-prod/7.3-prod/debian-9/Dockerfile)
