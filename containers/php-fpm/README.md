...
* [`7.2-debian-9-prod`, `7.2.19-debian-9-r20-prod`, `7.2-prod`, `7.2.19-prod`, `7.2.19-r20-prod` (7.2-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.2.19-debian-9-r20-prod/7.2-prod/debian-9/Dockerfile)
...
* [`7.1-ol-7`, `7.1.30-ol-7-r20` (7.1/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.1.30-ol-7-r20/7.1/ol-7/Dockerfile)
...
* [`7.1-debian-9-prod`, `7.1.30-debian-9-r19-prod`, `7.1-prod`, `7.1.30-prod`, `7.1.30-r19-prod` (7.1-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.1.30-debian-9-r19-prod/7.1-prod/debian-9/Dockerfile)
