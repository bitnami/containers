...
* [`7.3-debian-9-prod`, `7.3.12-debian-9-r7-prod`, `7.3-prod`, `7.3.12-prod`, `7.3.12-r7-prod`, `latest-prod` (7.3-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.3.12-debian-9-r7-prod/7.3-prod/debian-9/Dockerfile)
