...
* [`8.0-prod`, `8.0-prod-debian-10`, `8.0.6-prod`, `8.0.6-prod-debian-10-r6` (8.0-prod/debian-10/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/8.0.6-prod-debian-10-r6/8.0-prod/debian-10/Dockerfile)
