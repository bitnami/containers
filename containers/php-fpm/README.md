...
* [`7.3-debian-9-prod`, `7.3.7-debian-9-r4-prod`, `7.3-prod`, `7.3.7-prod`, `7.3.7-r4-prod`, `latest-prod` (7.3-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.3.7-debian-9-r4-prod/7.3-prod/debian-9/Dockerfile)
...
* [`7.2-debian-9-prod`, `7.2.20-debian-9-r4-prod`, `7.2-prod`, `7.2.20-prod`, `7.2.20-r4-prod` (7.2-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.2.20-debian-9-r4-prod/7.2-prod/debian-9/Dockerfile)
