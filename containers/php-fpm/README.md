...
* [`7.2-prod-debian-10`, `7.2-debian-10-prod`, `7.2.32-prod-debian-10-r4`, `7.2.32-debian-10-r4-prod`, `7.2-prod`, `7.2.32-prod` (7.2-prod/debian-10/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.2.32-prod-debian-10-r4/7.2-prod/debian-10/Dockerfile)
