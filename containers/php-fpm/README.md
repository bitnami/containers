...
* [`7.3-prod-debian-10`, `7.3-debian-10-prod`, `7.3.19-prod-debian-10-r9`, `7.3.19-debian-10-r9-prod`, `7.3-prod`, `7.3.19-prod` (7.3-prod/debian-10/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.3.19-prod-debian-10-r9/7.3-prod/debian-10/Dockerfile)
