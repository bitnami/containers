...
* [`7.3-debian-9-prod`, `7.3.10-debian-9-r18-prod`, `7.3-prod`, `7.3.10-prod`, `7.3.10-r18-prod`, `latest-prod` (7.3-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.3.10-debian-9-r18-prod/7.3-prod/debian-9/Dockerfile)
...
* [`7.1-ol-7`, `7.1.32-ol-7-r51` (7.1/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.1.32-ol-7-r51/7.1/ol-7/Dockerfile)
...
* [`7.1-debian-9-prod`, `7.1.32-debian-9-r44-prod`, `7.1-prod`, `7.1.32-prod`, `7.1.32-r44-prod` (7.1-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.1.32-debian-9-r44-prod/7.1-prod/debian-9/Dockerfile)
