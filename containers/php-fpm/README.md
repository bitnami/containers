...
* [`7.3-ol-7-prod`, `7.3.7-ol-7-r20-prod` (7.3-prod/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.3.7-ol-7-r20-prod/7.3-prod/ol-7/Dockerfile)
...
* [`7.1-debian-9-prod`, `7.1.30-debian-9-r53-prod`, `7.1-prod`, `7.1.30-prod`, `7.1.30-r53-prod` (7.1-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.1.30-debian-9-r53-prod/7.1-prod/debian-9/Dockerfile)
...
* [`5.6-ol-7`, `5.6.40-ol-7-r184` (5.6/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/5.6.40-ol-7-r184/5.6/ol-7/Dockerfile)
* [`5.6-ol-7-prod`, `5.6.40-ol-7-r162-prod` (5.6-prod/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/5.6.40-ol-7-r162-prod/5.6-prod/ol-7/Dockerfile)
