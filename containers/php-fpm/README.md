...
* [`7.4-debian-10-prod`, `7.4.2-debian-10-r6-prod`, `7.4-prod`, `7.4.2-prod` (7.4-prod/debian-10/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.4.2-debian-10-r6-prod/7.4-prod/debian-10/Dockerfile)
