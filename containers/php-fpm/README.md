...
* [`7.2-debian-9-prod`, `7.2.26-debian-9-r17-prod`, `7.2-prod`, `7.2.26-prod`, `7.2.26-r17-prod` (7.2-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.2.26-debian-9-r17-prod/7.2-prod/debian-9/Dockerfile)
