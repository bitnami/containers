...
* [`7.4-ol-7-prod`, `7.4.2-ol-7-r4-prod` (7.4-prod/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.4.2-ol-7-r4-prod/7.4-prod/ol-7/Dockerfile)
* [`7.4-ol-7`, `7.4.2-ol-7-r4` (7.4/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.4.2-ol-7-r4/7.4/ol-7/Dockerfile)
...
* [`7.3-debian-10-prod`, `7.3.14-debian-10-r4-prod`, `7.3-prod`, `7.3.14-prod`, `latest-prod` (7.3-prod/debian-10/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.3.14-debian-10-r4-prod/7.3-prod/debian-10/Dockerfile)
...
* [`7.2-debian-10-prod`, `7.2.27-debian-10-r4-prod`, `7.2-prod`, `7.2.27-prod` (7.2-prod/debian-10/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.2.27-debian-10-r4-prod/7.2-prod/debian-10/Dockerfile)
