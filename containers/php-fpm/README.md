...
* [`7.2`, `7.2.7-r10` (7.2/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.2.7-r10/7.2/Dockerfile)
* [`7.2-ol-7`, `7.2.7-ol-7-r4` (7.2/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.2.7-ol-7-r4/7.2/ol-7/Dockerfile)
...
* [`7.1`, `7.1.19-r5`, `latest` (7.1/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.1.19-r5/7.1/Dockerfile)
