...
* [`7.0`, `7.0.30-r32` (7.0/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.0.30-r32/7.0/Dockerfile)
...
* [`5.6`, `5.6.36-r32` (5.6/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/5.6.36-r32/5.6/Dockerfile)
