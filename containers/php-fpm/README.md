...
* [`7.3-debian-9-prod`, `7.3.9-debian-9-r6-prod`, `7.3-prod`, `7.3.9-prod`, `7.3.9-r6-prod`, `latest-prod` (7.3-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.3.9-debian-9-r6-prod/7.3-prod/debian-9/Dockerfile)
...
* [`7.2-debian-9-prod`, `7.2.22-debian-9-r6-prod`, `7.2-prod`, `7.2.22-prod`, `7.2.22-r6-prod` (7.2-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.2.22-debian-9-r6-prod/7.2-prod/debian-9/Dockerfile)
