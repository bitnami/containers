...
* [`7.2-debian-9-prod`, `7.2.17-debian-9-r13-prod`, `7.2-prod`, `7.2.17-prod`, `7.2.17-r13-prod`, `latest-prod` (7.2-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.2.17-debian-9-r13-prod/7.2-prod/debian-9/Dockerfile)
