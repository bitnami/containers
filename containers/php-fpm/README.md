...
* [`7.3-ol-7-prod`, `7.3.11-ol-7-r22-prod` (7.3-prod/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.3.11-ol-7-r22-prod/7.3-prod/ol-7/Dockerfile)
...
* [`7.1-ol-7-prod`, `7.1.33-ol-7-r22-prod` (7.1-prod/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.1.33-ol-7-r22-prod/7.1-prod/ol-7/Dockerfile)
* [`7.1-debian-9`, `7.1.33-debian-9-r17`, `7.1`, `7.1.33`, `7.1.33-r17` (7.1/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.1.33-debian-9-r17/7.1/debian-9/Dockerfile)
* [`7.1-debian-9-prod`, `7.1.33-debian-9-r16-prod`, `7.1-prod`, `7.1.33-prod`, `7.1.33-r16-prod` (7.1-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.1.33-debian-9-r16-prod/7.1-prod/debian-9/Dockerfile)
