...
* [`7.3-debian-9-prod`, `7.3.9-debian-9-r14-prod`, `7.3-prod`, `7.3.9-prod`, `7.3.9-r14-prod`, `latest-prod` (7.3-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.3.9-debian-9-r14-prod/7.3-prod/debian-9/Dockerfile)
...
* [`5.6-debian-9-prod`, `5.6.40-debian-9-r206-prod`, `5.6-prod`, `5.6.40-prod`, `5.6.40-r206-prod` (5.6-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/5.6.40-debian-9-r206-prod/5.6-prod/debian-9/Dockerfile)
