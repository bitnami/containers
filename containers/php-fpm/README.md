...
* [`7.2`, `7.2.5-r16` (7.2/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.2.5-r16/7.2/Dockerfile)
* [`7.2-prod`, `7.2.5-r16-prod` (7.2/prod/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.2.5-r16/7.2/prod/Dockerfile)
...
* [`5.6`, `5.6.36-r17` (5.6/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/5.6.36-r17/5.6/Dockerfile)
* [`5.6-prod`, `5.6.36-r17-prod` (5.6/prod/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/5.6.36-r17/5.6/prod/Dockerfile)
