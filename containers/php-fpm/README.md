...
* [`7.3-ol-7-prod`, `7.3.5-ol-7-r10-prod` (7.3-prod/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.3.5-ol-7-r10-prod/7.3-prod/ol-7/Dockerfile)
* [`7.3-ol-7`, `7.3.5-ol-7-r10` (7.3/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.3.5-ol-7-r10/7.3/ol-7/Dockerfile)
...
* [`7.2-ol-7-prod`, `7.2.18-ol-7-r11-prod` (7.2-prod/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.2.18-ol-7-r11-prod/7.2-prod/ol-7/Dockerfile)
* [`7.2-debian-9-prod`, `7.2.18-debian-9-r1-prod`, `7.2-prod`, `7.2.18-prod`, `7.2.18-r1-prod`, `latest-prod` (7.2-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.2.18-debian-9-r1-prod/7.2-prod/debian-9/Dockerfile)
...
* [`5.6-ol-7`, `5.6.40-ol-7-r108` (5.6/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/5.6.40-ol-7-r108/5.6/ol-7/Dockerfile)
