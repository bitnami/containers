...
* [`7.2-debian-9-prod`, `7.2.16-debian-9-r28-prod`, `7.2-prod`, `7.2.16-prod`, `7.2.16-r28-prod`, `latest-prod` (7.2-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.2.16-debian-9-r28-prod/7.2-prod/debian-9/Dockerfile)
