...
* [`7.3-rhel-7`, `7.3.2-rhel-7-r12` (7.3/rhel-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.3.2-rhel-7-r12/7.3/rhel-7/Dockerfile)
...
* [`7.2-debian-9-prod`, `7.2.15-debian-9-r9-prod`, `7.2-prod`, `7.2.15-prod`, `7.2.15-r9-prod`, `latest-prod` (7.2-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.2.15-debian-9-r9-prod/7.2-prod/debian-9/Dockerfile)
...
* [`7.1-rhel-7`, `7.1.26-rhel-7-r21` (7.1/rhel-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.1.26-rhel-7-r21/7.1/rhel-7/Dockerfile)
...
* [`7.1-debian-9-prod`, `7.1.26-debian-9-r18-prod`, `7.1-prod`, `7.1.26-prod`, `7.1.26-r18-prod` (7.1-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.1.26-debian-9-r18-prod/7.1-prod/debian-9/Dockerfile)
