...
* [`7.3-ol-7-prod`, `7.3.3-ol-7-r8-prod` (7.3-prod/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.3.3-ol-7-r8-prod/7.3-prod/ol-7/Dockerfile)
...
* [`7.2-debian-9-prod`, `7.2.16-debian-9-r8-prod`, `7.2-prod`, `7.2.16-prod`, `7.2.16-r8-prod`, `latest-prod` (7.2-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.2.16-debian-9-r8-prod/7.2-prod/debian-9/Dockerfile)
...
* [`7.1-ol-7`, `7.1.27-ol-7-r9` (7.1/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.1.27-ol-7-r9/7.1/ol-7/Dockerfile)
* [`7.1-ol-7-prod`, `7.1.27-ol-7-r8-prod` (7.1-prod/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.1.27-ol-7-r8-prod/7.1-prod/ol-7/Dockerfile)
