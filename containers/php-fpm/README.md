...
* [`7.3-ol-7`, `7.3.3-ol-7-r8` (7.3/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.3.3-ol-7-r8/7.3/ol-7/Dockerfile)
...
* [`7.2-rhel-7`, `7.2.16-rhel-7-r8` (7.2/rhel-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.2.16-rhel-7-r8/7.2/rhel-7/Dockerfile)
...
* [`7.1-debian-9-prod`, `7.1.27-debian-9-r8-prod`, `7.1-prod`, `7.1.27-prod`, `7.1.27-r8-prod` (7.1-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.1.27-debian-9-r8-prod/7.1-prod/debian-9/Dockerfile)
