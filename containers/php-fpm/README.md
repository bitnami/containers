...
* [`7.3-debian-9`, `7.3.4-debian-9-r11`, `7.3`, `7.3.4`, `7.3.4-r11` (7.3/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.3.4-debian-9-r11/7.3/debian-9/Dockerfile)
...
* [`7.2-debian-9-prod`, `7.2.17-debian-9-r9-prod`, `7.2-prod`, `7.2.17-prod`, `7.2.17-r9-prod`, `latest-prod` (7.2-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.2.17-debian-9-r9-prod/7.2-prod/debian-9/Dockerfile)
...
* [`5.6-ol-7-prod`, `5.6.40-ol-7-r69-prod` (5.6-prod/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/5.6.40-ol-7-r69-prod/5.6-prod/ol-7/Dockerfile)
