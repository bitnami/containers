...
* [`7.2`, `7.2.6-r14` (7.2/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.2.6-r14/7.2/Dockerfile)
...
* [`7.1`, `7.1.18-r11`, `latest` (7.1/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.1.18-r11/7.1/Dockerfile)
