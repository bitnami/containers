...
* [`7.1-ol-7`, `7.1.32-ol-7-r5` (7.1/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.1.32-ol-7-r5/7.1/ol-7/Dockerfile)
* [`7.1-ol-7-prod`, `7.1.32-ol-7-r4-prod` (7.1-prod/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.1.32-ol-7-r4-prod/7.1-prod/ol-7/Dockerfile)
* [`7.1-debian-9-prod`, `7.1.32-debian-9-r4-prod`, `7.1-prod`, `7.1.32-prod`, `7.1.32-r4-prod` (7.1-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.1.32-debian-9-r4-prod/7.1-prod/debian-9/Dockerfile)
...
* [`5.6-ol-7-prod`, `5.6.40-ol-7-r204-prod` (5.6-prod/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/5.6.40-ol-7-r204-prod/5.6-prod/ol-7/Dockerfile)
