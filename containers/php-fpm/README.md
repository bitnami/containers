...
* [`7.3-ol-7-prod`, `7.3.7-ol-7-r9-prod` (7.3-prod/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.3.7-ol-7-r9-prod/7.3-prod/ol-7/Dockerfile)
...
* [`7.3-debian-9-prod`, `7.3.7-debian-9-r9-prod`, `7.3-prod`, `7.3.7-prod`, `7.3.7-r9-prod`, `latest-prod` (7.3-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.3.7-debian-9-r9-prod/7.3-prod/debian-9/Dockerfile)
...
* [`7.2-debian-9-prod`, `7.2.20-debian-9-r9-prod`, `7.2-prod`, `7.2.20-prod`, `7.2.20-r9-prod` (7.2-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.2.20-debian-9-r9-prod/7.2-prod/debian-9/Dockerfile)
...
* [`7.1-ol-7-prod`, `7.1.30-ol-7-r45-prod` (7.1-prod/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.1.30-ol-7-r45-prod/7.1-prod/ol-7/Dockerfile)
...
* [`5.6-debian-9-prod`, `5.6.40-debian-9-r144-prod`, `5.6-prod`, `5.6.40-prod`, `5.6.40-r144-prod` (5.6-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/5.6.40-debian-9-r144-prod/5.6-prod/debian-9/Dockerfile)
