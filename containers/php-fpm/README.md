...
* [`7.3-ol-7`, `7.3.9-ol-7-r1` (7.3/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.3.9-ol-7-r1/7.3/ol-7/Dockerfile)
...
* [`7.3-debian-9-prod`, `7.3.9-debian-9-r1-prod`, `7.3-prod`, `7.3.9-prod`, `7.3.9-r1-prod`, `latest-prod` (7.3-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.3.9-debian-9-r1-prod/7.3-prod/debian-9/Dockerfile)
...
* [`7.2-ol-7-prod`, `7.2.22-ol-7-r1-prod` (7.2-prod/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.2.22-ol-7-r1-prod/7.2-prod/ol-7/Dockerfile)
...
* [`7.2-debian-9-prod`, `7.2.22-debian-9-r1-prod`, `7.2-prod`, `7.2.22-prod`, `7.2.22-r1-prod` (7.2-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.2.22-debian-9-r1-prod/7.2-prod/debian-9/Dockerfile)
...
* [`7.1-ol-7-prod`, `7.1.32-ol-7-r1-prod` (7.1-prod/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.1.32-ol-7-r1-prod/7.1-prod/ol-7/Dockerfile)
...
* [`7.1-debian-9`, `7.1.32-debian-9-r1`, `7.1`, `7.1.32`, `7.1.32-r1` (7.1/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.1.32-debian-9-r1/7.1/debian-9/Dockerfile)
...
* [`5.6-ol-7-prod`, `5.6.40-ol-7-r201-prod` (5.6-prod/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/5.6.40-ol-7-r201-prod/5.6-prod/ol-7/Dockerfile)
