...
* [`7.4-debian-10-prod`, `7.4.5-debian-10-r9-prod`, `7.4-prod`, `7.4.5-prod` (7.4-prod/debian-10/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.4.5-debian-10-r9-prod/7.4-prod/debian-10/Dockerfile)
