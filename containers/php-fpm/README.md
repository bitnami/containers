...
# Supported tags and respective `Dockerfile` links
 ...
 - [`7.1`, `7.1.16-r3`, `latest` (7.1/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.1.16-r3/7.1/Dockerfile), [`7.1-prod`, `7.1.16-r3-prod` (7.1/prod/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.1.16-r3/7.1/prod/Dockerfile)
 - [`7.0`, `7.0.29-r3` (7.0/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.0.29-r3/7.0/Dockerfile), [`7.0-prod`, `7.0.29-r3-prod` (7.0/prod/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.0.29-r3/7.0/prod/Dockerfile)
