...
* [`7.4-prod-debian-10`, `7.4-debian-10-prod`, `7.4.9-prod-debian-10-r1`, `7.4.9-debian-10-r1-prod`, `7.4-prod`, `7.4.9-prod`, `latest-prod` (7.4-prod/debian-10/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.4.9-prod-debian-10-r1/7.4-prod/debian-10/Dockerfile)
