...
* [`7.3-debian-9-prod`, `7.3.11-debian-9-r18-prod`, `7.3-prod`, `7.3.11-prod`, `7.3.11-r18-prod`, `latest-prod` (7.3-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.3.11-debian-9-r18-prod/7.3-prod/debian-9/Dockerfile)
...
* [`7.2-debian-9-prod`, `7.2.24-debian-9-r18-prod`, `7.2-prod`, `7.2.24-prod`, `7.2.24-r18-prod` (7.2-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.2.24-debian-9-r18-prod/7.2-prod/debian-9/Dockerfile)
