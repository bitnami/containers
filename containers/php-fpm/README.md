...
* [`7.2`, `7.2.6-r8` (7.2/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.2.6-r8/7.2/Dockerfile)
...
* [`7.1`, `7.1.18-r6`, `latest` (7.1/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.1.18-r6/7.1/Dockerfile)
...
* [`7.0`, `7.0.30-r31` (7.0/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.0.30-r31/7.0/Dockerfile)
...
* [`5.6`, `5.6.36-r31` (5.6/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/5.6.36-r31/5.6/Dockerfile)
