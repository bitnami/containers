...
* [`7.2-debian-9-prod`, `7.2.18-debian-9-r19-prod`, `7.2-prod`, `7.2.18-prod`, `7.2.18-r19-prod` (7.2-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.2.18-debian-9-r19-prod/7.2-prod/debian-9/Dockerfile)
