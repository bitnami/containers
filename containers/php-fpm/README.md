...
* [`7.3-debian-9-prod`, `7.3.10-debian-9-r2-prod`, `7.3-prod`, `7.3.10-prod`, `7.3.10-r2-prod`, `latest-prod` (7.3-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.3.10-debian-9-r2-prod/7.3-prod/debian-9/Dockerfile)
* [`7.3-debian-9`, `7.3.10-debian-9-r2`, `7.3`, `7.3.10`, `7.3.10-r2`, `latest` (7.3/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.3.10-debian-9-r2/7.3/debian-9/Dockerfile)
...
* [`7.1-ol-7-prod`, `7.1.32-ol-7-r35-prod` (7.1-prod/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.1.32-ol-7-r35-prod/7.1-prod/ol-7/Dockerfile)
