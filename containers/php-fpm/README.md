...
* [`7.2`, `7.2.6-r17` (7.2/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.2.6-r17/7.2/Dockerfile)
...
* [`7.1`, `7.1.18-r14`, `latest` (7.1/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.1.18-r14/7.1/Dockerfile)
...
* [`7.0`, `7.0.30-r39` (7.0/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.0.30-r39/7.0/Dockerfile)
...
* [`5.6`, `5.6.36-r39` (5.6/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/5.6.36-r39/5.6/Dockerfile)
