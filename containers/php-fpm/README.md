...
* [`7.2-ol-7`, `7.2.16-ol-7-r9` (7.2/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.2.16-ol-7-r9/7.2/ol-7/Dockerfile)
...
* [`7.1-debian-9-prod`, `7.1.27-debian-9-r9-prod`, `7.1-prod`, `7.1.27-prod`, `7.1.27-r9-prod` (7.1-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.1.27-debian-9-r9-prod/7.1-prod/debian-9/Dockerfile)
...
* [`5.6-debian-9-prod`, `5.6.40-debian-9-r41-prod`, `5.6-prod`, `5.6.40-prod`, `5.6.40-r41-prod` (5.6-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/5.6.40-debian-9-r41-prod/5.6-prod/debian-9/Dockerfile)
