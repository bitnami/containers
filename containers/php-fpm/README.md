...
* [`7.3-debian-9-prod`, `7.3.6-debian-9-r23-prod`, `7.3-prod`, `7.3.6-prod`, `7.3.6-r23-prod`, `latest-prod` (7.3-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.3.6-debian-9-r23-prod/7.3-prod/debian-9/Dockerfile)
...
* [`5.6-ol-7`, `5.6.40-ol-7-r153` (5.6/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/5.6.40-ol-7-r153/5.6/ol-7/Dockerfile)
* [`5.6-ol-7-prod`, `5.6.40-ol-7-r131-prod` (5.6-prod/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/5.6.40-ol-7-r131-prod/5.6-prod/ol-7/Dockerfile)
