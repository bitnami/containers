...
* [`7.4-debian-9-prod`, `7.4.1-debian-9-r30-prod`, `7.4-prod`, `7.4.1-prod`, `7.4.1-r30-prod` (7.4-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.4.1-debian-9-r30-prod/7.4-prod/debian-9/Dockerfile)
