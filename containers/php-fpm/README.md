...
* [`7.2`, `7.2.6-r30` (7.2/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.2.6-r30/7.2/Dockerfile)
...
* [`5.6`, `5.6.36-r52` (5.6/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/5.6.36-r52/5.6/Dockerfile)
