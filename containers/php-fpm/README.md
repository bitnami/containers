...
* [`7.3-ol-7`, `7.3.10-ol-7-r8` (7.3/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.3.10-ol-7-r8/7.3/ol-7/Dockerfile)
...
* [`7.2-ol-7`, `7.2.23-ol-7-r7` (7.2/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.2.23-ol-7-r7/7.2/ol-7/Dockerfile)
...
* [`7.2-debian-9-prod`, `7.2.23-debian-9-r6-prod`, `7.2-prod`, `7.2.23-prod`, `7.2.23-r6-prod` (7.2-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.2.23-debian-9-r6-prod/7.2-prod/debian-9/Dockerfile)
...
* [`7.1-debian-9-prod`, `7.1.32-debian-9-r36-prod`, `7.1-prod`, `7.1.32-prod`, `7.1.32-r36-prod` (7.1-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.1.32-debian-9-r36-prod/7.1-prod/debian-9/Dockerfile)
