...
* [`7.1`, `7.1.18-r26`, `latest` (7.1/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.1.18-r26/7.1/Dockerfile)
...
* [`7.0`, `7.0.30-r52` (7.0/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.0.30-r52/7.0/Dockerfile)
