...
* [`7.4-ol-7-prod`, `7.4.1-ol-7-r1-prod` (7.4-prod/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.4.1-ol-7-r1-prod/7.4-prod/ol-7/Dockerfile)
...
* [`7.4-debian-9-prod`, `7.4.1-debian-9-r1-prod`, `7.4-prod`, `7.4.1-prod`, `7.4.1-r1-prod` (7.4-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.4.1-debian-9-r1-prod/7.4-prod/debian-9/Dockerfile)
...
* [`7.3-ol-7`, `7.3.13-ol-7-r2` (7.3/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.3.13-ol-7-r2/7.3/ol-7/Dockerfile)
...
* [`7.2-ol-7`, `7.2.26-ol-7-r2` (7.2/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.2.26-ol-7-r2/7.2/ol-7/Dockerfile)
