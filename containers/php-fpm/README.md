...
* [`8.1`, `8.1-debian-11`, `8.1.7`, `8.1.7-debian-11-r10`, `latest` (8.1/debian-11/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/8.1.7-debian-11-r10/8.1/debian-11/Dockerfile)
* [`8.0`, `8.0-debian-11`, `8.0.20`, `8.0.20-debian-11-r10` (8.0/debian-11/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/8.0.20-debian-11-r10/8.0/debian-11/Dockerfile)
* [`7.4`, `7.4-debian-11`, `7.4.30`, `7.4.30-debian-11-r11` (7.4/debian-11/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.4.30-debian-11-r11/7.4/debian-11/Dockerfile)
...
```console
$ docker build -t bitnami/php-fpm 'https://github.com/bitnami/bitnami-docker-php-fpm.git#master:8.1/debian-11'
```
