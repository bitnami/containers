...
* [`8.0-prod`, `8.0-prod-debian-10`, `8.0.1-prod`, `8.0.1-prod-debian-10-r8` (8.0-prod/debian-10/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/8.0.1-prod-debian-10-r8/8.0-prod/debian-10/Dockerfile)
