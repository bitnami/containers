...
* [`7.3-rhel-7`, `7.3.4-rhel-7-r9` (7.3/rhel-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.3.4-rhel-7-r9/7.3/rhel-7/Dockerfile)
...
* [`7.3-debian-9-prod`, `7.3.4-debian-9-r8-prod`, `7.3-prod`, `7.3.4-prod`, `7.3.4-r8-prod` (7.3-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.3.4-debian-9-r8-prod/7.3-prod/debian-9/Dockerfile)
