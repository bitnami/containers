...
* [`7.4-debian-10`, `7.4.5-debian-10-r9`, `7.4`, `7.4.5` (7.4/debian-10/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.4.5-debian-10-r9/7.4/debian-10/Dockerfile)
...
* [`7.3-debian-10-prod`, `7.3.17-debian-10-r9-prod`, `7.3-prod`, `7.3.17-prod`, `latest-prod` (7.3-prod/debian-10/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.3.17-debian-10-r9-prod/7.3-prod/debian-10/Dockerfile)
