...
* [`7.2`, `7.2.6-r11` (7.2/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.2.6-r11/7.2/Dockerfile)
...
* [`7.1`, `7.1.18-r9`, `latest` (7.1/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.1.18-r9/7.1/Dockerfile)
