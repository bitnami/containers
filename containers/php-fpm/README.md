...
* [`7.3-debian-9-prod`, `7.3.5-debian-9-r18-prod`, `7.3-prod`, `7.3.5-prod`, `7.3.5-r18-prod`, `latest-prod` (7.3-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.3.5-debian-9-r18-prod/7.3-prod/debian-9/Dockerfile)
