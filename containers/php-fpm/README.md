...
* [`5.6`, `5.6.36-r15` (5.6/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/5.6.36-r15/5.6/Dockerfile)
* [`5.6-prod`, `5.6.36-r15-prod` (5.6/prod/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/5.6.36-r15/5.6/prod/Dockerfile)
