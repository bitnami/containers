...
* [`7.3-debian-10-prod`, `7.3.16-debian-10-r10-prod`, `7.3-prod`, `7.3.16-prod`, `latest-prod` (7.3-prod/debian-10/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.3.16-debian-10-r10-prod/7.3-prod/debian-10/Dockerfile)
...
* [`7.2-debian-10-prod`, `7.2.29-debian-10-r10-prod`, `7.2-prod`, `7.2.29-prod` (7.2-prod/debian-10/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.2.29-debian-10-r10-prod/7.2-prod/debian-10/Dockerfile)
