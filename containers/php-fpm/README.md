...
* [`7.3-debian-9-prod`, `7.3.6-debian-9-r7-prod`, `7.3-prod`, `7.3.6-prod`, `7.3.6-r7-prod`, `latest-prod` (7.3-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.3.6-debian-9-r7-prod/7.3-prod/debian-9/Dockerfile)
...
* [`7.2-debian-9-prod`, `7.2.19-debian-9-r7-prod`, `7.2-prod`, `7.2.19-prod`, `7.2.19-r7-prod` (7.2-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.2.19-debian-9-r7-prod/7.2-prod/debian-9/Dockerfile)
