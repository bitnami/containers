...
* [`7.3-debian-9-prod`, `7.3.8-debian-9-r9-prod`, `7.3-prod`, `7.3.8-prod`, `7.3.8-r9-prod`, `latest-prod` (7.3-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.3.8-debian-9-r9-prod/7.3-prod/debian-9/Dockerfile)
