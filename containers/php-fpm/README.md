...
* [`7.4-debian-10`, `7.4.4-debian-10-r4`, `7.4`, `7.4.4` (7.4/debian-10/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.4.4-debian-10-r4/7.4/debian-10/Dockerfile)
...
* [`7.2-debian-10-prod`, `7.2.29-debian-10-r5-prod`, `7.2-prod`, `7.2.29-prod` (7.2-prod/debian-10/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.2.29-debian-10-r5-prod/7.2-prod/debian-10/Dockerfile)
