...
* [`7.4-debian-10-prod`, `7.4.5-debian-10-r8-prod`, `7.4-prod`, `7.4.5-prod` (7.4-prod/debian-10/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.4.5-debian-10-r8-prod/7.4-prod/debian-10/Dockerfile)
...
* [`7.2-debian-10`, `7.2.30-debian-10-r9`, `7.2`, `7.2.30` (7.2/debian-10/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.2.30-debian-10-r9/7.2/debian-10/Dockerfile)
* [`7.2-debian-10-prod`, `7.2.30-debian-10-r8-prod`, `7.2-prod`, `7.2.30-prod` (7.2-prod/debian-10/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.2.30-debian-10-r8-prod/7.2-prod/debian-10/Dockerfile)
