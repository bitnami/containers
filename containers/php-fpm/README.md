...
* [`7.2-debian-9-prod`, `7.2.15-debian-9-r8-prod`, `7.2-prod`, `7.2.15-prod`, `7.2.15-r8-prod`, `latest-prod` (7.2-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.2.15-debian-9-r8-prod/7.2-prod/debian-9/Dockerfile)
