...
* [`7.1`, `7.1.18-r27`, `latest` (7.1/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.1.18-r27/7.1/Dockerfile)
* [`7.1-ol-7`, `7.1.18-ol-7-r3` (7.1/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.1.18-ol-7-r3/7.1/ol-7/Dockerfile)
...
* [`7.0`, `7.0.30-r53` (7.0/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.0.30-r53/7.0/Dockerfile)
