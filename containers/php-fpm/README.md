...
* [`7.2-debian-9-prod`, `7.2.16-debian-9-r9-prod`, `7.2-prod`, `7.2.16-prod`, `7.2.16-r9-prod`, `latest-prod` (7.2-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.2.16-debian-9-r9-prod/7.2-prod/debian-9/Dockerfile)
...
* [`7.1-ol-7`, `7.1.27-ol-7-r10` (7.1/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.1.27-ol-7-r10/7.1/ol-7/Dockerfile)
...
* [`5.6-ol-7`, `5.6.40-ol-7-r62` (5.6/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/5.6.40-ol-7-r62/5.6/ol-7/Dockerfile)
* [`5.6-ol-7-prod`, `5.6.40-ol-7-r41-prod` (5.6-prod/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/5.6.40-ol-7-r41-prod/5.6-prod/ol-7/Dockerfile)
