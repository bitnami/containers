...
* [`7.2-debian-9-prod`, `7.2.18-debian-9-r2-prod`, `7.2-prod`, `7.2.18-prod`, `7.2.18-r2-prod` (7.2-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.2.18-debian-9-r2-prod/7.2-prod/debian-9/Dockerfile)
...
* [`7.1-debian-9-prod`, `7.1.29-debian-9-r2-prod`, `7.1-prod`, `7.1.29-prod`, `7.1.29-r2-prod` (7.1-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.1.29-debian-9-r2-prod/7.1-prod/debian-9/Dockerfile)
