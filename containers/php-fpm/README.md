...
* [`7.2-debian-9-prod`, `7.2.15-debian-9-r10-prod`, `7.2-prod`, `7.2.15-prod`, `7.2.15-r10-prod`, `latest-prod` (7.2-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.2.15-debian-9-r10-prod/7.2-prod/debian-9/Dockerfile)
...
* [`5.6-debian-9-prod`, `5.6.40-debian-9-r19-prod`, `5.6-prod`, `5.6.40-prod`, `5.6.40-r19-prod` (5.6-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/5.6.40-debian-9-r19-prod/5.6-prod/debian-9/Dockerfile)
