...
* [`7.3-debian-10-prod`, `7.3.17-debian-10-r6-prod`, `7.3-prod`, `7.3.17-prod`, `latest-prod` (7.3-prod/debian-10/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.3.17-debian-10-r6-prod/7.3-prod/debian-10/Dockerfile)
...
* [`7.2-debian-10`, `7.2.30-debian-10-r5`, `7.2`, `7.2.30` (7.2/debian-10/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.2.30-debian-10-r5/7.2/debian-10/Dockerfile)
