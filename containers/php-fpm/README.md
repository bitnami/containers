...
* [`8.0-prod`, `8.0-prod-debian-10`, `8.0.9-prod`, `8.0.9-prod-debian-10-r4` (8.0-prod/debian-10/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/8.0.9-prod-debian-10-r4/8.0-prod/debian-10/Dockerfile)
