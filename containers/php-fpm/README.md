...
* [`7.3-ol-7-prod`, `7.3.12-ol-7-r24-prod` (7.3-prod/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.3.12-ol-7-r24-prod/7.3-prod/ol-7/Dockerfile)
...
* [`7.3-debian-9-prod`, `7.3.12-debian-9-r19-prod`, `7.3-prod`, `7.3.12-prod`, `7.3.12-r19-prod`, `latest-prod` (7.3-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.3.12-debian-9-r19-prod/7.3-prod/debian-9/Dockerfile)
