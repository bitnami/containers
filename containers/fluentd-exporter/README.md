...
* [`0`, `0-debian-11`, `0.2.0`, `0.2.0-debian-11-r-1`, `latest` (0/debian-11/Dockerfile)](https://github.com/bitnami/bitnami-docker-fluentd-exporter/blob/0.2.0-debian-11-r-1/0/debian-11/Dockerfile)
* [`0`, `0-debian-10`, `0.2.0`, `0.2.0-debian-10-r779`, `latest` (0/debian-10/Dockerfile)](https://github.com/bitnami/bitnami-docker-fluentd-exporter/blob/0.2.0-debian-10-r779/0/debian-10/Dockerfile)
...
```console
$ docker build -t bitnami/fluentd-exporter:latest 'https://github.com/bitnami/bitnami-docker-fluentd-exporter.git#master:0/debian-11'$ docker build -t bitnami/fluentd-exporter:latest 'https://github.com/bitnami/bitnami-docker-fluentd-exporter.git#master:0/debian-10'
```
