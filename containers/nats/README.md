...
* [`2`, `2-debian-11`, `2.8.2`, `2.8.2-debian-11-r-1`, `latest` (2/debian-11/Dockerfile)](https://github.com/bitnami/bitnami-docker-nats/blob/2.8.2-debian-11-r-1/2/debian-11/Dockerfile)
* [`2`, `2-debian-10`, `2.8.2`, `2.8.2-debian-10-r1`, `latest` (2/debian-10/Dockerfile)](https://github.com/bitnami/bitnami-docker-nats/blob/2.8.2-debian-10-r1/2/debian-10/Dockerfile)
...
```console
$ docker build -t bitnami/nats:latest 'https://github.com/bitnami/bitnami-docker-nginx.git#master:2/debian-11'$ docker build -t bitnami/nats:latest 'https://github.com/bitnami/bitnami-docker-nginx.git#master:2/debian-10'
```
