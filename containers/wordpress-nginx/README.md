...
- [`5`, `5-debian-11`, `5.9.3`, `5.9.3-debian-11-r-1`, `latest` (5/debian-11/Dockerfile)](https://github.com/bitnami/bitnami-docker-wordpress-nginx/blob/5.9.3-debian-11-r-1/5/debian-11/Dockerfile)
- [`5`, `5-debian-10`, `5.9.3`, `5.9.3-debian-10-r32`, `latest` (5/debian-10/Dockerfile)](https://github.com/bitnami/bitnami-docker-wordpress-nginx/blob/5.9.3-debian-10-r32/5/debian-10/Dockerfile)
...
```console
$ docker build -t bitnami/wordpress-nginx:latest 'https://github.com/bitnami/bitnami-docker-wordpress-nginx.git#master:5/debian-11'$ docker build -t bitnami/wordpress-nginx:latest 'https://github.com/bitnami/bitnami-docker-wordpress-nginx.git#master:5/debian-10'
```
