...
* [`3.7-ol-7`, `3.7.18-ol-7-r10` (3.7/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-rabbitmq/blob/3.7.18-ol-7-r10/3.7/ol-7/Dockerfile)
* [`3.7-debian-9`, `3.7.18-debian-9-r10`, `3.7`, `3.7.18`, `3.7.18-r10`, `latest` (3.7/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-rabbitmq/blob/3.7.18-debian-9-r10/3.7/debian-9/Dockerfile)
...
```bash
$ docker build -t bitnami/rabbitmq:latest 'https://github.com/bitnami/bitnami-docker-rabbitmq.git#master:3.7/debian-9'
```
