...
- [`1`, `1-scratch`, `1.0.1`, `1.0.1-scratch-r5`, `latest` (1/scratch/Dockerfile)](https://github.com/bitnami/bitnami-docker-dataplatform-emitter/blob/1.0.1-scratch-r5/1/scratch/Dockerfile)
- [`0`, `0-scratch`, `0.0.11`, `0.0.11-scratch-r2` (0/scratch/Dockerfile)](https://github.com/bitnami/bitnami-docker-dataplatform-emitter/blob/0.0.11-scratch-r2/0/scratch/Dockerfile)
