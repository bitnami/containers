...
- [`1`, `1-scratch`, `1.0.1`, `1.0.1-scratch-r4`, `latest` (1/scratch/Dockerfile)](https://github.com/bitnami/bitnami-docker-dataplatform-emitter/blob/1.0.1-scratch-r4/1/scratch/Dockerfile)
