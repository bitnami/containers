...
* [`0`, `0-debian-10`, `0-debian-10-r0`, `latest` (0/debian-10/Dockerfile)](https://github.com/bitnami/bitnami-docker-bitnami-shell/blob/0-debian-10-r0/0/debian-10/Dockerfile)
...
```console
$ docker build -t bitnami/bitnami-shell:latest 'https://github.com/bitnami/bitnami-docker-bitnami-shell.git#master:0/debian-10'
```
