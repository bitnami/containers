...
* [`0-debian-9`, `0.20180711.0-debian-9-r135`, `0`, `0.20180711.0`, `0.20180711.0-r135`, `latest` (0/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-airflow-exporter/blob/0.20180711.0-debian-9-r135/0/debian-9/Dockerfile)
...
```bash
$ docker build -t bitnami/airflow-exporter:latest 'https://github.com/bitnami/bitnami-docker-airflow-exporter.git#master:0/debian-9'
```
