...
* [`10-scratch`, `10.0.0-scratch-r0`, `10`, `10.0.0`, `latest` (10/scratch/Dockerfile)](https://github.com/bitnami/bitnami-docker-keycloak-gatekeeper/blob/10.0.0/10/scratch/Dockerfile)
