...
* [`10`, `10-scratch`, `10.0.0`, `10.0.0-scratch-r2`, `latest` (10/scratch/Dockerfile)](https://github.com/bitnami/bitnami-docker-keycloak-gatekeeper/blob/10.0.0-scratch-r2/10/scratch/Dockerfile)
