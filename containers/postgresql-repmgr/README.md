...
* [`4-centos-7`, `4.0.3-centos-7-r36` (4/centos-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-postgresql-repmgr/blob/4.0.3-centos-7-r36/4/centos-7/Dockerfile)
