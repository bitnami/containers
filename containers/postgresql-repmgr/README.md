...
* [`9.6-centos-7`, `9.6.15-centos-7-r30` (9.6/centos-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-postgresql-repmgr/blob/9.6.15-centos-7-r30/9.6/centos-7/Dockerfile)
