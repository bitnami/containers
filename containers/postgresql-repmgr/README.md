...
* [`12-centos-7`, `12.0.0-centos-7-r10` (12/centos-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-postgresql-repmgr/blob/12.0.0-centos-7-r10/12/centos-7/Dockerfile)
