...
* [`2`, `2-debian-11`, `2.9.4`, `2.9.4-debian-11-r14`, `latest` (2/debian-11/Dockerfile)](https://github.com/bitnami/bitnami-docker-spring-cloud-dataflow-shell/blob/2.9.4-debian-11-r14/2/debian-11/Dockerfile)
...
```console
$ docker build -t bitnami/spring-cloud-dataflow-shell:latest 'https://github.com/bitnami/bitnami-docker-spring-cloud-dataflow-shell.git#master:2/debian-11'
```
...
If you encountered a problem running this container, you can file an [issue](https://github.com/bitnami/bitnami-docker-spring-cloud-dataflow-shell/issues/new). Be sure to include the following information in your issue:
