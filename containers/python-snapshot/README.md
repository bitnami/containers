...
* [`3.6-prod-debian-10`, `3.6-debian-10-prod`, `3.6.11-prod-debian-10-r8`, `3.6.11-debian-10-r8-prod`, `3.6-prod`, `3.6.11-prod` (3.6-prod/debian-10/Dockerfile)](https://github.com/bitnami/bitnami-docker-python-snapshot/blob/3.6.11-prod-debian-10-r8/3.6-prod/debian-10/Dockerfile)
