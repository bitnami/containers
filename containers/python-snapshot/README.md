...
* [`3.9-prod`, `3.9-prod-debian-10`, `3.9.4-prod`, `3.9.4-prod-debian-10-r5` (3.9-prod/debian-10/Dockerfile)](https://github.com/bitnami/bitnami-docker-python-snapshot/blob/3.9.4-prod-debian-10-r5/3.9-prod/debian-10/Dockerfile)
...
* [`3.6-prod`, `3.6-prod-debian-10`, `3.6.13-prod`, `3.6.13-prod-debian-10-r49` (3.6-prod/debian-10/Dockerfile)](https://github.com/bitnami/bitnami-docker-python-snapshot/blob/3.6.13-prod-debian-10-r49/3.6-prod/debian-10/Dockerfile)
