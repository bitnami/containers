...
* [`3.7-prod`, `3.7-prod-debian-10`, `3.7.11-prod`, `3.7.11-prod-debian-10-r7` (3.7-prod/debian-10/Dockerfile)](https://github.com/bitnami/bitnami-docker-python-snapshot/blob/3.7.11-prod-debian-10-r7/3.7-prod/debian-10/Dockerfile)
...
* [`3.6-prod`, `3.6-prod-debian-10`, `3.6.14-prod`, `3.6.14-prod-debian-10-r7` (3.6-prod/debian-10/Dockerfile)](https://github.com/bitnami/bitnami-docker-python-snapshot/blob/3.6.14-prod-debian-10-r7/3.6-prod/debian-10/Dockerfile)
