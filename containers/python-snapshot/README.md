...
* [`3.8-prod`, `3.8-prod-debian-10`, `3.8.9-prod`, `3.8.9-prod-debian-10-r9` (3.8-prod/debian-10/Dockerfile)](https://github.com/bitnami/bitnami-docker-python-snapshot/blob/3.8.9-prod-debian-10-r9/3.8-prod/debian-10/Dockerfile)
...
* [`3.7-prod`, `3.7-prod-debian-10`, `3.7.10-prod`, `3.7.10-prod-debian-10-r49` (3.7-prod/debian-10/Dockerfile)](https://github.com/bitnami/bitnami-docker-python-snapshot/blob/3.7.10-prod-debian-10-r49/3.7-prod/debian-10/Dockerfile)
