...
* [`3.8-prod`, `3.8-prod-debian-10`, `3.8.11-prod`, `3.8.11-prod-debian-10-r8` (3.8-prod/debian-10/Dockerfile)](https://github.com/bitnami/bitnami-docker-python-snapshot/blob/3.8.11-prod-debian-10-r8/3.8-prod/debian-10/Dockerfile)
...
* [`3.7`, `3.7-debian-10`, `3.7.11`, `3.7.11-debian-10-r9`, `latest` (3.7/debian-10/Dockerfile)](https://github.com/bitnami/bitnami-docker-python-snapshot/blob/3.7.11-debian-10-r9/3.7/debian-10/Dockerfile)
