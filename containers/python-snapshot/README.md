...
* [`3.9`, `3.9-debian-10`, `3.9.6`, `3.9.6-debian-10-r9` (3.9/debian-10/Dockerfile)](https://github.com/bitnami/bitnami-docker-python-snapshot/blob/3.9.6-debian-10-r9/3.9/debian-10/Dockerfile)
...
* [`2-prod`, `2-prod-debian-10`, `2.7.18-prod`, `2.7.18-prod-debian-10-r335` (2-prod/debian-10/Dockerfile)](https://github.com/bitnami/bitnami-docker-python-snapshot/blob/2.7.18-prod-debian-10-r335/2-prod/debian-10/Dockerfile)
