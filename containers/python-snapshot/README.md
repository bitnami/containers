...
* [`3.8-prod-debian-10`, `3.8-debian-10-prod`, `3.8.5-prod-debian-10-r7`, `3.8.5-debian-10-r7-prod`, `3.8-prod`, `3.8.5-prod` (3.8-prod/debian-10/Dockerfile)](https://github.com/bitnami/bitnami-docker-python-snapshot/blob/3.8.5-prod-debian-10-r7/3.8-prod/debian-10/Dockerfile)
