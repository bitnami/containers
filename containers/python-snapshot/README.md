...
* [`3.8-prod-debian-10`, `3.8-debian-10-prod`, `3.8.5-prod-debian-10-r5`, `3.8.5-debian-10-r5-prod`, `3.8-prod`, `3.8.5-prod` (3.8-prod/debian-10/Dockerfile)](https://github.com/bitnami/bitnami-docker-python-snapshot/blob/3.8.5-prod-debian-10-r5/3.8-prod/debian-10/Dockerfile)
...
* [`2-prod-debian-10`, `2-debian-10-prod`, `2.7.18-prod-debian-10-r6`, `2.7.18-debian-10-r6-prod`, `2-prod`, `2.7.18-prod` (2-prod/debian-10/Dockerfile)](https://github.com/bitnami/bitnami-docker-python-snapshot/blob/2.7.18-prod-debian-10-r6/2-prod/debian-10/Dockerfile)
