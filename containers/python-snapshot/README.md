...
* [`3.7-prod-debian-10`, `3.7-debian-10-prod`, `3.7.8-prod-debian-10-r8`, `3.7.8-debian-10-r8-prod`, `3.7-prod`, `3.7.8-prod`, `latest-prod` (3.7-prod/debian-10/Dockerfile)](https://github.com/bitnami/bitnami-docker-python-snapshot/blob/3.7.8-prod-debian-10-r8/3.7-prod/debian-10/Dockerfile)
...
* [`2-prod-debian-10`, `2-debian-10-prod`, `2.7.18-prod-debian-10-r8`, `2.7.18-debian-10-r8-prod`, `2-prod`, `2.7.18-prod` (2-prod/debian-10/Dockerfile)](https://github.com/bitnami/bitnami-docker-python-snapshot/blob/2.7.18-prod-debian-10-r8/2-prod/debian-10/Dockerfile)
