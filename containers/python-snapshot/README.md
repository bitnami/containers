...
* [`3.8-prod`, `3.8-prod-debian-10`, `3.8.11-prod`, `3.8.11-prod-debian-10-r32` (3.8-prod/debian-10/Dockerfile)](https://github.com/bitnami/bitnami-docker-python-snapshot/blob/3.8.11-prod-debian-10-r32/3.8-prod/debian-10/Dockerfile)
