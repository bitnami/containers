...
* [`3.9-prod`, `3.9-prod-debian-10`, `3.9.6-prod`, `3.9.6-prod-debian-10-r9` (3.9-prod/debian-10/Dockerfile)](https://github.com/bitnami/bitnami-docker-python-snapshot/blob/3.9.6-prod-debian-10-r9/3.9-prod/debian-10/Dockerfile)
...
* [`3.6`, `3.6-debian-10`, `3.6.14`, `3.6.14-debian-10-r9` (3.6/debian-10/Dockerfile)](https://github.com/bitnami/bitnami-docker-python-snapshot/blob/3.6.14-debian-10-r9/3.6/debian-10/Dockerfile)
