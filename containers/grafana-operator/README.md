...
* [`4`, `4-debian-11`, `4.3.0`, `4.3.0-debian-11-r-1`, `latest` (4/debian-11/Dockerfile)](https://github.com/bitnami/bitnami-docker-grafana-operator/blob/4.3.0-debian-11-r-1/4/debian-11/Dockerfile)
* [`4`, `4-debian-10`, `4.3.0`, `4.3.0-debian-10-r8`, `latest` (4/debian-10/Dockerfile)](https://github.com/bitnami/bitnami-docker-grafana-operator/blob/4.3.0-debian-10-r8/4/debian-10/Dockerfile)
...
```console
$ docker build -t bitnami/grafana-operator:latest 'https://github.com/bitnami/bitnami-docker-grafana-operator.git#master:4/debian-11'$ docker build -t bitnami/grafana-operator:latest 'https://github.com/bitnami/bitnami-docker-grafana-operator.git#master:4/debian-10'
```
