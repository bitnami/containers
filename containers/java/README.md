...
# Supported tags and respective `Dockerfile` links
 ...
 - [`1.8`, `1.8.171-r40` (1.8/Dockerfile)](https://github.com/bitnami/bitnami-docker-java/blob/1.8.171-r40/1.8/Dockerfile), [`1.8-prod`, `1.8.171-r40-prod` (1.8/prod/Dockerfile)](https://github.com/bitnami/bitnami-docker-java/blob/1.8.171-r40/1.8/prod/Dockerfile)
