...
* [`0-debian-9`, `0.5.0-debian-9-r6`, `0`, `0.5.0`, `0.5.0-r6`, `latest` (0/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-consul-exporter/blob/0.5.0-debian-9-r6/0/debian-9/Dockerfile)
...
```bash
$ docker build -t bitnami/consul-exporter:latest https://github.com/bitnami/bitnami-docker-consul-exporter.git
```
