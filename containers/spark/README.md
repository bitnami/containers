...
* [`2-debian-9`, `2.4.4-debian-9-r106`, `2`, `2.4.4`, `2.4.4-r106`, `latest` (2/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-spark/blob/2.4.4-debian-9-r106/2/debian-9/Dockerfile)
...
```bash
docker build -t bitnami/spark:latest 'https://github.com/bitnami/bitnami-docker-spark.git#master:2/debian-9'
```
