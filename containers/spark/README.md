...
* [`3`, `3-debian-11`, `3.2.1`, `3.2.1-debian-11-r0`, `latest` (3/debian-11/Dockerfile)](https://github.com/bitnami/bitnami-docker-spark/blob/3.2.1-debian-11-r0/3/debian-11/Dockerfile)
...
```console
docker build -t bitnami/spark:latest 'https://github.com/bitnami/bitnami-docker-spark.git#master:3/debian-11'
```
