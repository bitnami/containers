...
* [`1.16-centos-7`, `1.16.1-centos-7-r99` (1.16/centos-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-nginx/blob/1.16.1-centos-7-r99/1.16/centos-7/Dockerfile)
