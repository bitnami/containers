...
* [`1.18-debian-10`, `1.18.0-debian-10-r10`, `1.18`, `1.18.0` (1.18/debian-10/Dockerfile)](https://github.com/bitnami/bitnami-docker-nginx/blob/1.18.0-debian-10-r10/1.18/debian-10/Dockerfile)
* [`1.17-debian-10`, `1.17.10-debian-10-r31`, `1.17`, `1.17.10`, `latest` (1.17/debian-10/Dockerfile)](https://github.com/bitnami/bitnami-docker-nginx/blob/1.17.10-debian-10-r31/1.17/debian-10/Dockerfile)
...
```console
$ docker build -t bitnami/nginx:latest 'https://github.com/bitnami/bitnami-docker-nginx.git#master:1.17/debian-10'
```
