...
* [`1.14`, `1.14.0-r60`, `latest` (1.14/Dockerfile)](https://github.com/bitnami/bitnami-docker-nginx/blob/1.14.0-r60/1.14/Dockerfile)
* [`1.14-ol-7`, `1.14.0-ol-7-r14` (1.14/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-nginx/blob/1.14.0-ol-7-r14/1.14/ol-7/Dockerfile)
