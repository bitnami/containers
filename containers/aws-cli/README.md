...
* [`1-photon-3`, `1.18.20-photon-3-r0` (1/photon-3/Dockerfile)](https://github.com/bitnami/bitnami-docker-aws-cli/blob/1.18.20-photon-3-r0/1/photon-3/Dockerfile)
* [`1-debian-10`, `1.18.20-debian-10-r0`, `1`, `1.18.20`, `latest` (1/debian-10/Dockerfile)](https://github.com/bitnami/bitnami-docker-aws-cli/blob/1.18.20-debian-10-r0/1/debian-10/Dockerfile)
* [`1-centos-7`, `1.18.20-centos-7-r0` (1/centos-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-aws-cli/blob/1.18.20-centos-7-r0/1/centos-7/Dockerfile)
...
If you encountered a problem running this container, you can file an [issue](https://github.com/bitnami/bitnami-docker-aws-cli/issues). For us to provide better support, be sure to include the following information in your issue:
