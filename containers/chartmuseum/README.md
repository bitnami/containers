...
* [`0`, `0-debian-11`, `0.14.0`, `0.14.0-debian-11-r11`, `latest` (0/debian-11/Dockerfile)](https://github.com/bitnami/bitnami-docker-chartmuseum/blob/0.14.0-debian-11-r11/0/debian-11/Dockerfile)
...
```console
$ docker build -t bitnami/chartmuseum:latest 'https://github.com/bitnami/bitnami-docker-chartmuseum.git#master:0/debian-11'
```
