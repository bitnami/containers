...
* [`1`, `1-debian-11`, `1.12.2`, `1.12.2-debian-11-r11`, `latest` (1/debian-11/Dockerfile)](https://github.com/bitnami/bitnami-docker-consul/blob/1.12.2-debian-11-r11/1/debian-11/Dockerfile)
...
```console
$ docker build -t bitnami/consul:latest 'https://github.com/bitnami/bitnami-docker-consul.git#master:1/debian-11'
```
