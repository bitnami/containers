...
* [`0-debian-9`, `0.13.8-debian-9-r0`, `0`, `0.13.8`, `0.13.8-r0`, `latest` (0/Dockerfile)](https://github.com/bitnami/bitnami-docker-fluent-bit/blob/0.13.8-debian-9-r0/0/Dockerfile)
