...
# How to deploy Service Catalog in Kubernetes?
...
* [`0-debian-9`, `0.2.2-debian-9-r92`, `0`, `0.2.2`, `0.2.2-r92`, `latest` (0/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-service-catalog/blob/0.2.2-debian-9-r92/0/debian-9/Dockerfile)
* [`0-photon-3`, `0.0.0-photon-3-r0` (0/photon-3/Dockerfile)](https://github.com/bitnami/bitnami-docker-service-catalog/blob/0.0.0-photon-3-r0/0/photon-3/Dockerfile)
...
```bash
$ docker build -t bitnami/service-catalog:latest 'https://github.com/bitnami/bitnami-docker-service-catalog.git#master:0/debian-9'
```
