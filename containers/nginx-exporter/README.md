...
* [`0`, `0-debian-11`, `0.10.0`, `0.10.0-debian-11-r14`, `latest` (0/debian-11/Dockerfile)](https://github.com/bitnami/bitnami-docker-nginx-exporter/blob/0.10.0-debian-11-r14/0/debian-11/Dockerfile)
...
```console
$ docker build -t bitnami/nginx-exporter:latest 'https://github.com/bitnami/bitnami-docker-nginx-exporter.git#master:0/debian-11'
```
