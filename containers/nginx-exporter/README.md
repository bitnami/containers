...
# How to deploy NGINX Exporter in Kubernetes?
...
* [`0-debian-9`, `0.4.2-debian-9-r130`, `0`, `0.4.2`, `0.4.2-r130`, `latest` (0/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-nginx-exporter/blob/0.4.2-debian-9-r130/0/debian-9/Dockerfile)
...
```bash
$ docker build -t bitnami/nginx-exporter:latest 'https://github.com/bitnami/bitnami-docker-nginx-exporter.git#master:0/debian-9'
```
...
If you encountered a problem running this container, you can file an [issue](https://github.com/bitnami/bitnami-docker-nginx-exporter/issues). For us to provide better support, be sure to include the following information in your issue:
