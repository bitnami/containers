...
* [`0-debian-9`, `0.4.2-debian-9-r14`, `0`, `0.4.2`, `0.4.2-r14`, `latest` (0/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-nginx-exporter/blob/0.4.2-debian-9-r14/0/debian-9/Dockerfile)
...
```bash
$ docker build -t bitnami/nginx-exporter:latest https://github.com/bitnami/bitnami-docker-nginx-exporter.git
```
