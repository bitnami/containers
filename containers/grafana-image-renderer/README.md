...
* [`1-debian-10`, `1.0.12-debian-10-r11`, `1`, `1.0.12`, `latest` (1/debian-10/Dockerfile)](https://github.com/bitnami/bitnami-docker-grafana-image-renderer/blob/1.0.12-debian-10-r11/1/debian-10/Dockerfile)
...
```console
$ docker build -t bitnami/grafana-image-renderer:latest 'https://github.com/bitnami/bitnami-docker-grafana-image-renderer.git#master:1/debian-10'
```
