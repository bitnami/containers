...
* [`0`, `0-debian-11`, `0.7.1`, `0.7.1-debian-11-r-1`, `latest` (0/debian-11/Dockerfile)](https://github.com/bitnami/bitnami-docker-configmap-reload/blob/0.7.1-debian-11-r-1/0/debian-11/Dockerfile)
* [`0`, `0-debian-10`, `0.7.1`, `0.7.1-debian-10-r84`, `latest` (0/debian-10/Dockerfile)](https://github.com/bitnami/bitnami-docker-configmap-reload/blob/0.7.1-debian-10-r84/0/debian-10/Dockerfile)
...
```console
$ docker build -t bitnami/configmap-reload:latest 'https://github.com/bitnami/bitnami-docker-configmap-reload.git#master:0/debian-11'$ docker build -t bitnami/configmap-reload:latest 'https://github.com/bitnami/bitnami-docker-configmap-reload.git#master:0/debian-10'
```
