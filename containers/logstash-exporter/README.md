# Logstash Exporter packaged by Bitnami
...
* [`7.3`, `7.3-debian-11`, `7.3.0`, `7.3.0-debian-11-r-1`, `latest` (7.3/debian-11/Dockerfile)](https://github.com/bitnami/bitnami-docker-logstash-exporter/blob/7.3.0-debian-11-r-1/7.3/debian-11/Dockerfile)
* [`7.3`, `7.3-debian-10`, `7.3.0`, `7.3.0-debian-10-r520`, `latest` (7.3/debian-10/Dockerfile)](https://github.com/bitnami/bitnami-docker-logstash-exporter/blob/7.3.0-debian-10-r520/7.3/debian-10/Dockerfile)
...
```console
$ docker build -t bitnami/logstash-exporter:latest 'https://github.com/bitnami/bitnami-docker-logstash-exporter.git#master:7.3/debian-11'$ docker build -t bitnami/logstash-exporter:latest 'https://github.com/bitnami/bitnami-docker-logstash-exporter.git#master:7.3/debian-10'
```
