...
* [`0-ol-7`, `0.10.0-ol-7-r14` (0/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-pushgateway/blob/0.10.0-ol-7-r14/0/ol-7/Dockerfile)
* [`0-debian-9`, `0.10.0-debian-9-r10`, `0`, `0.10.0`, `0.10.0-r10`, `latest` (0/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-pushgateway/blob/0.10.0-debian-9-r10/0/debian-9/Dockerfile)
...
```bash
$ docker build -t bitnami/pushgateway:latest 'https://github.com/bitnami/bitnami-docker-pushgateway.git#master:0/debian-9'
```
