...
* [`1`, `1-debian-11`, `1.4.2`, `1.4.2-debian-11-r-1`, `latest` (1/debian-11/Dockerfile)](https://github.com/bitnami/bitnami-docker-pushgateway/blob/1.4.2-debian-11-r-1/1/debian-11/Dockerfile)
* [`1`, `1-debian-10`, `1.4.2`, `1.4.2-debian-10-r199`, `latest` (1/debian-10/Dockerfile)](https://github.com/bitnami/bitnami-docker-pushgateway/blob/1.4.2-debian-10-r199/1/debian-10/Dockerfile)
...
```console
$ docker build -t bitnami/pushgateway:latest 'https://github.com/bitnami/bitnami-docker-pushgateway.git#master:1/debian-11'$ docker build -t bitnami/pushgateway:latest 'https://github.com/bitnami/bitnami-docker-pushgateway.git#master:1/debian-10'
```
