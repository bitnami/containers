...
* [`12-centos-7`, `12.0.0-centos-7-r20` (12/centos-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-postgresql/blob/12.0.0-centos-7-r20/12/centos-7/Dockerfile)
