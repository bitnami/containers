...
* [`0-rhel-7`, `0.22.0-rhel-7-r18` (0/rhel-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-nginx-ingress-controller/blob/0.22.0-rhel-7-r18/0/rhel-7/Dockerfile)
