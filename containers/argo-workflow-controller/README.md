...
* [`3`, `3-scratch`, `3.2.5`, `3.2.5-scratch-r1`, `latest` (3/scratch/Dockerfile)](https://github.com/bitnami/bitnami-docker-argo-workflow-controller/blob/3.2.5-scratch-r1/3/scratch/      Dockerfile)
