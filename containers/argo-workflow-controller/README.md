...
* [`3`, `3-scratch`, `3.3.8`, `3.3.8-scratch-r0`, `latest` (3/scratch/Dockerfile)](https://github.com/bitnami/bitnami-docker-argo-workflow-controller/blob/3.3.8-scratch-r0/3/scratch/      Dockerfile)
...
```console
$ docker build -t bitnami/argo-workflow-controller:latest 'https://github.com/bitnami/bitnami-docker-argo-workflow-controller.git#master:3/scratch'
```
