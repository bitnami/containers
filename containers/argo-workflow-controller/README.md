...
* [`3`, `3-scratch`, `3.2.8`, `3.2.8-scratch-r3`, `latest` (3/scratch/Dockerfile)](https://github.com/bitnami/bitnami-docker-argo-workflow-controller/blob/3.2.8-scratch-r3/3/scratch/      Dockerfile)
