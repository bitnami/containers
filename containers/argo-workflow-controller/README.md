...
* [`3`, `3-scratch`, `3.2.7`, `3.2.7-scratch-r0`, `latest` (3/scratch/Dockerfile)](https://github.com/bitnami/bitnami-docker-argo-workflow-controller/blob/3.2.7-scratch-r0/3/scratch/      Dockerfile)
