...
* [`2020-ol-7`, `2020.1.13-ol-7-r0` (2020/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-minio/blob/2020.1.13-ol-7-r0/2020/ol-7/Dockerfile)
* [`2020-debian-9`, `2020.1.13-debian-9-r1`, `2020`, `2020.1.13`, `2020.1.13-r1`, `latest` (2020/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-minio/blob/2020.1.13-debian-9-r1/2020/debian-9/Dockerfile)
...
```bash
$ docker build -t bitnami/minio-client:latest 'https://github.com/bitnami/bitnami-docker-minio-client.git#master:2020/debian-9'
```
