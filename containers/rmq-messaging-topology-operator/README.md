...
- [`1`, `1-scratch`, `1.7.1`, `1.7.1-scratch-r1`, `latest` (1/scratch/Dockerfile)](https://github.com/bitnami/bitnami-docker-rmq-default-credential-updater/blob/1.7.1-scratch-r1/1/scratch/Dockerfile)
