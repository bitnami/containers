...
- [`1`, `1-scratch`, `1.4.1`, `1.4.1-scratch-r0`, `latest` (1/scratch/Dockerfile)](https://github.com/bitnami/bitnami-docker-rmq-default-credential-updater/blob/1.4.1-scratch-r0/1/scratch/Dockerfile)
