...
* [`3.7-ol-7-prod`, `3.7.3-ol-7-r58-prod` (3.7-prod/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-python/blob/3.7.3-ol-7-r58-prod/3.7-prod/ol-7/Dockerfile)
* [`3.7-ol-7`, `3.7.3-ol-7-r58` (3.7/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-python/blob/3.7.3-ol-7-r58/3.7/ol-7/Dockerfile)
* [`3.7-debian-9-prod`, `3.7.3-debian-9-r48-prod`, `3.7-prod`, `3.7.3-prod`, `3.7.3-r48-prod`, `latest-prod` (3.7-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-python/blob/3.7.3-debian-9-r48-prod/3.7-prod/debian-9/Dockerfile)
...
* [`3.6-ol-7`, `3.6.8-ol-7-r146` (3.6/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-python/blob/3.6.8-ol-7-r146/3.6/ol-7/Dockerfile)
* [`3.6-ol-7-prod`, `3.6.8-ol-7-r108-prod` (3.6-prod/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-python/blob/3.6.8-ol-7-r108-prod/3.6-prod/ol-7/Dockerfile)
* [`3.6-debian-9-prod`, `3.6.8-debian-9-r95-prod`, `3.6-prod`, `3.6.8-prod`, `3.6.8-r95-prod` (3.6-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-python/blob/3.6.8-debian-9-r95-prod/3.6-prod/debian-9/Dockerfile)
...
* [`2-ol-7-prod`, `2.7.16-ol-7-r80-prod` (2-prod/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-python/blob/2.7.16-ol-7-r80-prod/2-prod/ol-7/Dockerfile)
* [`2-ol-7`, `2.7.16-ol-7-r79` (2/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-python/blob/2.7.16-ol-7-r79/2/ol-7/Dockerfile)
...
* [`2-debian-9`, `2.7.16-debian-9-r70`, `2`, `2.7.16`, `2.7.16-r70` (2/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-python/blob/2.7.16-debian-9-r70/2/debian-9/Dockerfile)
