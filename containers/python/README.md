...
# Supported tags and respective `Dockerfile` links
 ...
 - [`3`, `3.6.5-r32`, `latest` (3/Dockerfile)](https://github.com/bitnami/bitnami-docker-python/blob/3.6.5-r32/3/Dockerfile), [`3-prod`, `3.6.5-r32-prod` (3/prod/Dockerfile)](https://github.com/bitnami/bitnami-docker-python/blob/3.6.5-r32/3/prod/Dockerfile)
