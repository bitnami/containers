...
* [`3.7-ol-7-prod`, `3.7.3-ol-7-r1-prod` (3.7-prod/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-python/blob/3.7.3-ol-7-r1-prod/3.7-prod/ol-7/Dockerfile)
* [`3.7-ol-7`, `3.7.3-ol-7-r1` (3.7/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-python/blob/3.7.3-ol-7-r1/3.7/ol-7/Dockerfile)
* [`3.7-debian-9`, `3.7.3-debian-9-r2`, `3.7`, `3.7.3`, `3.7.3-r2`, `latest` (3.7/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-python/blob/3.7.3-debian-9-r2/3.7/debian-9/Dockerfile)
* [`3.7-debian-9-prod`, `3.7.3-debian-9-r1-prod`, `3.7-prod`, `3.7.3-prod`, `3.7.3-r1-prod`, `latest-prod` (3.7-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-python/blob/3.7.3-debian-9-r1-prod/3.7-prod/debian-9/Dockerfile)
* [`3.6-rhel-7`, `3.6.8-rhel-7-r40` (3.6/rhel-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-python/blob/3.6.8-rhel-7-r40/3.6/rhel-7/Dockerfile)
* [`3.6-ol-7`, `3.6.8-ol-7-r91` (3.6/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-python/blob/3.6.8-ol-7-r91/3.6/ol-7/Dockerfile)
* [`3.6-ol-7-prod`, `3.6.8-ol-7-r53-prod` (3.6-prod/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-python/blob/3.6.8-ol-7-r53-prod/3.6-prod/ol-7/Dockerfile)
* [`3.6-debian-9`, `3.6.8-debian-9-r89`, `3.6`, `3.6.8`, `3.6.8-r89` (3.6/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-python/blob/3.6.8-debian-9-r89/3.6/debian-9/Dockerfile)
* [`3.6-debian-9-prod`, `3.6.8-debian-9-r49-prod`, `3.6-prod`, `3.6.8-prod`, `3.6.8-r49-prod` (3.6-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-python/blob/3.6.8-debian-9-r49-prod/3.6-prod/debian-9/Dockerfile)
* [`2-rhel-7`, `2.7.16-rhel-7-r24` (2/rhel-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-python/blob/2.7.16-rhel-7-r24/2/rhel-7/Dockerfile)
* [`2-ol-7-prod`, `2.7.16-ol-7-r24-prod` (2-prod/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-python/blob/2.7.16-ol-7-r24-prod/2-prod/ol-7/Dockerfile)
* [`2-ol-7`, `2.7.16-ol-7-r23` (2/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-python/blob/2.7.16-ol-7-r23/2/ol-7/Dockerfile)
* [`2-debian-9`, `2.7.16-debian-9-r24`, `2`, `2.7.16`, `2.7.16-r24` (2/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-python/blob/2.7.16-debian-9-r24/2/debian-9/Dockerfile)
* [`2-debian-9-prod`, `2.7.16-debian-9-r23-prod`, `2-prod`, `2.7.16-prod`, `2.7.16-r23-prod` (2-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-python/blob/2.7.16-debian-9-r23-prod/2-prod/debian-9/Dockerfile)
