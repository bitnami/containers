...
* [`3.7-debian-9-prod`, `3.7.4-debian-9-r10-prod`, `3.7-prod`, `3.7.4-prod`, `3.7.4-r10-prod`, `latest-prod` (3.7-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-python/blob/3.7.4-debian-9-r10-prod/3.7-prod/debian-9/Dockerfile)
