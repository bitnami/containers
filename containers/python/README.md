...
# Supported tags and respective `Dockerfile` links
 ...
 - [`3`, `3.6.5-r29`, `latest` (3/Dockerfile)](https://github.com/bitnami/bitnami-docker-python/blob/3.6.5-r29/3/Dockerfile), [`3-prod`, `3.6.5-r29-prod` (3/prod/Dockerfile)](https://github.com/bitnami/bitnami-docker-python/blob/3.6.5-r29/3/prod/Dockerfile)
 - [`2`, `2.7.15-r20` (2/Dockerfile)](https://github.com/bitnami/bitnami-docker-python/blob/2.7.15-r20/2/Dockerfile), [`2-prod`, `2.7.15-r20-prod` (2/prod/Dockerfile)](https://github.com/bitnami/bitnami-docker-python/blob/2.7.15-r20/2/prod/Dockerfile)
