...
* [`3.7-ol-7-prod`, `3.7.3-ol-7-r18-prod` (3.7-prod/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-python/blob/3.7.3-ol-7-r18-prod/3.7-prod/ol-7/Dockerfile)
...
* [`3.7-debian-9-prod`, `3.7.3-debian-9-r18-prod`, `3.7-prod`, `3.7.3-prod`, `3.7.3-r18-prod`, `latest-prod` (3.7-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-python/blob/3.7.3-debian-9-r18-prod/3.7-prod/debian-9/Dockerfile)
...
* [`2-rhel-7`, `2.7.16-rhel-7-r41` (2/rhel-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-python/blob/2.7.16-rhel-7-r41/2/rhel-7/Dockerfile)
* [`2-ol-7-prod`, `2.7.16-ol-7-r40-prod` (2-prod/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-python/blob/2.7.16-ol-7-r40-prod/2-prod/ol-7/Dockerfile)
...
* [`2-debian-9`, `2.7.16-debian-9-r40`, `2`, `2.7.16`, `2.7.16-r40` (2/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-python/blob/2.7.16-debian-9-r40/2/debian-9/Dockerfile)
