...
# Supported tags and respective `Dockerfile` links
 ...
 - [`2`, `2.7.14-r6` (2/Dockerfile)](https://github.com/bitnami/bitnami-docker-python/blob/2.7.14-r6/2/Dockerfile), [`2-prod`, `2.7.14-r6-prod` (2/prod/Dockerfile)](https://github.com/bitnami/bitnami-docker-python/blob/2.7.14-r6/2/prod/Dockerfile)
