...
* [`1`, `1-debian-11`, `1.4.1`, `1.4.1-debian-11-r14`, `latest` (1/debian-11/Dockerfile)](https://github.com/bitnami/bitnami-docker-grafana-tempo-vulture/blob/1.4.1-debian-11-r14/1/debian-11/Dockerfile)
...
```console
$ docker build -t bitnami/grafana-tempo-vulture:latest 'https://github.com/bitnami/bitnami-docker-grafana-tempo-vulture.git#master:1/debian-11'
```
