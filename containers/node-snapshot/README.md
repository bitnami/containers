...
* [`16-prod`, `16-prod-debian-10`, `16.5.0-prod`, `16.5.0-prod-debian-10-r2` (16-prod/debian-10/Dockerfile)](https://github.com/bitnami/bitnami-docker-node-snapshot/blob/16.5.0-prod-debian-10-r2/16-prod/debian-10/Dockerfile)
