...
* [`0-debian-9`, `0.5.0-debian-9-r1`, `0`, `0.5.0`, `0.5.0-r1`, `latest` (0/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-nats-exporter/blob/0.5.0-debian-9-r1/0/debian-9/Dockerfile)
...
```bash
$ docker build -t bitnami/nats-exporter:latest https://github.com/bitnami/bitnami-docker-nats-exporter.git
```
