...
HTTP_HOST="$DOMAIN"
[[ -n "$APACHE_HTTP_PORT_NUMBER" && "$APACHE_HTTP_PORT_NUMBER" != "80" ]] && HTTP_HOST="${DOMAIN}:${APACHE_HTTP_PORT_NUMBER}"
HTTPS_HOST="$DOMAIN"
[[ -n "$APACHE_HTTPS_PORT_NUMBER" && "$APACHE_HTTPS_PORT_NUMBER" != "443" ]] && HTTPS_HOST="${DOMAIN}:${APACHE_HTTPS_PORT_NUMBER}"
