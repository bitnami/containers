...
* [`3`, `3-scratch`, `3.3.6`, `3.3.6-scratch-r1`, `latest` (3/scratch/Dockerfile)](https://github.com/bitnami/bitnami-docker-argo-workflows/blob/3.3.6-scratch-r1/3/scratch/      Dockerfile)
