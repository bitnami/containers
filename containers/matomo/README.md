...
* [`4`, `4-debian-11`, `4.10.1`, `4.10.1-debian-11-r11`, `latest` (4/debian-11/Dockerfile)](https://github.com/bitnami/bitnami-docker-matomo/blob/4.10.1-debian-11-r11/4/debian-11/Dockerfile)
...
```console
docker build -t bitnami/matomo:latest 'https://github.com/bitnami/bitnami-docker-matomo.git#master:4/debian-11'
```
