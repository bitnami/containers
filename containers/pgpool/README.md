...
* [`4`, `4-debian-11`, `4.3.2`, `4.3.2-debian-11-r15`, `latest` (4/debian-11/Dockerfile)](https://github.com/bitnami/bitnami-docker-pgpool/blob/4.3.2-debian-11-r15/4/debian-11/Dockerfile)
...
```console
$ docker build -t bitnami/pgpool:latest 'https://github.com/bitnami/bitnami-docker-pgpool.git#master:4/debian-11'
```
