...
* [`1-debian-9`, `1.3.1-debian-9-r2` (1/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-kube-state-metrics/blob/1.3.1-debian-9-r2/1/debian-9/Dockerfile)
