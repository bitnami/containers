...
* [`1-debian-9`, `1.3.1-debian-9-r6`, `1`, `1.3.1`, `1.3.1-r6`, `latest` (1/Dockerfile)](https://github.com/bitnami/bitnami-docker-kube-state-metrics/blob/1.3.1-debian-9-r6/1/Dockerfile)
