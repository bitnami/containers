...
RUN . ./libcomponent.sh && component_unpack "mongodb" "4.0.10-3" --checksum 43c8591b046a0a31c3a982f1fdacf2d1a508eb2a54818bf04e7ab00ba50bcac2

COPY rootfs /
RUN /postunpack.sh
ENV BITNAMI_APP_NAME="mongodb" \
    BITNAMI_IMAGE_VERSION="4.0.10-debian-9-r32" \
