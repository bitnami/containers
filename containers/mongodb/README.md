...
* [`4.2-debian-10`, `4.2.8-debian-10-r11`, `4.2`, `4.2.8`, `latest` (4.2/debian-10/Dockerfile)](https://github.com/bitnami/bitnami-docker-mongodb/blob/4.2.8-debian-10-r11/4.2/debian-10/Dockerfile)
...
```console
$ docker build -t bitnami/mongodb:latest 'https://github.com/bitnami/bitnami-docker-mongodb.git#master:4.2/debian-10'
```
