...
* [`1`, `1-debian-11`, `1.37.0`, `1.37.0-debian-11-r-1`, `latest` (1/debian-11/Dockerfile)](https://github.com/bitnami/bitnami-docker-redis-exporter/blob/1.37.0-debian-11-r-1/1/debian-11/Dockerfile)
* [`1`, `1-debian-10`, `1.37.0`, `1.37.0-debian-10-r48`, `latest` (1/debian-10/Dockerfile)](https://github.com/bitnami/bitnami-docker-redis-exporter/blob/1.37.0-debian-10-r48/1/debian-10/Dockerfile)
...
```console
$ docker build -t bitnami/redis-exporter:latest 'https://github.com/bitnami/bitnami-docker-redis-exporter.git#master:1/debian-11'$ docker build -t bitnami/redis-exporter:latest 'https://github.com/bitnami/bitnami-docker-redis-exporter.git#master:1/debian-10'
```
