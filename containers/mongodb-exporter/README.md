...
* [`0`, `0-debian-11`, `0.32.0`, `0.32.0-debian-11-r10`, `latest` (0/debian-11/Dockerfile)](https://github.com/bitnami/bitnami-docker-mongodb-exporter/blob/0.32.0-debian-11-r10/0/debian-11/Dockerfile)
...
```console
$ docker build -t bitnami/mongodb-exporter:latest 'https://github.com/bitnami/bitnami-docker-mongodb-exporter.git#master:0/debian-11'
```
