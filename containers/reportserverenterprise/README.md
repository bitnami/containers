...
- [`4`, `4-debian-10`, `4.1.0-6063`, `4.1.0-6063-debian-10-r15`, `latest` (4/debian-10/Dockerfile)](https://github.com/bitnami/bitnami-docker-reportserverenterprise/blob/4.1.0-6063-debian-10-r15/4/debian-10/Dockerfile)
...
```console
$ docker build -t bitnami/reportserverenterprise:latest 'https://github.com/bitnami/bitnami-docker-reportserverenterprise.git#master:4/debian-10'
```
