...
* [`0`, `0-debian-11`, `0.57.0`, `0.57.0-debian-11-r10`, `latest` (0/debian-11/Dockerfile)](https://github.com/bitnami/bitnami-docker-prometheus-operator/blob/0.57.0-debian-11-r10/0/debian-11/Dockerfile)
...
```console
$ docker build -t bitnami/prometheus-operator:latest 'https://github.com/bitnami/bitnami-docker-prometheus-operator.git#master:0/debian-11'
```
