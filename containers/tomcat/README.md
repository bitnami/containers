...
# Supported tags and respective `Dockerfile` links
 ...
 - [`9.0`, `9.0.7-r1` (9.0/Dockerfile)](https://github.com/bitnami/bitnami-docker-tomcat/blob/9.0.7-r1/9.0/Dockerfile)
 - [`8.5`, `8.5.30-r0`, `latest` (8.5/Dockerfile)](https://github.com/bitnami/bitnami-docker-tomcat/blob/8.5.30-r0/8.5/Dockerfile)
 - [`8.0`, `8.0.51-r0` (8.0/Dockerfile)](https://github.com/bitnami/bitnami-docker-tomcat/blob/8.0.51-r0/8.0/Dockerfile)
