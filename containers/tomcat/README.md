...
# Supported tags and respective `Dockerfile` links
 ...
 - [`9.0`, `7.0.78-r0`, `latest` (9.0/Dockerfile)](https://github.com/bitnami/bitnami-docker-tomcat/blob/7.0.78-r0/9.0/Dockerfile)
 - [`8.5`, `7.0.78-r0` (8.5/Dockerfile)](https://github.com/bitnami/bitnami-docker-tomcat/blob/7.0.78-r0/8.5/Dockerfile)
 - [`8.0`, `7.0.78-r0` (8.0/Dockerfile)](https://github.com/bitnami/bitnami-docker-tomcat/blob/7.0.78-r0/8.0/Dockerfile)
