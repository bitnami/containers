...
# Supported tags and respective `Dockerfile` links
 ...
 - [`9.0`, `8.0.44-r0`, `latest` (9.0/Dockerfile)](https://github.com/bitnami/bitnami-docker-tomcat/blob/8.0.44-r0/9.0/Dockerfile)
 - [`8.5`, `8.0.44-r0` (8.5/Dockerfile)](https://github.com/bitnami/bitnami-docker-tomcat/blob/8.0.44-r0/8.5/Dockerfile)
 - [`8.0`, `8.0.44-r0` (8.0/Dockerfile)](https://github.com/bitnami/bitnami-docker-tomcat/blob/8.0.44-r0/8.0/Dockerfile)
 - [`7`, `8.0.44-r0` (7/Dockerfile)](https://github.com/bitnami/bitnami-docker-tomcat/blob/8.0.44-r0/7/Dockerfile)
