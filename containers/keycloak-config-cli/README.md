...
* [`5`, `5-debian-10`, `5.2.0`, `5.2.0-debian-10-r23`, `latest` (5/debian-10/Dockerfile)](https://github.com/bitnami/bitnami-docker-keycloak-config-cli/blob/5.2.0-debian-10-r23/5/debian-10/Dockerfile)
* [`4`, `4-debian-10`, `4.9.0`, `4.9.0-debian-10-r55` (4/debian-10/Dockerfile)](https://github.com/bitnami/bitnami-docker-keycloak-config-cli/blob/4.9.0-debian-10-r55/4/debian-10/Dockerfile)
...
```console
$ docker build -t bitnami/keycloak-config-cli:latest 'https://github.com/bitnami/bitnami-docker-keycloak-config-cli.git#master:5/debian-10'
```
