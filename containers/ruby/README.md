...
# Supported tags and respective `Dockerfile` links
 ...
 - [`2.3`, `2.3.7-r22` (2.3/Dockerfile)](https://github.com/bitnami/bitnami-docker-ruby/blob/2.3.7-r22/2.3/Dockerfile), [`2.3-prod`, `2.3.7-r22-prod` (2.3/prod/Dockerfile)](https://github.com/bitnami/bitnami-docker-ruby/blob/2.3.7-r22/2.3/prod/Dockerfile)
