...
* [`2.6-debian-9-prod`, `2.6.4-debian-9-r32-prod`, `2.6-prod`, `2.6.4-prod`, `2.6.4-r32-prod`, `latest-prod` (2.6-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-ruby/blob/2.6.4-debian-9-r32-prod/2.6-prod/debian-9/Dockerfile)
...
* [`2.4-ol-7`, `2.4.7-ol-7-r36` (2.4/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-ruby/blob/2.4.7-ol-7-r36/2.4/ol-7/Dockerfile)
