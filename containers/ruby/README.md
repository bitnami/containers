...
# Supported tags and respective `Dockerfile` links
 ...
 - [`2.3`, `2.3.5-r0` (2.3/Dockerfile)](https://github.com/bitnami/bitnami-docker-ruby/blob/2.3.5-r0/2.3/Dockerfile), [`2.3-prod`, `2.3.5-r0-prod` (2.3/prod/Dockerfile)](https://github.com/bitnami/bitnami-docker-ruby/blob/2.3.5-r0/2.3/prod/Dockerfile)
 - [`2.2`, `2.2.8-r0` (2.2/Dockerfile)](https://github.com/bitnami/bitnami-docker-ruby/blob/2.2.8-r0/2.2/Dockerfile), [`2.2-prod`, `2.2.8-r0-prod` (2.2/prod/Dockerfile)](https://github.com/bitnami/bitnami-docker-ruby/blob/2.2.8-r0/2.2/prod/Dockerfile)
