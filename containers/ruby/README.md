...
* [`2.7-debian-10-prod`, `2.7.1-debian-10-r56-prod`, `2.7-prod`, `2.7.1-prod`, `latest-prod` (2.7-prod/debian-10/Dockerfile)](https://github.com/bitnami/bitnami-docker-ruby/blob/2.7.1-debian-10-r56-prod/2.7-prod/debian-10/Dockerfile)
...
* [`2.5-debian-10-prod`, `2.5.8-debian-10-r56-prod`, `2.5-prod`, `2.5.8-prod` (2.5-prod/debian-10/Dockerfile)](https://github.com/bitnami/bitnami-docker-ruby/blob/2.5.8-debian-10-r56-prod/2.5-prod/debian-10/Dockerfile)
...
* [`2.4-debian-10-prod`, `2.4.10-debian-10-r56-prod`, `2.4-prod`, `2.4.10-prod` (2.4-prod/debian-10/Dockerfile)](https://github.com/bitnami/bitnami-docker-ruby/blob/2.4.10-debian-10-r56-prod/2.4-prod/debian-10/Dockerfile)
