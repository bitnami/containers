...
* [`2.6-ol-7-prod`, `2.6.1-ol-7-r33-prod` (2.6-prod/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-ruby/blob/2.6.1-ol-7-r33-prod/2.6-prod/ol-7/Dockerfile)
...
* [`2.5-ol-7-prod`, `2.5.3-ol-7-r33-prod` (2.5-prod/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-ruby/blob/2.5.3-ol-7-r33-prod/2.5-prod/ol-7/Dockerfile)
...
* [`2.5-debian-9`, `2.5.3-debian-9-r132`, `2.5`, `2.5.3`, `2.5.3-r132`, `latest` (2.5/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-ruby/blob/2.5.3-debian-9-r132/2.5/debian-9/Dockerfile)
...
* [`2.3-debian-9-prod`, `2.3.8-debian-9-r30-prod`, `2.3-prod`, `2.3.8-prod`, `2.3.8-r30-prod` (2.3-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-ruby/blob/2.3.8-debian-9-r30-prod/2.3-prod/debian-9/Dockerfile)
