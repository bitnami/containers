...
* [`2.6-ol-7-prod`, `2.6.1-ol-7-r1-prod` (2.6-prod/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-ruby/blob/2.6.1-ol-7-r1-prod/2.6-prod/ol-7/Dockerfile)
...
* [`2.6-debian-9-prod`, `2.6.1-debian-9-r1-prod`, `2.6-prod`, `2.6.1-prod`, `2.6.1-r1-prod` (2.6-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-ruby/blob/2.6.1-debian-9-r1-prod/2.6-prod/debian-9/Dockerfile)
...
* [`2.4-ol-7`, `2.4.5-ol-7-r95` (2.4/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-ruby/blob/2.4.5-ol-7-r95/2.4/ol-7/Dockerfile)
...
* [`2.4-debian-9-prod`, `2.4.5-debian-9-r0-prod`, `2.4-prod`, `2.4.5-prod`, `2.4.5-r0-prod` (2.4-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-ruby/blob/2.4.5-debian-9-r0-prod/2.4-prod/debian-9/Dockerfile)
...
* [`2.3-debian-9-prod`, `2.3.8-debian-9-r1-prod`, `2.3-prod`, `2.3.8-prod`, `2.3.8-r1-prod` (2.3-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-ruby/blob/2.3.8-debian-9-r1-prod/2.3-prod/debian-9/Dockerfile)
