...
* [`2.6-ol-7`, `2.6.1-ol-7-r35` (2.6/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-ruby/blob/2.6.1-ol-7-r35/2.6/ol-7/Dockerfile)
* [`2.6-debian-9`, `2.6.1-debian-9-r35`, `2.6`, `2.6.1`, `2.6.1-r35` (2.6/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-ruby/blob/2.6.1-debian-9-r35/2.6/debian-9/Dockerfile)
* [`2.6-debian-9-prod`, `2.6.1-debian-9-r31-prod`, `2.6-prod`, `2.6.1-prod`, `2.6.1-r31-prod` (2.6-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-ruby/blob/2.6.1-debian-9-r31-prod/2.6-prod/debian-9/Dockerfile)
* [`2.5-ol-7-prod`, `2.5.3-ol-7-r35-prod` (2.5-prod/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-ruby/blob/2.5.3-ol-7-r35-prod/2.5-prod/ol-7/Dockerfile)
* [`2.5-ol-7`, `2.5.3-ol-7-r132` (2.5/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-ruby/blob/2.5.3-ol-7-r132/2.5/ol-7/Dockerfile)
* [`2.5-debian-9-prod`, `2.5.3-debian-9-r33-prod`, `2.5-prod`, `2.5.3-prod`, `2.5.3-r33-prod`, `latest-prod` (2.5-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-ruby/blob/2.5.3-debian-9-r33-prod/2.5-prod/debian-9/Dockerfile)
* [`2.5-debian-9`, `2.5.3-debian-9-r134`, `2.5`, `2.5.3`, `2.5.3-r134`, `latest` (2.5/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-ruby/blob/2.5.3-debian-9-r134/2.5/debian-9/Dockerfile)
* [`2.4-ol-7-prod`, `2.4.5-ol-7-r32-prod` (2.4-prod/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-ruby/blob/2.4.5-ol-7-r32-prod/2.4-prod/ol-7/Dockerfile)
* [`2.4-ol-7`, `2.4.5-ol-7-r126` (2.4/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-ruby/blob/2.4.5-ol-7-r126/2.4/ol-7/Dockerfile)
* [`2.4-debian-9-prod`, `2.4.5-debian-9-r30-prod`, `2.4-prod`, `2.4.5-prod`, `2.4.5-r30-prod` (2.4-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-ruby/blob/2.4.5-debian-9-r30-prod/2.4-prod/debian-9/Dockerfile)
* [`2.4-debian-9`, `2.4.5-debian-9-r130`, `2.4`, `2.4.5`, `2.4.5-r130` (2.4/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-ruby/blob/2.4.5-debian-9-r130/2.4/debian-9/Dockerfile)
* [`2.3-ol-7-prod`, `2.3.8-ol-7-r33-prod` (2.3-prod/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-ruby/blob/2.3.8-ol-7-r33-prod/2.3-prod/ol-7/Dockerfile)
* [`2.3-ol-7`, `2.3.8-ol-7-r127` (2.3/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-ruby/blob/2.3.8-ol-7-r127/2.3/ol-7/Dockerfile)
* [`2.3-debian-9-prod`, `2.3.8-debian-9-r32-prod`, `2.3-prod`, `2.3.8-prod`, `2.3.8-r32-prod` (2.3-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-ruby/blob/2.3.8-debian-9-r32-prod/2.3-prod/debian-9/Dockerfile)
* [`2.3-debian-9`, `2.3.8-debian-9-r133`, `2.3`, `2.3.8`, `2.3.8-r133` (2.3/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-ruby/blob/2.3.8-debian-9-r133/2.3/debian-9/Dockerfile)
