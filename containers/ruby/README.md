...
* [`2.6-ol-7`, `2.6.4-ol-7-r12` (2.6/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-ruby/blob/2.6.4-ol-7-r12/2.6/ol-7/Dockerfile)
* [`2.6-ol-7-prod`, `2.6.4-ol-7-r11-prod` (2.6-prod/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-ruby/blob/2.6.4-ol-7-r11-prod/2.6-prod/ol-7/Dockerfile)
* [`2.6-debian-9-prod`, `2.6.4-debian-9-r9-prod`, `2.6-prod`, `2.6.4-prod`, `2.6.4-r9-prod`, `latest-prod` (2.6-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-ruby/blob/2.6.4-debian-9-r9-prod/2.6-prod/debian-9/Dockerfile)
