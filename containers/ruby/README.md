...
* [`2.6-debian-9-prod`, `2.6.3-debian-9-r107-prod`, `2.6-prod`, `2.6.3-prod`, `2.6.3-r107-prod`, `latest-prod` (2.6-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-ruby/blob/2.6.3-debian-9-r107-prod/2.6-prod/debian-9/Dockerfile)
...
* [`2.5-debian-9-prod`, `2.5.5-debian-9-r138-prod`, `2.5-prod`, `2.5.5-prod`, `2.5.5-r138-prod` (2.5-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-ruby/blob/2.5.5-debian-9-r138-prod/2.5-prod/debian-9/Dockerfile)
