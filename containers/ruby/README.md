...
# Supported tags and respective `Dockerfile` links
 ...
 - [`2.2`, `2.2.10-r17` (2.2/Dockerfile)](https://github.com/bitnami/bitnami-docker-ruby/blob/2.2.10-r17/2.2/Dockerfile), [`2.2-prod`, `2.2.10-r17-prod` (2.2/prod/Dockerfile)](https://github.com/bitnami/bitnami-docker-ruby/blob/2.2.10-r17/2.2/prod/Dockerfile)
