...
* [`2.6-debian-9-prod`, `2.6.4-debian-9-r3-prod`, `2.6-prod`, `2.6.4-prod`, `2.6.4-r3-prod`, `latest-prod` (2.6-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-ruby/blob/2.6.4-debian-9-r3-prod/2.6-prod/debian-9/Dockerfile)
