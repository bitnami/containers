...
* [`2.7-ol-7`, `2.7.0-ol-7-r38` (2.7/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-ruby/blob/2.7.0-ol-7-r38/2.7/ol-7/Dockerfile)
...
* [`2.7-debian-10-prod`, `2.7.0-debian-10-r25-prod`, `2.7-prod`, `2.7.0-prod`, `latest-prod` (2.7-prod/debian-10/Dockerfile)](https://github.com/bitnami/bitnami-docker-ruby/blob/2.7.0-debian-10-r25-prod/2.7-prod/debian-10/Dockerfile)
...
* [`2.5-ol-7-prod`, `2.5.7-ol-7-r140-prod` (2.5-prod/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-ruby/blob/2.5.7-ol-7-r140-prod/2.5-prod/ol-7/Dockerfile)
* [`2.5-debian-10-prod`, `2.5.7-debian-10-r25-prod`, `2.5-prod`, `2.5.7-prod` (2.5-prod/debian-10/Dockerfile)](https://github.com/bitnami/bitnami-docker-ruby/blob/2.5.7-debian-10-r25-prod/2.5-prod/debian-10/Dockerfile)
