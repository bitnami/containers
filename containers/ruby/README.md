...
* [`2.6-ol-7-prod`, `2.6.4-ol-7-r9-prod` (2.6-prod/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-ruby/blob/2.6.4-ol-7-r9-prod/2.6-prod/ol-7/Dockerfile)
...
* [`2.4-debian-9-prod`, `2.4.7-debian-9-r8-prod`, `2.4-prod`, `2.4.7-prod`, `2.4.7-r8-prod` (2.4-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-ruby/blob/2.4.7-debian-9-r8-prod/2.4-prod/debian-9/Dockerfile)
