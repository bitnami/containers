...
* [`2.5-debian-9-prod`, `2.5.5-debian-9-r16-prod`, `2.5-prod`, `2.5.5-prod`, `2.5.5-r16-prod`, `latest-prod` (2.5-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-ruby/blob/2.5.5-debian-9-r16-prod/2.5-prod/debian-9/Dockerfile)
...
* [`2.3-ol-7-prod`, `2.3.8-ol-7-r53-prod` (2.3-prod/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-ruby/blob/2.3.8-ol-7-r53-prod/2.3-prod/ol-7/Dockerfile)
* [`2.3-ol-7`, `2.3.8-ol-7-r147` (2.3/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-ruby/blob/2.3.8-ol-7-r147/2.3/ol-7/Dockerfile)
