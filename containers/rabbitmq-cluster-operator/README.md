...
- [`1`, `1-scratch`, `1.11.1`, `1.11.1-scratch-r3`, `latest` (1/scratch/Dockerfile)](https://github.com/bitnami/bitnami-docker-rabbitmq-cluster-operator/blob/1.11.1-scratch-r3/1/scratch/Dockerfile)
