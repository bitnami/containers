...
- [`1`, `1-scratch`, `1.8.1`, `1.8.1-scratch-r0`, `latest` (1/scratch/Dockerfile)](https://github.com/bitnami/bitnami-docker-rabbitmq-cluster-operator/blob/1.8.1-scratch-r0/1/scratch/Dockerfile)
