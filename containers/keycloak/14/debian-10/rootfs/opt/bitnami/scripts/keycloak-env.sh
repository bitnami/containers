...
# Append '?' in the beginning of the string if KEYCLOAK_JDBC_PARAMS value isn't empty
KEYCLOAK_JDBC_PARAMS=$(echo "${KEYCLOAK_JDBC_PARAMS:-"${JDBC_PARAMS:-}"}" | sed '/^$/! s/^/?/')
export KEYCLOAK_JDBC_PARAMS
