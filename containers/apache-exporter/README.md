...
* [`0`, `0-debian-11`, `0.11.0`, `0.11.0-debian-11-r-1`, `latest` (0/debian-11/Dockerfile)](https://github.com/bitnami/bitnami-docker-apache-exporter/blob/0.11.0-debian-11-r-1/0/debian-11/Dockerfile)

* [`0`, `0-debian-10`, `0.11.0`, `0.11.0-debian-10-r136`, `latest` (0/debian-10/Dockerfile)](https://github.com/bitnami/bitnami-docker-apache-exporter/blob/0.11.0-debian-10-r136/0/debian-10/Dockerfile)
...
```console
$ docker build -t bitnami/apache-exporter:latest 'https://github.com/bitnami/bitnami-docker-apache-exporter.git#master:0/debian-11'$ docker build -t bitnami/apache-exporter:latest 'https://github.com/bitnami/bitnami-docker-apache-exporter.git#master:0/debian-10'
```
