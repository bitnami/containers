...
* [`1.20`, `1.20-debian-11`, `1.20.1`, `1.20.1-debian-11-r2` (1.20/debian-11/Dockerfile)](https://github.com/bitnami/bitnami-docker-contour/blob/1.20.1-debian-11-r2/1.20/debian-11/Dockerfile)
...
```console
$ docker build -t bitnami/contour:latest 'https://github.com/bitnami/bitnami-docker-contour.git#master:1.21/debian-10'
```
