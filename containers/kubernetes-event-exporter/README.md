...
* [`0`, `0-scratch`, `0.9.0`, `0.9.0-scratch-r1`, `latest` (0/scratch/Dockerfile)](https://github.com/bitnami/bitnami-docker-kubernetes-event-exporter/blob/0.9.0-scratch-r1/0/scratch/Dockerfile)
