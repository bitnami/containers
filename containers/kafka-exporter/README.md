...
# How to deploy Kafka Exporter in Kubernetes?

You can find an example for testing Kafka Exporter in Kubernetes with the `test.yaml` file. To launch it, run the command:
...
* [`1-debian-9`, `1.2.0-debian-9-r1`, `1`, `1.2.0`, `1.2.0-r1`, `latest` (1/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-kafka-exporter/blob/1.2.0-debian-9-r1/1/debian-9/Dockerfile)
...
```bash
$ docker build -t bitnami/kafka-exporter:latest https://github.com/bitnami/bitnami-docker-kafka-exporter.git
```
...
If you encountered a problem running this container, you can file an [issue](https://github.com/bitnami/bitnami-docker-kafka-exporter/issues). For us to provide better support, be sure to include the following information in your issue:
