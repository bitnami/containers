...
* [`1`, `1-debian-11`, `1.4.2`, `1.4.2-debian-11-r14`, `latest` (1/debian-11/Dockerfile)](https://github.com/bitnami/bitnami-docker-kafka-exporter/blob/1.4.2-debian-11-r14/1/debian-11/Dockerfile)
...
```console
$ docker build -t bitnami/kafka-exporter:latest 'https://github.com/bitnami/bitnami-docker-kafka-exporter.git#master:1/debian-11'
```
