...
* [`7-ol-7`, `7.5.1-ol-7-r19` (7/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-logstash/blob/7.5.1-ol-7-r19/7/ol-7/Dockerfile)
* [`7-debian-9`, `7.5.1-debian-9-r14`, `7`, `7.5.1`, `7.5.1-r14`, `latest` (7/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-logstash/blob/7.5.1-debian-9-r14/7/debian-9/Dockerfile)
...
```bash
$ docker build -t bitnami/logstash:latest 'https://github.com/bitnami/bitnami-docker-logstash.git#master:7/debian-9'
```
