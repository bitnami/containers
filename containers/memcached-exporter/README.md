...
* [`0`, `0-debian-11`, `0.9.0`, `0.9.0-debian-11-r-1`, `latest` (0/debian-11/Dockerfile)](https://github.com/bitnami/bitnami-docker-memcached-exporter/blob/0.9.0-debian-11-r-1/0/debian-11/Dockerfile)
* [`0`, `0-debian-10`, `0.9.0`, `0.9.0-debian-10-r379`, `latest` (0/debian-10/Dockerfile)](https://github.com/bitnami/bitnami-docker-memcached-exporter/blob/0.9.0-debian-10-r379/0/debian-10/Dockerfile)
...
```console
$ docker build -t bitnami/memcached-exporter:latest 'https://github.com/bitnami/bitnami-docker-memcached-exporter.git#master:0/debian-11'$ docker build -t bitnami/memcached-exporter:latest 'https://github.com/bitnami/bitnami-docker-memcached-exporter.git#master:0/debian-10'
```
