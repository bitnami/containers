...
* [`4.0-debian-9`, `4.0.11-debian-9-r5`, `4.0`, `4.0.11`, `4.0.11-r5`, `latest` (4.0/Dockerfile)](https://github.com/bitnami/bitnami-docker-redis-sentinel/blob/4.0.11-debian-9-r5/4.0/Dockerfile)
