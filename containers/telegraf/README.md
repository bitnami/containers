...
* [`1`, `1-debian-11`, `1.23.0`, `1.23.0-debian-11-r7`, `latest` (1/debian-11/Dockerfile)](https://github.com/bitnami/bitnami-docker-telegraf/blob/1.23.0-debian-11-r7/1/debian-11/Dockerfile)
...
```console
$ docker build -t bitnami/telegraf:latest 'https://github.com/bitnami/bitnami-docker-telegraf.git#master:1/debian-11'
```
