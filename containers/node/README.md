...
# Supported tags and respective `Dockerfile` links
 ...
 - [`9`, `9.2.1-r0` (9/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/9.2.1-r0/9/Dockerfile), [`9-prod`, `9.2.1-r0-prod` (9/prod/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/9.2.1-r0/9/prod/Dockerfile)
 ...
 - [`6`, `6.12.1-r0`, `latest` (6/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/6.12.1-r0/6/Dockerfile), [`6-prod`, `6.12.1-r0-prod` (6/prod/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/6.12.1-r0/6/prod/Dockerfile)
