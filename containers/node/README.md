...
* [`13-photon-3`, `13.5.0-photon-3-r0` (13/photon-3/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/13.5.0-photon-3-r0/13/photon-3/Dockerfile)
* [`13-ol-7-prod`, `13.5.0-ol-7-r17-prod` (13-prod/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/13.5.0-ol-7-r17-prod/13-prod/ol-7/Dockerfile)
* [`13-ol-7`, `13.5.0-ol-7-r17` (13/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/13.5.0-ol-7-r17/13/ol-7/Dockerfile)
* [`13-debian-9-prod`, `13.5.0-debian-9-r13-prod`, `13-prod`, `13.5.0-prod`, `13.5.0-r13-prod` (13-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/13.5.0-debian-9-r13-prod/13-prod/debian-9/Dockerfile)
* [`13-debian-9`, `13.5.0-debian-9-r13`, `13`, `13.5.0`, `13.5.0-r13` (13/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/13.5.0-debian-9-r13/13/debian-9/Dockerfile)
...
* [`12-ol-7-prod`, `12.14.0-ol-7-r18-prod` (12-prod/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/12.14.0-ol-7-r18-prod/12-prod/ol-7/Dockerfile)
* [`12-ol-7`, `12.14.0-ol-7-r18` (12/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/12.14.0-ol-7-r18/12/ol-7/Dockerfile)
* [`12-debian-9`, `12.14.0-debian-9-r14`, `12`, `12.14.0`, `12.14.0-r14` (12/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/12.14.0-debian-9-r14/12/debian-9/Dockerfile)
* [`12-debian-9-prod`, `12.14.0-debian-9-r13-prod`, `12-prod`, `12.14.0-prod`, `12.14.0-r13-prod` (12-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/12.14.0-debian-9-r13-prod/12-prod/debian-9/Dockerfile)
...
* [`11-ol-7-prod`, `11.15.0-ol-7-r264-prod` (11-prod/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/11.15.0-ol-7-r264-prod/11-prod/ol-7/Dockerfile)
* [`11-ol-7`, `11.15.0-ol-7-r262` (11/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/11.15.0-ol-7-r262/11/ol-7/Dockerfile)
* [`11-debian-9`, `11.15.0-debian-9-r230`, `11`, `11.15.0`, `11.15.0-r230` (11/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/11.15.0-debian-9-r230/11/debian-9/Dockerfile)
* [`11-debian-9-prod`, `11.15.0-debian-9-r223-prod`, `11-prod`, `11.15.0-prod`, `11.15.0-r223-prod` (11-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/11.15.0-debian-9-r223-prod/11-prod/debian-9/Dockerfile)
...
* [`10-ol-7-prod`, `10.18.0-ol-7-r18-prod` (10-prod/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/10.18.0-ol-7-r18-prod/10-prod/ol-7/Dockerfile)
* [`10-ol-7`, `10.18.0-ol-7-r18` (10/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/10.18.0-ol-7-r18/10/ol-7/Dockerfile)
* [`10-debian-9-prod`, `10.18.0-debian-9-r14-prod`, `10-prod`, `10.18.0-prod`, `10.18.0-r14-prod`, `latest-prod` (10-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/10.18.0-debian-9-r14-prod/10-prod/debian-9/Dockerfile)
* [`10-debian-9`, `10.18.0-debian-9-r13`, `10`, `10.18.0`, `10.18.0-r13`, `latest` (10/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/10.18.0-debian-9-r13/10/debian-9/Dockerfile)
...
* [`8-ol-7-prod`, `8.17.0-ol-7-r18-prod` (8-prod/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/8.17.0-ol-7-r18-prod/8-prod/ol-7/Dockerfile)
* [`8-ol-7`, `8.17.0-ol-7-r18` (8/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/8.17.0-ol-7-r18/8/ol-7/Dockerfile)
* [`8-debian-9`, `8.17.0-debian-9-r15`, `8`, `8.17.0`, `8.17.0-r15` (8/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/8.17.0-debian-9-r15/8/debian-9/Dockerfile)
* [`8-debian-9-prod`, `8.17.0-debian-9-r13-prod`, `8-prod`, `8.17.0-prod`, `8.17.0-r13-prod` (8-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/8.17.0-debian-9-r13-prod/8-prod/debian-9/Dockerfile)
...
* [`6-ol-7-prod`, `6.17.1-ol-7-r281-prod` (6-prod/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/6.17.1-ol-7-r281-prod/6-prod/ol-7/Dockerfile)
* [`6-ol-7`, `6.17.1-ol-7-r277` (6/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/6.17.1-ol-7-r277/6/ol-7/Dockerfile)
* [`6-debian-9`, `6.17.1-debian-9-r247`, `6`, `6.17.1`, `6.17.1-r247` (6/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/6.17.1-debian-9-r247/6/debian-9/Dockerfile)
* [`6-debian-9-prod`, `6.17.1-debian-9-r240-prod`, `6-prod`, `6.17.1-prod`, `6.17.1-r240-prod` (6-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/6.17.1-debian-9-r240-prod/6-prod/debian-9/Dockerfile)
