...
* [`10-debian-9-prod`, `10.17.0-debian-9-r1-prod`, `10-prod`, `10.17.0-prod`, `10.17.0-r1-prod`, `latest-prod` (10-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/10.17.0-debian-9-r1-prod/10-prod/debian-9/Dockerfile)
