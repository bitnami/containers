...
# Supported tags and respective `Dockerfile` links
 ...
 - [`8`, `8.11.3-r2` (8/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/8.11.3-r2/8/Dockerfile), [`8-prod`, `8.11.3-r2-prod` (8/prod/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/8.11.3-r2/8/prod/Dockerfile)
 ...
 - [`6`, `6.14.3-r3` (6/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/6.14.3-r3/6/Dockerfile), [`6-prod`, `6.14.3-r3-prod` (6/prod/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/6.14.3-r3/6/prod/Dockerfile)
