...
# Supported tags and respective `Dockerfile` links
 ...
 - [`10`, `10.4.0-r2` (10/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/10.4.0-r2/10/Dockerfile), [`10-prod`, `10.4.0-r2-prod` (10/prod/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/10.4.0-r2/10/prod/Dockerfile)
 - [`9`, `9.11.1-r35` (9/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/9.11.1-r35/9/Dockerfile), [`9-prod`, `9.11.1-r35-prod` (9/prod/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/9.11.1-r35/9/prod/Dockerfile)
 ...
 - [`8`, `8.11.2-r8` (8/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/8.11.2-r8/8/Dockerfile), [`8-prod`, `8.11.2-r8-prod` (8/prod/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/8.11.2-r8/8/prod/Dockerfile)
