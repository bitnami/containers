...
* [`13-ol-7-prod`, `13.5.0-ol-7-r16-prod` (13-prod/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/13.5.0-ol-7-r16-prod/13-prod/ol-7/Dockerfile)
* [`13-ol-7`, `13.5.0-ol-7-r16` (13/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/13.5.0-ol-7-r16/13/ol-7/Dockerfile)
* [`13-debian-9-prod`, `13.5.0-debian-9-r12-prod`, `13-prod`, `13.5.0-prod`, `13.5.0-r12-prod` (13-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/13.5.0-debian-9-r12-prod/13-prod/debian-9/Dockerfile)
* [`13-debian-9`, `13.5.0-debian-9-r12`, `13`, `13.5.0`, `13.5.0-r12` (13/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/13.5.0-debian-9-r12/13/debian-9/Dockerfile)
...
* [`12-ol-7-prod`, `12.14.0-ol-7-r17-prod` (12-prod/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/12.14.0-ol-7-r17-prod/12-prod/ol-7/Dockerfile)
* [`12-ol-7`, `12.14.0-ol-7-r17` (12/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/12.14.0-ol-7-r17/12/ol-7/Dockerfile)
* [`12-debian-9`, `12.14.0-debian-9-r13`, `12`, `12.14.0`, `12.14.0-r13` (12/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/12.14.0-debian-9-r13/12/debian-9/Dockerfile)
* [`12-debian-9-prod`, `12.14.0-debian-9-r12-prod`, `12-prod`, `12.14.0-prod`, `12.14.0-r12-prod` (12-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/12.14.0-debian-9-r12-prod/12-prod/debian-9/Dockerfile)
...
* [`11-ol-7-prod`, `11.15.0-ol-7-r263-prod` (11-prod/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/11.15.0-ol-7-r263-prod/11-prod/ol-7/Dockerfile)
* [`11-ol-7`, `11.15.0-ol-7-r261` (11/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/11.15.0-ol-7-r261/11/ol-7/Dockerfile)
* [`11-debian-9`, `11.15.0-debian-9-r229`, `11`, `11.15.0`, `11.15.0-r229` (11/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/11.15.0-debian-9-r229/11/debian-9/Dockerfile)
* [`11-debian-9-prod`, `11.15.0-debian-9-r222-prod`, `11-prod`, `11.15.0-prod`, `11.15.0-r222-prod` (11-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/11.15.0-debian-9-r222-prod/11-prod/debian-9/Dockerfile)
...
* [`10-ol-7-prod`, `10.18.0-ol-7-r17-prod` (10-prod/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/10.18.0-ol-7-r17-prod/10-prod/ol-7/Dockerfile)
* [`10-ol-7`, `10.18.0-ol-7-r17` (10/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/10.18.0-ol-7-r17/10/ol-7/Dockerfile)
* [`10-debian-9-prod`, `10.18.0-debian-9-r13-prod`, `10-prod`, `10.18.0-prod`, `10.18.0-r13-prod`, `latest-prod` (10-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/10.18.0-debian-9-r13-prod/10-prod/debian-9/Dockerfile)
* [`10-debian-9`, `10.18.0-debian-9-r12`, `10`, `10.18.0`, `10.18.0-r12`, `latest` (10/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/10.18.0-debian-9-r12/10/debian-9/Dockerfile)
...
* [`8-ol-7-prod`, `8.17.0-ol-7-r17-prod` (8-prod/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/8.17.0-ol-7-r17-prod/8-prod/ol-7/Dockerfile)
* [`8-ol-7`, `8.17.0-ol-7-r17` (8/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/8.17.0-ol-7-r17/8/ol-7/Dockerfile)
* [`8-debian-9`, `8.17.0-debian-9-r14`, `8`, `8.17.0`, `8.17.0-r14` (8/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/8.17.0-debian-9-r14/8/debian-9/Dockerfile)
* [`8-debian-9-prod`, `8.17.0-debian-9-r12-prod`, `8-prod`, `8.17.0-prod`, `8.17.0-r12-prod` (8-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/8.17.0-debian-9-r12-prod/8-prod/debian-9/Dockerfile)
...
* [`6-ol-7-prod`, `6.17.1-ol-7-r280-prod` (6-prod/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/6.17.1-ol-7-r280-prod/6-prod/ol-7/Dockerfile)
* [`6-ol-7`, `6.17.1-ol-7-r276` (6/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/6.17.1-ol-7-r276/6/ol-7/Dockerfile)
* [`6-debian-9`, `6.17.1-debian-9-r245`, `6`, `6.17.1`, `6.17.1-r245` (6/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/6.17.1-debian-9-r245/6/debian-9/Dockerfile)
* [`6-debian-9-prod`, `6.17.1-debian-9-r239-prod`, `6-prod`, `6.17.1-prod`, `6.17.1-r239-prod` (6-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/6.17.1-debian-9-r239-prod/6-prod/debian-9/Dockerfile)
