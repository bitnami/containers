...
* [`12-debian-9-prod`, `12.6.0-debian-9-r9-prod`, `12-prod`, `12.6.0-prod`, `12.6.0-r9-prod` (12-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/12.6.0-debian-9-r9-prod/12-prod/debian-9/Dockerfile)
