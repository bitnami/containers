...
* [`10-debian-9-prod`, `10.16.0-debian-9-r8-prod`, `10-prod`, `10.16.0-prod`, `10.16.0-r8-prod`, `latest-prod` (10-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/10.16.0-debian-9-r8-prod/10-prod/debian-9/Dockerfile)
...
* [`8-ol-7-prod`, `8.16.0-ol-7-r42-prod` (8-prod/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/8.16.0-ol-7-r42-prod/8-prod/ol-7/Dockerfile)
