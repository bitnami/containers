...
# Supported tags and respective `Dockerfile` links
 ...
 - [`10`, `10.4.1-r4` (10/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/10.4.1-r4/10/Dockerfile), [`10-prod`, `10.4.1-r4-prod` (10/prod/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/10.4.1-r4/10/prod/Dockerfile)
 ...
 - [`8`, `8.11.3-r3` (8/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/8.11.3-r3/8/Dockerfile), [`8-prod`, `8.11.3-r3-prod` (8/prod/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/8.11.3-r3/8/prod/Dockerfile)
 ...
 - [`6`, `6.14.3-r4` (6/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/6.14.3-r4/6/Dockerfile), [`6-prod`, `6.14.3-r4-prod` (6/prod/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/6.14.3-r4/6/prod/Dockerfile)
