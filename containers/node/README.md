...
* [`12-debian-9-prod`, `12.3.1-debian-9-r8-prod`, `12-prod`, `12.3.1-prod`, `12.3.1-r8-prod` (12-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/12.3.1-debian-9-r8-prod/12-prod/debian-9/Dockerfile)
...
* [`10-ol-7-prod`, `10.16.0-ol-7-r0-prod` (10-prod/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/10.16.0-ol-7-r0-prod/10-prod/ol-7/Dockerfile)
...
* [`8-ol-7-prod`, `8.16.0-ol-7-r33-prod` (8-prod/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/8.16.0-ol-7-r33-prod/8-prod/ol-7/Dockerfile)
