...
# Supported tags and respective `Dockerfile` links
 ...
 - [`8`, `8.11.3-r10` (8/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/8.11.3-r10/8/Dockerfile), [`8-prod`, `8.11.3-r10-prod` (8/prod/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/8.11.3-r10/8/prod/Dockerfile)
 - [`8`, `8.11.3-ol-7-r3` (8/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/8.11.3-ol-7-r3/8/Dockerfile), [`8-prod`, `8.11.3-ol-7-r3-prod` (8/prod/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/8.11.3-ol-7-r3/8/prod/Dockerfile)
