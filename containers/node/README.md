...
* [`12-debian-9-prod`, `12.13.0-debian-9-r2-prod`, `12-prod`, `12.13.0-prod`, `12.13.0-r2-prod` (12-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/12.13.0-debian-9-r2-prod/12-prod/debian-9/Dockerfile)
