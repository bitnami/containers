...
* [`8-debian-9-prod`, `8.15.0-debian-9-r9-prod`, `8-prod`, `8.15.0-prod`, `8.15.0-r9-prod`, `latest-prod` (8-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/8.15.0-debian-9-r9-prod/8-prod/debian-9/Dockerfile)
