...
* [`10-ol-7-prod`, `10.15.1-ol-7-r19-prod` (10-prod/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/10.15.1-ol-7-r19-prod/10-prod/ol-7/Dockerfile)
...
* [`8-ol-7-prod`, `8.15.0-ol-7-r19-prod` (8-prod/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/8.15.0-ol-7-r19-prod/8-prod/ol-7/Dockerfile)
...
* [`6-debian-9-prod`, `6.16.0-debian-9-r16-prod`, `6-prod`, `6.16.0-prod`, `6.16.0-r16-prod` (6-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/6.16.0-debian-9-r16-prod/6-prod/debian-9/Dockerfile)
