...
# Supported tags and respective `Dockerfile` links
 ...
 - [`9`, `9.3.0-r1` (9/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/9.3.0-r1/9/Dockerfile), [`9-prod`, `9.3.0-r1-prod` (9/prod/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/9.3.0-r1/9/prod/Dockerfile)
