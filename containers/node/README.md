...
* [`12-debian-9-prod`, `12.14.1-debian-9-r8-prod`, `12-prod`, `12.14.1-prod`, `12.14.1-r8-prod` (12-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/12.14.1-debian-9-r8-prod/12-prod/debian-9/Dockerfile)
...
* [`10-debian-9-prod`, `10.18.1-debian-9-r7-prod`, `10-prod`, `10.18.1-prod`, `10.18.1-r7-prod`, `latest-prod` (10-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/10.18.1-debian-9-r7-prod/10-prod/debian-9/Dockerfile)
...
* [`8-ol-7`, `8.17.0-ol-7-r36` (8/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/8.17.0-ol-7-r36/8/ol-7/Dockerfile)
* [`8-ol-7-prod`, `8.17.0-ol-7-r30-prod` (8-prod/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/8.17.0-ol-7-r30-prod/8-prod/ol-7/Dockerfile)
