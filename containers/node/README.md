...
* [`12-debian-9-prod`, `12.6.0-debian-9-r15-prod`, `12-prod`, `12.6.0-prod`, `12.6.0-r15-prod` (12-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/12.6.0-debian-9-r15-prod/12-prod/debian-9/Dockerfile)
...
* [`8-ol-7`, `8.16.0-ol-7-r85` (8/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/8.16.0-ol-7-r85/8/ol-7/Dockerfile)
...
* [`6-ol-7-prod`, `6.17.1-ol-7-r101-prod` (6-prod/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/6.17.1-ol-7-r101-prod/6-prod/ol-7/Dockerfile)
