...
* [`12-debian-10-prod`, `12.16.0-debian-10-r5-prod`, `12-prod`, `12.16.0-prod`, `latest-prod` (12-prod/debian-10/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/12.16.0-debian-10-r5-prod/12-prod/debian-10/Dockerfile)
...
* [`10-ol-7`, `10.19.0-ol-7-r9` (10/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/10.19.0-ol-7-r9/10/ol-7/Dockerfile)
