...
* [`12-ol-7-prod`, `12.10.0-ol-7-r19-prod` (12-prod/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/12.10.0-ol-7-r19-prod/12-prod/ol-7/Dockerfile)
...
* [`11-ol-7-prod`, `11.15.0-ol-7-r151-prod` (11-prod/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/11.15.0-ol-7-r151-prod/11-prod/ol-7/Dockerfile)
...
* [`10-debian-9-prod`, `10.16.3-debian-9-r35-prod`, `10-prod`, `10.16.3-prod`, `10.16.3-r35-prod`, `latest-prod` (10-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/10.16.3-debian-9-r35-prod/10-prod/debian-9/Dockerfile)
* [`8-ol-7-prod`, `8.16.1-ol-7-r38-prod` (8-prod/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/8.16.1-ol-7-r38-prod/8-prod/ol-7/Dockerfile)
...
* [`6-ol-7-prod`, `6.17.1-ol-7-r166-prod` (6-prod/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/6.17.1-ol-7-r166-prod/6-prod/ol-7/Dockerfile)
...
* [`6-debian-9-prod`, `6.17.1-debian-9-r152-prod`, `6-prod`, `6.17.1-prod`, `6.17.1-r152-prod` (6-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/6.17.1-debian-9-r152-prod/6-prod/debian-9/Dockerfile)
