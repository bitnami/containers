...
* [`10-debian-9-prod`, `10.15.3-debian-9-r1-prod`, `10-prod`, `10.15.3-prod`, `10.15.3-r1-prod` (10-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/10.15.3-debian-9-r1-prod/10-prod/debian-9/Dockerfile)
