...
* [`11-debian-9-prod`, `11.13.0-debian-9-r3-prod`, `11-prod`, `11.13.0-prod`, `11.13.0-r3-prod` (11-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/11.13.0-debian-9-r3-prod/11-prod/debian-9/Dockerfile)
