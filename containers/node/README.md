...
* [`13-photon-3`, `13.6.0-photon-3-r0` (13/photon-3/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/13.6.0-photon-3-r0/13/photon-3/Dockerfile)
* [`13-ol-7`, `13.6.0-ol-7-r12` (13/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/13.6.0-ol-7-r12/13/ol-7/Dockerfile)
* [`13-ol-7-prod`, `13.6.0-ol-7-r11-prod` (13-prod/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/13.6.0-ol-7-r11-prod/13-prod/ol-7/Dockerfile)
* [`13-debian-9-prod`, `13.6.0-debian-9-r10-prod`, `13-prod`, `13.6.0-prod`, `13.6.0-r10-prod` (13-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/13.6.0-debian-9-r10-prod/13-prod/debian-9/Dockerfile)
* [`13-debian-9`, `13.6.0-debian-9-r10`, `13`, `13.6.0`, `13.6.0-r10` (13/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/13.6.0-debian-9-r10/13/debian-9/Dockerfile)
...
* [`12-ol-7-prod`, `12.14.1-ol-7-r9-prod` (12-prod/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/12.14.1-ol-7-r9-prod/12-prod/ol-7/Dockerfile)
* [`12-ol-7`, `12.14.1-ol-7-r12` (12/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/12.14.1-ol-7-r12/12/ol-7/Dockerfile)
* [`12-debian-9`, `12.14.1-debian-9-r11`, `12`, `12.14.1`, `12.14.1-r11` (12/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/12.14.1-debian-9-r11/12/debian-9/Dockerfile)
* [`12-debian-9-prod`, `12.14.1-debian-9-r10-prod`, `12-prod`, `12.14.1-prod`, `12.14.1-r10-prod` (12-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/12.14.1-debian-9-r10-prod/12-prod/debian-9/Dockerfile)
...
* [`11-ol-7`, `11.15.0-ol-7-r281` (11/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/11.15.0-ol-7-r281/11/ol-7/Dockerfile)
* [`11-ol-7-prod`, `11.15.0-ol-7-r277-prod` (11-prod/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/11.15.0-ol-7-r277-prod/11-prod/ol-7/Dockerfile)
* [`11-debian-9`, `11.15.0-debian-9-r248`, `11`, `11.15.0`, `11.15.0-r248` (11/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/11.15.0-debian-9-r248/11/debian-9/Dockerfile)
* [`11-debian-9-prod`, `11.15.0-debian-9-r237-prod`, `11-prod`, `11.15.0-prod`, `11.15.0-r237-prod` (11-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/11.15.0-debian-9-r237-prod/11-prod/debian-9/Dockerfile)
...
* [`10-ol-7-prod`, `10.18.1-ol-7-r9-prod` (10-prod/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/10.18.1-ol-7-r9-prod/10-prod/ol-7/Dockerfile)
* [`10-ol-7`, `10.18.1-ol-7-r10` (10/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/10.18.1-ol-7-r10/10/ol-7/Dockerfile)
* [`10-debian-9-prod`, `10.18.1-debian-9-r8-prod`, `10-prod`, `10.18.1-prod`, `10.18.1-r8-prod`, `latest-prod` (10-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/10.18.1-debian-9-r8-prod/10-prod/debian-9/Dockerfile)
* [`10-debian-9`, `10.18.1-debian-9-r8`, `10`, `10.18.1`, `10.18.1-r8`, `latest` (10/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/10.18.1-debian-9-r8/10/debian-9/Dockerfile)
...
* [`8-ol-7`, `8.17.0-ol-7-r38` (8/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/8.17.0-ol-7-r38/8/ol-7/Dockerfile)
* [`8-ol-7-prod`, `8.17.0-ol-7-r31-prod` (8-prod/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/8.17.0-ol-7-r31-prod/8-prod/ol-7/Dockerfile)
* [`8-debian-9-prod`, `8.17.0-debian-9-r31-prod`, `8-prod`, `8.17.0-prod`, `8.17.0-r31-prod` (8-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/8.17.0-debian-9-r31-prod/8-prod/debian-9/Dockerfile)
* [`8-debian-9`, `8.17.0-debian-9-r28`, `8`, `8.17.0`, `8.17.0-r28` (8/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/8.17.0-debian-9-r28/8/debian-9/Dockerfile)
...
* [`6-ol-7-prod`, `6.17.1-ol-7-r301-prod` (6-prod/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/6.17.1-ol-7-r301-prod/6-prod/ol-7/Dockerfile)
* [`6-ol-7`, `6.17.1-ol-7-r293` (6/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/6.17.1-ol-7-r293/6/ol-7/Dockerfile)
* [`6-debian-9`, `6.17.1-debian-9-r260`, `6`, `6.17.1`, `6.17.1-r260` (6/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/6.17.1-debian-9-r260/6/debian-9/Dockerfile)
* [`6-debian-9-prod`, `6.17.1-debian-9-r258-prod`, `6-prod`, `6.17.1-prod`, `6.17.1-r258-prod` (6-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/6.17.1-debian-9-r258-prod/6-prod/debian-9/Dockerfile)
