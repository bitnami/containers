...
# Supported tags and respective `Dockerfile` links
 ...
 - [`10`, `10.1.0-r1` (10/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/10.1.0-r1/10/Dockerfile), [`10-prod`, `10.1.0-r1-prod` (10/prod/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/10.1.0-r1/10/prod/Dockerfile)
 - [`9`, `9.11.1-r14` (9/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/9.11.1-r14/9/Dockerfile), [`9-prod`, `9.11.1-r14-prod` (9/prod/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/9.11.1-r14/9/prod/Dockerfile)
 - [`8`, `8.11.1-r16` (8/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/8.11.1-r16/8/Dockerfile), [`8-prod`, `8.11.1-r16-prod` (8/prod/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/8.11.1-r16/8/prod/Dockerfile)
 ...
 - [`6`, `6.14.2-r8`, `latest` (6/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/6.14.2-r8/6/Dockerfile), [`6-prod`, `6.14.2-r8-prod` (6/prod/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/6.14.2-r8/6/prod/Dockerfile)
