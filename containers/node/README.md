...
# Supported tags and respective `Dockerfile` links
 ...
 - [`10`, `10.5.0-r11` (10/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/10.5.0-r11/10/Dockerfile), [`10-prod`, `10.5.0-r11-prod` (10/prod/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/10.5.0-r11/10/prod/Dockerfile)
 ...
 - [`6`, `6.14.3-ol-7-r12` (6/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/6.14.3-ol-7-r12/6/Dockerfile), [`6-prod`, `6.14.3-ol-7-r12-prod` (6/prod/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/6.14.3-ol-7-r12/6/prod/Dockerfile)
