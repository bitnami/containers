...
* [`13-ol-7`, `13.6.0-ol-7-r5` (13/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/13.6.0-ol-7-r5/13/ol-7/Dockerfile)
...
* [`13-debian-9-prod`, `13.6.0-debian-9-r3-prod`, `13-prod`, `13.6.0-prod`, `13.6.0-r3-prod` (13-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/13.6.0-debian-9-r3-prod/13-prod/debian-9/Dockerfile)
...
* [`8-ol-7`, `8.17.0-ol-7-r31` (8/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/8.17.0-ol-7-r31/8/ol-7/Dockerfile)
