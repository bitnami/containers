...
# Supported tags and respective `Dockerfile` links
 ...
 - [`10`, `10.4.1-r5` (10/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/10.4.1-r5/10/Dockerfile), [`10-prod`, `10.4.1-r5-prod` (10/prod/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/10.4.1-r5/10/prod/Dockerfile)
 ...
 - [`8`, `8.11.3-r4` (8/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/8.11.3-r4/8/Dockerfile), [`8-prod`, `8.11.3-r4-prod` (8/prod/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/8.11.3-r4/8/prod/Dockerfile)
