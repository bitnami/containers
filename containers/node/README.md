...
* [`13-photon-3`, `13.3.0-photon-3-r0` (13/photon-3/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/13.3.0-photon-3-r0/13/photon-3/Dockerfile)
* [`13-ol-7-prod`, `13.3.0-ol-7-r12-prod` (13-prod/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/13.3.0-ol-7-r12-prod/13-prod/ol-7/Dockerfile)
* [`13-ol-7`, `13.3.0-ol-7-r12` (13/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/13.3.0-ol-7-r12/13/ol-7/Dockerfile)
* [`13-debian-9-prod`, `13.3.0-debian-9-r10-prod`, `13-prod`, `13.3.0-prod`, `13.3.0-r10-prod` (13-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/13.3.0-debian-9-r10-prod/13-prod/debian-9/Dockerfile)
* [`13-debian-9`, `13.3.0-debian-9-r10`, `13`, `13.3.0`, `13.3.0-r10` (13/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/13.3.0-debian-9-r10/13/debian-9/Dockerfile)
* [`12-photon-3`, `12.13.1-photon-3-r0` (12/photon-3/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/12.13.1-photon-3-r0/12/photon-3/Dockerfile)
* [`12-ol-7-prod`, `12.13.1-ol-7-r29-prod` (12-prod/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/12.13.1-ol-7-r29-prod/12-prod/ol-7/Dockerfile)
* [`12-ol-7`, `12.13.1-ol-7-r29` (12/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/12.13.1-ol-7-r29/12/ol-7/Dockerfile)
* [`12-debian-9-prod`, `12.13.1-debian-9-r21-prod`, `12-prod`, `12.13.1-prod`, `12.13.1-r21-prod` (12-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/12.13.1-debian-9-r21-prod/12-prod/debian-9/Dockerfile)
* [`12-debian-9`, `12.13.1-debian-9-r21`, `12`, `12.13.1`, `12.13.1-r21` (12/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/12.13.1-debian-9-r21/12/debian-9/Dockerfile)
...
* [`11-ol-7-prod`, `11.15.0-ol-7-r245-prod` (11-prod/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/11.15.0-ol-7-r245-prod/11-prod/ol-7/Dockerfile)
* [`11-ol-7`, `11.15.0-ol-7-r243` (11/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/11.15.0-ol-7-r243/11/ol-7/Dockerfile)
* [`11-debian-9`, `11.15.0-debian-9-r215`, `11`, `11.15.0`, `11.15.0-r215` (11/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/11.15.0-debian-9-r215/11/debian-9/Dockerfile)
* [`11-debian-9-prod`, `11.15.0-debian-9-r208-prod`, `11-prod`, `11.15.0-prod`, `11.15.0-r208-prod` (11-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/11.15.0-debian-9-r208-prod/11-prod/debian-9/Dockerfile)
* [`10-photon-3`, `10.17.0-photon-3-r0` (10/photon-3/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/10.17.0-photon-3-r0/10/photon-3/Dockerfile)
* [`10-ol-7`, `10.17.0-ol-7-r59` (10/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/10.17.0-ol-7-r59/10/ol-7/Dockerfile)
* [`10-ol-7-prod`, `10.17.0-ol-7-r58-prod` (10-prod/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/10.17.0-ol-7-r58-prod/10-prod/ol-7/Dockerfile)
* [`10-debian-9-prod`, `10.17.0-debian-9-r48-prod`, `10-prod`, `10.17.0-prod`, `10.17.0-r48-prod`, `latest-prod` (10-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/10.17.0-debian-9-r48-prod/10-prod/debian-9/Dockerfile)
* [`10-debian-9`, `10.17.0-debian-9-r37`, `10`, `10.17.0`, `10.17.0-r37`, `latest` (10/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/10.17.0-debian-9-r37/10/debian-9/Dockerfile)
* [`8-photon-3`, `8.16.2-photon-3-r0` (8/photon-3/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/8.16.2-photon-3-r0/8/photon-3/Dockerfile)
* [`8-ol-7-prod`, `8.16.2-ol-7-r74-prod` (8-prod/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/8.16.2-ol-7-r74-prod/8-prod/ol-7/Dockerfile)
* [`8-ol-7`, `8.16.2-ol-7-r72` (8/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/8.16.2-ol-7-r72/8/ol-7/Dockerfile)
* [`8-debian-9`, `8.16.2-debian-9-r60`, `8`, `8.16.2`, `8.16.2-r60` (8/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/8.16.2-debian-9-r60/8/debian-9/Dockerfile)
* [`8-debian-9-prod`, `8.16.2-debian-9-r56-prod`, `8-prod`, `8.16.2-prod`, `8.16.2-r56-prod` (8-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/8.16.2-debian-9-r56-prod/8-prod/debian-9/Dockerfile)
...
* [`6-ol-7-prod`, `6.17.1-ol-7-r262-prod` (6-prod/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/6.17.1-ol-7-r262-prod/6-prod/ol-7/Dockerfile)
* [`6-ol-7`, `6.17.1-ol-7-r258` (6/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/6.17.1-ol-7-r258/6/ol-7/Dockerfile)
* [`6-debian-9`, `6.17.1-debian-9-r231`, `6`, `6.17.1`, `6.17.1-r231` (6/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/6.17.1-debian-9-r231/6/debian-9/Dockerfile)
* [`6-debian-9-prod`, `6.17.1-debian-9-r225-prod`, `6-prod`, `6.17.1-prod`, `6.17.1-r225-prod` (6-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/6.17.1-debian-9-r225-prod/6-prod/debian-9/Dockerfile)
