...
* [`13-debian-9-prod`, `13.2.0-debian-9-r9-prod`, `13-prod`, `13.2.0-prod`, `13.2.0-r9-prod` (13-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/13.2.0-debian-9-r9-prod/13-prod/debian-9/Dockerfile)
...
* [`10-ol-7`, `10.17.0-ol-7-r47` (10/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/10.17.0-ol-7-r47/10/ol-7/Dockerfile)
...
* [`6-ol-7`, `6.17.1-ol-7-r246` (6/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/6.17.1-ol-7-r246/6/ol-7/Dockerfile)
