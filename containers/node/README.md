...
# Supported tags and respective `Dockerfile` links
 ...
 - [`8`, `8.11.3-debian-9-r1` (8/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/8.11.3-debian-9-r1/8/Dockerfile), [`8-prod`, `8.11.3-debian-9-r1-prod` (8/prod/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/8.11.3-debian-9-r1/8/prod/Dockerfile)
