...
* [`13-debian-10-prod`, `13.8.0-debian-10-r1-prod`, `13-prod`, `13.8.0-prod` (13-prod/debian-10/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/13.8.0-debian-10-r1-prod/13-prod/debian-10/Dockerfile)
...
* [`10-debian-10-prod`, `10.19.0-debian-10-r1-prod`, `10-prod`, `10.19.0-prod` (10-prod/debian-10/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/10.19.0-debian-10-r1-prod/10-prod/debian-10/Dockerfile)
