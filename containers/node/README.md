...
* [`10-debian-9-prod`, `10.16.1-debian-9-r6-prod`, `10-prod`, `10.16.1-prod`, `10.16.1-r6-prod`, `latest-prod` (10-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/10.16.1-debian-9-r6-prod/10-prod/debian-9/Dockerfile)
