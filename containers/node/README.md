...
# Supported tags and respective `Dockerfile` links
 ...
 - [`10`, `10.4.1-r9` (10/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/10.4.1-r9/10/Dockerfile), [`10-prod`, `10.4.1-r9-prod` (10/prod/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/10.4.1-r9/10/prod/Dockerfile)
 ...
 - [`6`, `6.14.3-r9` (6/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/6.14.3-r9/6/Dockerfile), [`6-prod`, `6.14.3-r9-prod` (6/prod/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/6.14.3-r9/6/prod/Dockerfile)
