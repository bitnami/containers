...
* [`10-debian-10-prod`, `10.20.1-debian-10-r2-prod`, `10-prod`, `10.20.1-prod` (10-prod/debian-10/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/10.20.1-debian-10-r2-prod/10-prod/debian-10/Dockerfile)
