...
# Supported tags and respective `Dockerfile` links
 ...
 - [`9`, `9.11.1-r17` (9/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/9.11.1-r17/9/Dockerfile), [`9-prod`, `9.11.1-r17-prod` (9/prod/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/9.11.1-r17/9/prod/Dockerfile)
 - [`8`, `8.11.1-r19` (8/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/8.11.1-r19/8/Dockerfile), [`8-prod`, `8.11.1-r19-prod` (8/prod/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/8.11.1-r19/8/prod/Dockerfile)
 - [`7`, `7.10.1-r25` (7/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/7.10.1-r25/7/Dockerfile), [`7-prod`, `7.10.1-r25-prod` (7/prod/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/7.10.1-r25/7/prod/Dockerfile)
