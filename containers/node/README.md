...
# Supported tags and respective `Dockerfile` links
 ...
 - [`10`, `10.0.0-r3` (10/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/10.0.0-r3/10/Dockerfile), [`10-prod`, `10.0.0-r3-prod` (10/prod/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/10.0.0-r3/10/prod/Dockerfile)
 - [`9`, `9.11.1-r5` (9/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/9.11.1-r5/9/Dockerfile), [`9-prod`, `9.11.1-r5-prod` (9/prod/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/9.11.1-r5/9/prod/Dockerfile)
 - [`8`, `8.11.1-r6` (8/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/8.11.1-r6/8/Dockerfile), [`8-prod`, `8.11.1-r6-prod` (8/prod/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/8.11.1-r6/8/prod/Dockerfile)
 - [`7`, `7.10.1-r12` (7/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/7.10.1-r12/7/Dockerfile), [`7-prod`, `7.10.1-r12-prod` (7/prod/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/7.10.1-r12/7/prod/Dockerfile)
