...
# Supported tags and respective `Dockerfile` links
 ...
 - [`9`, `9.5.0-r0` (9/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/9.5.0-r0/9/Dockerfile), [`9-prod`, `9.5.0-r0-prod` (9/prod/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/9.5.0-r0/9/prod/Dockerfile)
 ...
 - [`7`, `7.10.1-r4` (7/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/7.10.1-r4/7/Dockerfile), [`7-prod`, `7.10.1-r4-prod` (7/prod/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/7.10.1-r4/7/prod/Dockerfile)
