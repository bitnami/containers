...
* [`13-debian-9-prod`, `13.6.0-debian-9-r8-prod`, `13-prod`, `13.6.0-prod`, `13.6.0-r8-prod` (13-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/13.6.0-debian-9-r8-prod/13-prod/debian-9/Dockerfile)
