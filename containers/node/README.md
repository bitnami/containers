...
# Supported tags and respective `Dockerfile` links
 ...
 - [`10`, `10.0.0-r12` (10/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/10.0.0-r12/10/Dockerfile), [`10-prod`, `10.0.0-r12-prod` (10/prod/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/10.0.0-r12/10/prod/Dockerfile)
 ...
 - [`8`, `8.11.1-r15` (8/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/8.11.1-r15/8/Dockerfile), [`8-prod`, `8.11.1-r15-prod` (8/prod/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/8.11.1-r15/8/prod/Dockerfile)
 - [`7`, `7.10.1-r21` (7/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/7.10.1-r21/7/Dockerfile), [`7-prod`, `7.10.1-r21-prod` (7/prod/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/7.10.1-r21/7/prod/Dockerfile)
