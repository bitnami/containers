...
* [`13-debian-9-prod`, `13.2.0-debian-9-r3-prod`, `13-prod`, `13.2.0-prod`, `13.2.0-r3-prod` (13-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/13.2.0-debian-9-r3-prod/13-prod/debian-9/Dockerfile)
