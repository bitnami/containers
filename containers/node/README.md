...
* [`12-ol-7-prod`, `12.5.0-ol-7-r4-prod` (12-prod/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/12.5.0-ol-7-r4-prod/12-prod/ol-7/Dockerfile)
