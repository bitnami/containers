...
* [`12-debian-9-prod`, `12.13.0-debian-9-r9-prod`, `12-prod`, `12.13.0-prod`, `12.13.0-r9-prod` (12-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/12.13.0-debian-9-r9-prod/12-prod/debian-9/Dockerfile)
...
* [`6-ol-7-prod`, `6.17.1-ol-7-r213-prod` (6-prod/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/6.17.1-ol-7-r213-prod/6-prod/ol-7/Dockerfile)
