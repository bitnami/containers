...
# Supported tags and respective `Dockerfile` links
 ...
 - [`9`, `9.11.1-r25` (9/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/9.11.1-r25/9/Dockerfile), [`9-prod`, `9.11.1-r25-prod` (9/prod/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/9.11.1-r25/9/prod/Dockerfile)
 - [`8`, `8.11.1-r27` (8/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/8.11.1-r27/8/Dockerfile), [`8-prod`, `8.11.1-r27-prod` (8/prod/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/8.11.1-r27/8/prod/Dockerfile)
