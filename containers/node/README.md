...
* [`12-debian-9-prod`, `12.14.1-debian-9-r6-prod`, `12-prod`, `12.14.1-prod`, `12.14.1-r6-prod` (12-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/12.14.1-debian-9-r6-prod/12-prod/debian-9/Dockerfile)
...
* [`10-ol-7-prod`, `10.18.1-ol-7-r5-prod` (10-prod/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/10.18.1-ol-7-r5-prod/10-prod/ol-7/Dockerfile)
* [`10-debian-9-prod`, `10.18.1-debian-9-r5-prod`, `10-prod`, `10.18.1-prod`, `10.18.1-r5-prod`, `latest-prod` (10-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/10.18.1-debian-9-r5-prod/10-prod/debian-9/Dockerfile)
