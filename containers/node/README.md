...
* [`12-debian-9-prod`, `12.5.0-debian-9-r6-prod`, `12-prod`, `12.5.0-prod`, `12.5.0-r6-prod` (12-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/12.5.0-debian-9-r6-prod/12-prod/debian-9/Dockerfile)
...
* [`11-ol-7-prod`, `11.15.0-ol-7-r68-prod` (11-prod/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/11.15.0-ol-7-r68-prod/11-prod/ol-7/Dockerfile)
