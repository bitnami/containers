...
# Supported tags and respective `Dockerfile` links
 ...
 - [`9`, `9.10.0-r0` (9/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/9.10.0-r0/9/Dockerfile), [`9-prod`, `9.10.0-r0-prod` (9/prod/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/9.10.0-r0/9/prod/Dockerfile)
 - [`8`, `8.11.1-r0` (8/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/8.11.1-r0/8/Dockerfile), [`8-prod`, `8.11.1-r0-prod` (8/prod/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/8.11.1-r0/8/prod/Dockerfile)
