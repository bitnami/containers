...
# Supported tags and respective `Dockerfile` links
 ...
 - [`6`, `6.11.5-r0`, `latest` (6/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/6.11.5-r0/6/Dockerfile), [`6-prod`, `6.11.5-r0-prod`, `latest` (6/prod/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/6.11.5-r0/6/prod/Dockerfile)
 - [`4`, `4.8.5-r0` (4/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/4.8.5-r0/4/Dockerfile), [`4-prod`, `4.8.5-r0-prod`, `latest` (4/prod/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/4.8.5-r0/4/prod/Dockerfile)
