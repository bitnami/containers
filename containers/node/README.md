...
# Supported tags and respective `Dockerfile` links
 ...
 - [`8`, `8.11.1-r9` (8/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/8.11.1-r9/8/Dockerfile), [`8-prod`, `8.11.1-r9-prod` (8/prod/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/8.11.1-r9/8/prod/Dockerfile)
 - [`7`, `7.10.1-r15` (7/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/7.10.1-r15/7/Dockerfile), [`7-prod`, `7.10.1-r15-prod` (7/prod/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/7.10.1-r15/7/prod/Dockerfile)
