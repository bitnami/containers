...
* [`11-debian-9-prod`, `11.13.0-debian-9-r9-prod`, `11-prod`, `11.13.0-prod`, `11.13.0-r9-prod` (11-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/11.13.0-debian-9-r9-prod/11-prod/debian-9/Dockerfile)
...
* [`6-ol-7`, `6.17.1-ol-7-r3` (6/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/6.17.1-ol-7-r3/6/ol-7/Dockerfile)
