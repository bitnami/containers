...
* [`12-debian-9-prod`, `12.10.0-debian-9-r4-prod`, `12-prod`, `12.10.0-prod`, `12.10.0-r4-prod` (12-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/12.10.0-debian-9-r4-prod/12-prod/debian-9/Dockerfile)
...
* [`6-ol-7-prod`, `6.17.1-ol-7-r154-prod` (6-prod/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/6.17.1-ol-7-r154-prod/6-prod/ol-7/Dockerfile)
