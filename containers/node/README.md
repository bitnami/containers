...
* [`6-debian-9-prod`, `6.17.1-debian-9-r102-prod`, `6-prod`, `6.17.1-prod`, `6.17.1-r102-prod` (6-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/6.17.1-debian-9-r102-prod/6-prod/debian-9/Dockerfile)
