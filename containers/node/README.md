...
* [`8-rhel-7`, `8.15.1-rhel-7-r36` (8/rhel-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/8.15.1-rhel-7-r36/8/rhel-7/Dockerfile)
...
* [`8-debian-9-prod`, `8.15.1-debian-9-r34-prod`, `8-prod`, `8.15.1-prod`, `8.15.1-r34-prod`, `latest-prod` (8-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/8.15.1-debian-9-r34-prod/8-prod/debian-9/Dockerfile)
...
* [`6-ol-7`, `6.17.1-ol-7-r1` (6/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/6.17.1-ol-7-r1/6/ol-7/Dockerfile)
