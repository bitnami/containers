...
# Supported tags and respective `Dockerfile` links
 ...
 - [`8`, `8.6.0-r1` (8/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/8.6.0-r1/8/Dockerfile), [`8-prod`, `8.6.0-r1-prod`, `latest` (8/prod/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/8.6.0-r1/8/prod/Dockerfile)
 - [`7`, `7.10.1-r1` (7/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/7.10.1-r1/7/Dockerfile), [`7-prod`, `7.10.1-r1-prod`, `latest` (7/prod/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/7.10.1-r1/7/prod/Dockerfile)
 - [`6`, `6.11.4-r1`, `latest` (6/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/6.11.4-r1/6/Dockerfile), [`6-prod`, `6.11.4-r1-prod`, `latest` (6/prod/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/6.11.4-r1/6/prod/Dockerfile)
 - [`4`, `4.8.4-r1` (4/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/4.8.4-r1/4/Dockerfile), [`4-prod`, `4.8.4-r1-prod`, `latest` (4/prod/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/4.8.4-r1/4/prod/Dockerfile)
