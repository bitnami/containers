...
* [`12-debian-9-prod`, `12.5.0-debian-9-r4-prod`, `12-prod`, `12.5.0-prod`, `12.5.0-r4-prod` (12-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/12.5.0-debian-9-r4-prod/12-prod/debian-9/Dockerfile)
...
* [`10-ol-7-prod`, `10.16.0-ol-7-r34-prod` (10-prod/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/10.16.0-ol-7-r34-prod/10-prod/ol-7/Dockerfile)
...
* [`8-debian-9-prod`, `8.16.0-debian-9-r60-prod`, `8-prod`, `8.16.0-prod`, `8.16.0-r60-prod` (8-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/8.16.0-debian-9-r60-prod/8-prod/debian-9/Dockerfile)
