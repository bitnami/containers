...
# Supported tags and respective `Dockerfile` links
 ...
 - [`8`, `8.9.0-r0` (8/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/8.9.0-r0/8/Dockerfile), [`8-prod`, `8.9.0-r0-prod` (8/prod/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/8.9.0-r0/8/prod/Dockerfile)
 ...
 - [`6`, `6.11.5-r0`, `latest` (6/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/6.11.5-r0/6/Dockerfile), [`6-prod`, `6.11.5-r0-prod` (6/prod/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/6.11.5-r0/6/prod/Dockerfile)
