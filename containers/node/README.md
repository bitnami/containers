...
# Supported tags and respective `Dockerfile` links
 ...
 - [`6`, `6.13.0-r2`, `latest` (6/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/6.13.0-r2/6/Dockerfile), [`6-prod`, `6.13.0-r2-prod` (6/prod/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/6.13.0-r2/6/prod/Dockerfile)
