...
* [`10-ol-7-prod`, `10.15.3-ol-7-r39-prod` (10-prod/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/10.15.3-ol-7-r39-prod/10-prod/ol-7/Dockerfile)
...
* [`8-debian-9-prod`, `8.15.1-debian-9-r44-prod`, `8-prod`, `8.15.1-prod`, `8.15.1-r44-prod`, `latest-prod` (8-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/8.15.1-debian-9-r44-prod/8-prod/debian-9/Dockerfile)
