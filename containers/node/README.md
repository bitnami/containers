...
* [`8-debian-9-prod`, `8.16.1-debian-9-r25-prod`, `8-prod`, `8.16.1-prod`, `8.16.1-r25-prod` (8-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/8.16.1-debian-9-r25-prod/8-prod/debian-9/Dockerfile)
