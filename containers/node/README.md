...
* [`13-debian-10-prod`, `13.14.0-debian-10-r9-prod`, `13-prod`, `13.14.0-prod` (13-prod/debian-10/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/13.14.0-debian-10-r9-prod/13-prod/debian-10/Dockerfile)
...
* [`10-debian-10-prod`, `10.20.1-debian-10-r27-prod`, `10-prod`, `10.20.1-prod` (10-prod/debian-10/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/10.20.1-debian-10-r27-prod/10-prod/debian-10/Dockerfile)
