...
* [`13-debian-9-prod`, `13.0.1-debian-9-r4-prod`, `13-prod`, `13.0.1-prod`, `13.0.1-r4-prod` (13-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/13.0.1-debian-9-r4-prod/13-prod/debian-9/Dockerfile)
