...
* [`13-ol-7-prod`, `13.3.0-ol-7-r2-prod` (13-prod/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/13.3.0-ol-7-r2-prod/13-prod/ol-7/Dockerfile)
* [`13-ol-7`, `13.3.0-ol-7-r2` (13/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/13.3.0-ol-7-r2/13/ol-7/Dockerfile)
* [`13-debian-9-prod`, `13.3.0-debian-9-r1-prod`, `13-prod`, `13.3.0-prod`, `13.3.0-r1-prod` (13-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/13.3.0-debian-9-r1-prod/13-prod/debian-9/Dockerfile)
* [`13-debian-9`, `13.3.0-debian-9-r1`, `13`, `13.3.0`, `13.3.0-r1` (13/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/13.3.0-debian-9-r1/13/debian-9/Dockerfile)
* [`12-ol-7-prod`, `12.13.1-ol-7-r19-prod` (12-prod/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/12.13.1-ol-7-r19-prod/12-prod/ol-7/Dockerfile)
* [`12-ol-7`, `12.13.1-ol-7-r19` (12/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/12.13.1-ol-7-r19/12/ol-7/Dockerfile)
* [`12-debian-9-prod`, `12.13.1-debian-9-r13-prod`, `12-prod`, `12.13.1-prod`, `12.13.1-r13-prod` (12-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/12.13.1-debian-9-r13-prod/12-prod/debian-9/Dockerfile)
* [`12-debian-9`, `12.13.1-debian-9-r13`, `12`, `12.13.1`, `12.13.1-r13` (12/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/12.13.1-debian-9-r13/12/debian-9/Dockerfile)
* [`11-ol-7-prod`, `11.15.0-ol-7-r234-prod` (11-prod/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/11.15.0-ol-7-r234-prod/11-prod/ol-7/Dockerfile)
* [`11-ol-7`, `11.15.0-ol-7-r233` (11/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/11.15.0-ol-7-r233/11/ol-7/Dockerfile)
* [`11-debian-9`, `11.15.0-debian-9-r207`, `11`, `11.15.0`, `11.15.0-r207` (11/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/11.15.0-debian-9-r207/11/debian-9/Dockerfile)
* [`11-debian-9-prod`, `11.15.0-debian-9-r200-prod`, `11-prod`, `11.15.0-prod`, `11.15.0-r200-prod` (11-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/11.15.0-debian-9-r200-prod/11-prod/debian-9/Dockerfile)
...
* [`10-ol-7`, `10.17.0-ol-7-r49` (10/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/10.17.0-ol-7-r49/10/ol-7/Dockerfile)
* [`10-ol-7-prod`, `10.17.0-ol-7-r48-prod` (10-prod/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/10.17.0-ol-7-r48-prod/10-prod/ol-7/Dockerfile)
* [`10-debian-9-prod`, `10.17.0-debian-9-r39-prod`, `10-prod`, `10.17.0-prod`, `10.17.0-r39-prod`, `latest-prod` (10-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/10.17.0-debian-9-r39-prod/10-prod/debian-9/Dockerfile)
* [`10-debian-9`, `10.17.0-debian-9-r29`, `10`, `10.17.0`, `10.17.0-r29`, `latest` (10/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/10.17.0-debian-9-r29/10/debian-9/Dockerfile)
* [`8-ol-7-prod`, `8.16.2-ol-7-r63-prod` (8-prod/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/8.16.2-ol-7-r63-prod/8-prod/ol-7/Dockerfile)
* [`8-ol-7`, `8.16.2-ol-7-r61` (8/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/8.16.2-ol-7-r61/8/ol-7/Dockerfile)
* [`8-debian-9`, `8.16.2-debian-9-r52`, `8`, `8.16.2`, `8.16.2-r52` (8/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/8.16.2-debian-9-r52/8/debian-9/Dockerfile)
* [`8-debian-9-prod`, `8.16.2-debian-9-r48-prod`, `8-prod`, `8.16.2-prod`, `8.16.2-r48-prod` (8-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/8.16.2-debian-9-r48-prod/8-prod/debian-9/Dockerfile)
* [`6-ol-7-prod`, `6.17.1-ol-7-r251-prod` (6-prod/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/6.17.1-ol-7-r251-prod/6-prod/ol-7/Dockerfile)
* [`6-ol-7`, `6.17.1-ol-7-r248` (6/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/6.17.1-ol-7-r248/6/ol-7/Dockerfile)
* [`6-debian-9`, `6.17.1-debian-9-r223`, `6`, `6.17.1`, `6.17.1-r223` (6/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/6.17.1-debian-9-r223/6/debian-9/Dockerfile)
* [`6-debian-9-prod`, `6.17.1-debian-9-r217-prod`, `6-prod`, `6.17.1-prod`, `6.17.1-r217-prod` (6-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/6.17.1-debian-9-r217-prod/6-prod/debian-9/Dockerfile)
