...
# Supported tags and respective `Dockerfile` links
 ...
 - [`9`, `9.11.2-ol-7-r11` (9/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/9.11.2-ol-7-r11/9/Dockerfile), [`9-prod`, `9.11.2-ol-7-r11-prod` (9/prod/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/9.11.2-ol-7-r11/9/prod/Dockerfile)
