...
# Supported tags and respective `Dockerfile` links
 ...
 - [`8`, `8.11.3-ol-7-r8` (8/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/8.11.3-ol-7-r8/8/Dockerfile), [`8-prod`, `8.11.3-ol-7-r8-prod` (8/prod/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/8.11.3-ol-7-r8/8/prod/Dockerfile)
 ...
 - [`7`, `7.10.1-ol-7-r7` (7/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/7.10.1-ol-7-r7/7/Dockerfile), [`7-prod`, `7.10.1-ol-7-r7-prod` (7/prod/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/7.10.1-ol-7-r7/7/prod/Dockerfile)
