...
* [`13-debian-10-prod`, `13.13.0-debian-10-r8-prod`, `13-prod`, `13.13.0-prod` (13-prod/debian-10/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/13.13.0-debian-10-r8-prod/13-prod/debian-10/Dockerfile)
