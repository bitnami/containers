...
* [`11-debian-9-prod`, `11.14.0-debian-9-r5-prod`, `11-prod`, `11.14.0-prod`, `11.14.0-r5-prod` (11-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/11.14.0-debian-9-r5-prod/11-prod/debian-9/Dockerfile)
