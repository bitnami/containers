...
* [`12-ol-7-prod`, `12.12.0-ol-7-r10-prod` (12-prod/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/12.12.0-ol-7-r10-prod/12-prod/ol-7/Dockerfile)
...
* [`10-debian-9-prod`, `10.16.3-debian-9-r63-prod`, `10-prod`, `10.16.3-prod`, `10.16.3-r63-prod`, `latest-prod` (10-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/10.16.3-debian-9-r63-prod/10-prod/debian-9/Dockerfile)
* [`8-ol-7-prod`, `8.16.2-ol-7-r12-prod` (8-prod/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/8.16.2-ol-7-r12-prod/8-prod/ol-7/Dockerfile)
