...
* [`12-debian-10-prod`, `12.14.1-debian-10-r3-prod`, `12-prod`, `12.14.1-prod` (12-prod/debian-10/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/12.14.1-debian-10-r3-prod/12-prod/debian-10/Dockerfile)
...
* [`10-debian-10-prod`, `10.18.1-debian-10-r3-prod`, `10-prod`, `10.18.1-prod`, `latest-prod` (10-prod/debian-10/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/10.18.1-debian-10-r3-prod/10-prod/debian-10/Dockerfile)
