...
* [`12-ol-7-prod`, `12.4.0-ol-7-r18-prod` (12-prod/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/12.4.0-ol-7-r18-prod/12-prod/ol-7/Dockerfile)
...
* [`12-debian-9-prod`, `12.4.0-debian-9-r18-prod`, `12-prod`, `12.4.0-prod`, `12.4.0-r18-prod` (12-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/12.4.0-debian-9-r18-prod/12-prod/debian-9/Dockerfile)
* [`11-ol-7-prod`, `11.15.0-ol-7-r57-prod` (11-prod/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/11.15.0-ol-7-r57-prod/11-prod/ol-7/Dockerfile)
...
* [`10-ol-7-prod`, `10.16.0-ol-7-r25-prod` (10-prod/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/10.16.0-ol-7-r25-prod/10-prod/ol-7/Dockerfile)
...
* [`8-debian-9-prod`, `8.16.0-debian-9-r51-prod`, `8-prod`, `8.16.0-prod`, `8.16.0-r51-prod` (8-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/8.16.0-debian-9-r51-prod/8-prod/debian-9/Dockerfile)
* [`6-ol-7-prod`, `6.17.1-ol-7-r73-prod` (6-prod/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/6.17.1-ol-7-r73-prod/6-prod/ol-7/Dockerfile)
...
* [`6-debian-9`, `6.17.1-debian-9-r64`, `6`, `6.17.1`, `6.17.1-r64` (6/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/6.17.1-debian-9-r64/6/debian-9/Dockerfile)
