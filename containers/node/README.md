...
# Supported tags and respective `Dockerfile` links
 ...
 - [`8`, `8.6.0-r0` (8/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/8.6.0-r0/8/Dockerfile)
 - [`7`, `7.10.1-r0` (7/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/7.10.1-r0/7/Dockerfile)
 - [`6`, `6.11.4-r0`, `latest` (6/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/6.11.4-r0/6/Dockerfile)
