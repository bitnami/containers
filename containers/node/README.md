...
* [`11-debian-9-prod`, `11.15.0-debian-9-r108-prod`, `11-prod`, `11.15.0-prod`, `11.15.0-r108-prod` (11-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/11.15.0-debian-9-r108-prod/11-prod/debian-9/Dockerfile)
...
* [`8-debian-9-prod`, `8.16.1-debian-9-r8-prod`, `8-prod`, `8.16.1-prod`, `8.16.1-r8-prod` (8-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/8.16.1-debian-9-r8-prod/8-prod/debian-9/Dockerfile)
