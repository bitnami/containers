...
# Supported tags and respective `Dockerfile` links
 ...
 - [`7`, `7.10.1-r0` (7/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/7.10.1-r0/7/Dockerfile), [`7-prod`, `7.10.1-r0-prod`, `latest` (7/prod/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/7.10.1-r0/7/prod/Dockerfile)
 ...
 - [`4`, `4.8.4-r0` (4/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/4.8.4-r0/4/Dockerfile), [`4-prod`, `4.8.4-r0-prod`, `latest` (4/prod/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/4.8.4-r0/4/prod/Dockerfile)
