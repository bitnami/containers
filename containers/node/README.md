...
* [`8-debian-9-prod`, `8.15.0-debian-9-r2-prod`, `8-prod`, `8.15.0-prod`, `8.15.0-r2-prod`, `latest-prod` (8-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/8.15.0-debian-9-r2-prod/8-prod/debian-9/Dockerfile)
...
* [`6-ol-7`, `6.16.0-ol-7-r39` (6/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/6.16.0-ol-7-r39/6/ol-7/Dockerfile)
