...
* [`12-debian-9-prod`, `12.7.0-debian-9-r6-prod`, `12-prod`, `12.7.0-prod`, `12.7.0-r6-prod` (12-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/12.7.0-debian-9-r6-prod/12-prod/debian-9/Dockerfile)
