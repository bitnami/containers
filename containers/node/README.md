...
# Supported tags and respective `Dockerfile` links
 ...
 - [`7`, `7.10.1-ol-7-r5` (7/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/7.10.1-ol-7-r5/7/Dockerfile), [`7-prod`, `7.10.1-ol-7-r5-prod` (7/prod/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/7.10.1-ol-7-r5/7/prod/Dockerfile)
