...
* [`12-debian-9-prod`, `12.14.1-debian-9-r9-prod`, `12-prod`, `12.14.1-prod`, `12.14.1-r9-prod` (12-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/12.14.1-debian-9-r9-prod/12-prod/debian-9/Dockerfile)
...
* [`10-ol-7-prod`, `10.18.1-ol-7-r8-prod` (10-prod/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/10.18.1-ol-7-r8-prod/10-prod/ol-7/Dockerfile)
...
* [`8-ol-7`, `8.17.0-ol-7-r37` (8/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/8.17.0-ol-7-r37/8/ol-7/Dockerfile)
