...
* [`11-ol-7-prod`, `11.13.0-ol-7-r5-prod` (11-prod/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/11.13.0-ol-7-r5-prod/11-prod/ol-7/Dockerfile)
...
* [`11-debian-9-prod`, `11.13.0-debian-9-r5-prod`, `11-prod`, `11.13.0-prod`, `11.13.0-r5-prod` (11-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/11.13.0-debian-9-r5-prod/11-prod/debian-9/Dockerfile)
...
* [`10-ol-7`, `10.15.3-ol-7-r28` (10/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/10.15.3-ol-7-r28/10/ol-7/Dockerfile)
...
* [`8-ol-7-prod`, `8.15.1-ol-7-r32-prod` (8-prod/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/8.15.1-ol-7-r32-prod/8-prod/ol-7/Dockerfile)
...
* [`6-debian-9-prod`, `6.17.0-debian-9-r32-prod`, `6-prod`, `6.17.0-prod`, `6.17.0-r32-prod` (6-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/6.17.0-debian-9-r32-prod/6-prod/debian-9/Dockerfile)
