...
* [`12-ol-7-prod`, `12.11.1-ol-7-r9-prod` (12-prod/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/12.11.1-ol-7-r9-prod/12-prod/ol-7/Dockerfile)
...
* [`11-ol-7`, `11.15.0-ol-7-r172` (11/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/11.15.0-ol-7-r172/11/ol-7/Dockerfile)
...
* [`10-ol-7-prod`, `10.16.3-ol-7-r58-prod` (10-prod/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/10.16.3-ol-7-r58-prod/10-prod/ol-7/Dockerfile)
...
* [`8-debian-9-prod`, `8.16.2-debian-9-r0-prod`, `8-prod`, `8.16.2-prod`, `8.16.2-r0-prod` (8-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/8.16.2-debian-9-r0-prod/8-prod/debian-9/Dockerfile)
* [`6-ol-7-prod`, `6.17.1-ol-7-r188-prod` (6-prod/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/6.17.1-ol-7-r188-prod/6-prod/ol-7/Dockerfile)
