...
# Supported tags and respective `Dockerfile` links
 ...
 - [`10`, `10.0.0-r5` (10/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/10.0.0-r5/10/Dockerfile), [`10-prod`, `10.0.0-r5-prod` (10/prod/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/10.0.0-r5/10/prod/Dockerfile)
 ...
 - [`6`, `6.14.2-r0`, `latest` (6/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/6.14.2-r0/6/Dockerfile), [`6-prod`, `6.14.2-r0-prod` (6/prod/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/6.14.2-r0/6/prod/Dockerfile)
