...
* [`13-ol-7-prod`, `13.5.0-ol-7-r9-prod` (13-prod/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/13.5.0-ol-7-r9-prod/13-prod/ol-7/Dockerfile)
...
* [`8-debian-9-prod`, `8.17.0-debian-9-r7-prod`, `8-prod`, `8.17.0-prod`, `8.17.0-r7-prod` (8-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/8.17.0-debian-9-r7-prod/8-prod/debian-9/Dockerfile)
