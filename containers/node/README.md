...
* [`13-ol-7-prod`, `13.2.0-ol-7-r8-prod` (13-prod/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/13.2.0-ol-7-r8-prod/13-prod/ol-7/Dockerfile)
* [`13-ol-7`, `13.2.0-ol-7-r8` (13/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/13.2.0-ol-7-r8/13/ol-7/Dockerfile)
* [`13-debian-9-prod`, `13.2.0-debian-9-r6-prod`, `13-prod`, `13.2.0-prod`, `13.2.0-r6-prod` (13-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/13.2.0-debian-9-r6-prod/13-prod/debian-9/Dockerfile)
* [`13-debian-9`, `13.2.0-debian-9-r6`, `13`, `13.2.0`, `13.2.0-r6` (13/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/13.2.0-debian-9-r6/13/debian-9/Dockerfile)
* [`12-ol-7-prod`, `12.13.1-ol-7-r12-prod` (12-prod/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/12.13.1-ol-7-r12-prod/12-prod/ol-7/Dockerfile)
* [`12-ol-7`, `12.13.1-ol-7-r12` (12/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/12.13.1-ol-7-r12/12/ol-7/Dockerfile)
* [`12-debian-9-prod`, `12.13.1-debian-9-r8-prod`, `12-prod`, `12.13.1-prod`, `12.13.1-r8-prod` (12-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/12.13.1-debian-9-r8-prod/12-prod/debian-9/Dockerfile)
* [`12-debian-9`, `12.13.1-debian-9-r8`, `12`, `12.13.1`, `12.13.1-r8` (12/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/12.13.1-debian-9-r8/12/debian-9/Dockerfile)
* [`11-ol-7-prod`, `11.15.0-ol-7-r228-prod` (11-prod/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/11.15.0-ol-7-r228-prod/11-prod/ol-7/Dockerfile)
* [`11-ol-7`, `11.15.0-ol-7-r227` (11/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/11.15.0-ol-7-r227/11/ol-7/Dockerfile)
* [`11-debian-9`, `11.15.0-debian-9-r202`, `11`, `11.15.0`, `11.15.0-r202` (11/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/11.15.0-debian-9-r202/11/debian-9/Dockerfile)
* [`11-debian-9-prod`, `11.15.0-debian-9-r195-prod`, `11-prod`, `11.15.0-prod`, `11.15.0-r195-prod` (11-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/11.15.0-debian-9-r195-prod/11-prod/debian-9/Dockerfile)
...
* [`10-ol-7`, `10.17.0-ol-7-r42` (10/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/10.17.0-ol-7-r42/10/ol-7/Dockerfile)
* [`10-ol-7-prod`, `10.17.0-ol-7-r41-prod` (10-prod/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/10.17.0-ol-7-r41-prod/10-prod/ol-7/Dockerfile)
* [`10-debian-9-prod`, `10.17.0-debian-9-r34-prod`, `10-prod`, `10.17.0-prod`, `10.17.0-r34-prod`, `latest-prod` (10-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/10.17.0-debian-9-r34-prod/10-prod/debian-9/Dockerfile)
* [`10-debian-9`, `10.17.0-debian-9-r24`, `10`, `10.17.0`, `10.17.0-r24`, `latest` (10/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/10.17.0-debian-9-r24/10/debian-9/Dockerfile)
* [`8-ol-7-prod`, `8.16.2-ol-7-r57-prod` (8-prod/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/8.16.2-ol-7-r57-prod/8-prod/ol-7/Dockerfile)
* [`8-ol-7`, `8.16.2-ol-7-r56` (8/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/8.16.2-ol-7-r56/8/ol-7/Dockerfile)
* [`8-debian-9`, `8.16.2-debian-9-r47`, `8`, `8.16.2`, `8.16.2-r47` (8/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/8.16.2-debian-9-r47/8/debian-9/Dockerfile)
* [`8-debian-9-prod`, `8.16.2-debian-9-r43-prod`, `8-prod`, `8.16.2-prod`, `8.16.2-r43-prod` (8-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/8.16.2-debian-9-r43-prod/8-prod/debian-9/Dockerfile)
* [`6-ol-7-prod`, `6.17.1-ol-7-r245-prod` (6-prod/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/6.17.1-ol-7-r245-prod/6-prod/ol-7/Dockerfile)
* [`6-ol-7`, `6.17.1-ol-7-r242` (6/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/6.17.1-ol-7-r242/6/ol-7/Dockerfile)
* [`6-debian-9`, `6.17.1-debian-9-r218`, `6`, `6.17.1`, `6.17.1-r218` (6/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/6.17.1-debian-9-r218/6/debian-9/Dockerfile)
* [`6-debian-9-prod`, `6.17.1-debian-9-r212-prod`, `6-prod`, `6.17.1-prod`, `6.17.1-r212-prod` (6-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/6.17.1-debian-9-r212-prod/6-prod/debian-9/Dockerfile)
