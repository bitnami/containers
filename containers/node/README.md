...
* [`13-ol-7-prod`, `13.8.0-ol-7-r9-prod` (13-prod/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/13.8.0-ol-7-r9-prod/13-prod/ol-7/Dockerfile)
...
* [`13-debian-10-prod`, `13.8.0-debian-10-r9-prod`, `13-prod`, `13.8.0-prod` (13-prod/debian-10/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/13.8.0-debian-10-r9-prod/13-prod/debian-10/Dockerfile)
