...
* [`11-debian-9-prod`, `11.9.0-debian-9-r1-prod`, `11-prod`, `11.9.0-prod`, `11.9.0-r1-prod` (11-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/11.9.0-debian-9-r1-prod/11-prod/debian-9/Dockerfile)
