...
* [`1`, `1-debian-10`, `1.1.0`, `1.1.0-debian-10-r220`, `latest` (1/debian-10/Dockerfile)](https://github.com/bitnami/bitnami-docker-wal-g/blob/1.1.0-debian-10-r220/1/debian-10/Dockerfile)
...
```console
$ docker build -t bitnami/wal-g:latest 'https://github.com/bitnami/bitnami-docker-wal-g.git#master:1/debian-10'
```
