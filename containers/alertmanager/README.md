...
* [`0`, `0-debian-11`, `0.24.0`, `0.24.0-debian-11-r11`, `latest` (0/debian-11/Dockerfile)](https://github.com/bitnami/bitnami-docker-alertmanager/blob/0.24.0-debian-11-r11/0/debian-11/Dockerfile)
...
```console
$ docker build -t bitnami/alertmanager:latest 'https://github.com/bitnami/bitnami-docker-alertmanager.git#master:0/debian-11'
```
