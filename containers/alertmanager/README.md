...
* [`0`, `0-debian-11`, `0.24.0`, `0.24.0-debian-11-r-1`, `latest` (0/debian-11/Dockerfile)](https://github.com/bitnami/bitnami-docker-alertmanager/blob/0.24.0-debian-11-r-1/0/debian-11/Dockerfile)
* [`0`, `0-debian-10`, `0.24.0`, `0.24.0-debian-10-r41`, `latest` (0/debian-10/Dockerfile)](https://github.com/bitnami/bitnami-docker-alertmanager/blob/0.24.0-debian-10-r41/0/debian-10/Dockerfile)
...
```console
$ docker build -t bitnami/alertmanager:latest 'https://github.com/bitnami/bitnami-docker-alertmanager.git#master:0/debian-11'$ docker build -t bitnami/alertmanager:latest 'https://github.com/bitnami/bitnami-docker-alertmanager.git#master:0/debian-10'
```
