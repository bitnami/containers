...
MONGODB_CLIENT_ROOT_USER="${MONGODB_CLIENT_ROOT_USER:-"${MONGODB_CLIENT_ROOT_USER:-}"}"
MONGODB_CLIENT_ROOT_USER="${MONGODB_CLIENT_ROOT_USER:-"${MONGODB_ROOT_USER:-}"}"
export MONGODB_CLIENT_ROOT_USER="${MONGODB_CLIENT_ROOT_USER:-root}" # only used during the first initialization
MONGODB_CLIENT_ROOT_PASSWORD="${MONGODB_CLIENT_ROOT_PASSWORD:-"${MONGODB_POSTGRES_PASSWORD:-}"}"
MONGODB_CLIENT_ROOT_PASSWORD="${MONGODB_CLIENT_ROOT_PASSWORD:-"${MONGODB_ROOT_PASSWORD:-}"}"
export MONGODB_CLIENT_ROOT_PASSWORD="${MONGODB_CLIENT_ROOT_PASSWORD:-}" # only used during the first initialization
