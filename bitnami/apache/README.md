...
* [`2.4`, `2.4-debian-11`, `2.4.54`, `2.4.54-debian-11-r16`, `latest` (2.4/debian-11/Dockerfile)](https://github.com/bitnami/bitnami-docker-apache/blob/2.4.54-debian-11-r16/2.4/debian-11/Dockerfile)
...
```console
$ docker build -t bitnami/apache:latest 'https://github.com/bitnami/bitnami-docker-apache.git#master:2.4/debian-11'
```
