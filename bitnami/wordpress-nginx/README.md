...
- [`5`, `5-debian-11`, `5.9.3`, `5.9.3-debian-11-r2`, `latest` (5/debian-11/Dockerfile)](https://github.com/bitnami/bitnami-docker-wordpress-nginx/blob/5.9.3-debian-11-r2/5/debian-11/Dockerfile)
...
```console
$ docker build -t bitnami/wordpress-nginx:latest 'https://github.com/bitnami/bitnami-docker-wordpress-nginx.git#master:5/debian-11'
```
