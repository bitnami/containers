...
* [`5.0-ol-7`, `5.0.7-ol-7-r5` (5.0/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-redis-sentinel/blob/5.0.7-ol-7-r5/5.0/ol-7/Dockerfile)
...
* [`4.0-ol-7`, `4.0.14-ol-7-r250` (4.0/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-redis-sentinel/blob/4.0.14-ol-7-r250/4.0/ol-7/Dockerfile)
* [`4.0-debian-9`, `4.0.14-debian-9-r220`, `4.0`, `4.0.14`, `4.0.14-r220` (4.0/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-redis-sentinel/blob/4.0.14-debian-9-r220/4.0/debian-9/Dockerfile)
