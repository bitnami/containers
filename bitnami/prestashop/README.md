...
* [`1.7`, `1.7-debian-10`, `1.7.6-8`, `1.7.6-8-debian-10-r11`, `latest` (1.7/debian-10/Dockerfile)](https://github.com/bitnami/bitnami-docker-prestashop/blob/1.7.6-8-debian-10-r11/1.7/debian-10/Dockerfile)
...
- `PRESTASHOP_ENABLE_HTTPS`: Whether to use HTTPS by default. Default: **off**.
