...
- [`1`, `1-scratch`, `1.12.1`, `1.12.1-scratch-r2`, `latest` (1/scratch/Dockerfile)](https://github.com/bitnami/bitnami-docker-rabbitmq-cluster-operator/blob/1.12.1-scratch-r2/1/scratch/Dockerfile)
