...
- [`1`, `1-scratch`, `1.11.0`, `1.11.0-scratch-r2`, `latest` (1/scratch/Dockerfile)](https://github.com/bitnami/bitnami-docker-rabbitmq-cluster-operator/blob/1.11.0-scratch-r2/1/scratch/Dockerfile)
