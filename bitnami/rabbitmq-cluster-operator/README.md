...
- [`1`, `1-scratch`, `1.13.0`, `1.13.0-scratch-r0`, `latest` (1/scratch/Dockerfile)](https://github.com/bitnami/bitnami-docker-rabbitmq-cluster-operator/blob/1.13.0-scratch-r0/1/scratch/Dockerfile)
