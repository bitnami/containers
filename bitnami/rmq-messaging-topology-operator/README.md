...
- [`1`, `1-scratch`, `1.3.0`, `1.3.0-scratch-r1`, `latest` (1/scratch/Dockerfile)](https://github.com/bitnami/bitnami-docker-rmq-default-credential-updater/blob/1.3.0-scratch-r1/1/scratch/Dockerfile)
