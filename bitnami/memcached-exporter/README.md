...
* [`0-debian-9`, `0.5.0-debian-9-r15`, `0`, `0.5.0`, `0.5.0-r15`, `latest` (0/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-memcached-exporter/blob/0.5.0-debian-9-r15/0/debian-9/Dockerfile)
...
```bash
$ docker build -t bitnami/memcached-exporter:latest https://github.com/bitnami/bitnami-docker-memcached-exporter.git
```
