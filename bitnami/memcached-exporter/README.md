...
# How to deploy Memcached Exporter in Kubernetes?

You can find an example for testing Memcached Exporter in Kubernetes with the `test.yaml` file. To launch it, run the command:
...
* [`0-debian-9`, `0.6.0-debian-9-r112`, `0`, `0.6.0`, `0.6.0-r112`, `latest` (0/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-memcached-exporter/blob/0.6.0-debian-9-r112/0/debian-9/Dockerfile)
...
```bash
$ docker build -t bitnami/memcached-exporter:latest 'https://github.com/bitnami/bitnami-docker-memcached-exporter.git#master:0/debian-9'
```
...
If you encountered a problem running this container, you can file an [issue](https://github.com/bitnami/bitnami-docker-memcached-exporter/issues). For us to provide better support, be sure to include the following information in your issue:
