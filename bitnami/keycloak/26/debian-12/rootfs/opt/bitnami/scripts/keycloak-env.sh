...
keycloak_env_vars=(
    ...
    KEYCLOAK_JDBC_URL
    KEYCLOAK_JDBC_DB_POOL_INITIAL_SIZE
    KEYCLOAK_JDBC_DB_POOL_MIN_SIZE
    KEYCLOAK_JDBC_DB_POOL_MAX_SIZE
    KEYCLOAK_JDBC_TRXN_XA_ENABLED
...
export KEYCLOAK_DATABASE_VENDOR="${KEYCLOAK_DATABASE_VENDOR:-dev-file}"
...
export KEYCLOAK_DATABASE_SCHEMA="${KEYCLOAK_DATABASE_SCHEMA:-}"
export KEYCLOAK_JDBC_PARAMS="${KEYCLOAK_JDBC_PARAMS:-}"
export KEYCLOAK_JDBC_DRIVER="${KEYCLOAK_JDBC_DRIVER:-}"
export KEYCLOAK_JDBC_URL="${KEYCLOAK_JDBC_URL:-}"
export KEYCLOAK_JDBC_DB_POOL_INITIAL_SIZE="${KEYCLOAK_JDBC_DB_POOL_INITIAL_SIZE:-}"
export KEYCLOAK_JDBC_DB_POOL_MIN_SIZE="${KEYCLOAK_JDBC_DB_POOL_MIN_SIZE:-}"
export KEYCLOAK_JDBC_DB_POOL_MAX_SIZE="${KEYCLOAK_JDBC_DB_POOL_MAX_SIZE:-}"
export KEYCLOAK_JDBC_TRXN_XA_ENABLED="${KEYCLOAK_JDBC_TRXN_XA_ENABLED:-false}"
