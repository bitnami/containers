...
```console
docker run --name cloudnative-pg bitnami/cloudnative-pg:latest
```
...
The recommended way to get the Bitnami cloudnative-pg Docker Image is to pull the prebuilt image from the [Docker Hub Registry](https://hub.docker.com/r/bitnami/cloudnative-pg).

```console
docker pull bitnami/cloudnative-pg:latest
```

To use a specific version, you can pull a versioned tag. You can view the [list of available versions](https://hub.docker.com/r/bitnami/cloudnative-pg/tags/) in the Docker Hub Registry.

```console
docker pull bitnami/cloudnative-pg:[TAG]
```
...
```console
docker run --rm --name cloudnative-pg bitnami/cloudnative-pg:latest --  --help
```
