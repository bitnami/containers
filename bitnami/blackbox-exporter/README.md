...
* [`0`, `0-debian-11`, `0.21.1`, `0.21.1-debian-11-r12`, `latest` (0/debian-11/Dockerfile)](https://github.com/bitnami/bitnami-docker-blackbox-exporter/blob/0.21.1-debian-11-r12/0/debian-11/Dockerfile)
...
```console
$ docker build -t bitnami/blackbox-exporter:latest 'https://github.com/bitnami/bitnami-docker-blackbox-exporter.git#master:0/debian-11'
```
...
If you encountered a problem running this container, you can file an [issue](https://github.com/bitnami/bitnami-docker-blackbox-exporter/issues/new). Be sure to include the following information in your issue:
