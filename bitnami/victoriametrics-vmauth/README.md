...
Looking to use VictoriaMetrics Auth in production? Try [VMware Tanzu Application Catalog](https://bitnami.com/enterprise), the commercial edition of the Bitnami catalog.
...
```console
docker pull bitnami/victoriametrics-vmauth:latest
```

To use a specific version, you can pull a versioned tag. You can view the [list of available versions](https://hub.docker.com/r/bitnami/victoriametrics-vmauth/tags/) in the Docker Hub Registry.

```console
docker pull bitnami/victoriametrics-vmauth:[TAG]
```
