...
- [`4`, `4-debian-10`, `4.4.0`, `4.4.0-debian-10-r162`, `latest` (4/debian-10/Dockerfile)](https://github.com/bitnami/bitnami-docker-osclass/blob/4.4.0-debian-10-r162/4/debian-10/Dockerfile)
...
```console
$ docker build -t bitnami/osclass:latest 'https://github.com/bitnami/bitnami-docker-osclass.git#master:4/debian-10'
```
