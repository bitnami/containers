...
* [`4`, `4-debian-10`, `4.8.0-0`, `4.8.0-0-debian-10-r209`, `latest` (4/debian-10/Dockerfile)](https://github.com/bitnami/bitnami-docker-orangehrm/blob/4.8.0-0-debian-10-r209/4/debian-10/Dockerfile)
...
#### Step 3. Create the OrangeHRM container with host volumes
