...
export AIRFLOW_WEBSERVER_SECRET_KEY="${AIRFLOW_WEBSERVER_SECRET_KEY:-}"
export AIRFLOW_APISERVER_SECRET_KEY="${AIRFLOW_APISERVER_SECRET_KEY:-}"
...
export AIRFLOW_LDAP_ALLOW_SELF_SIGNED="${AIRFLOW_LDAP_ALLOW_SELF_SIGNED:-False}"
