...
* [`3`, `3-debian-11`, `3.2.2`, `3.2.2-debian-11-r19`, `latest` (3/debian-11/Dockerfile)](https://github.com/bitnami/bitnami-docker-couchdb/blob/3.2.2-debian-11-r19/3/debian-11/Dockerfile)
...
```console
$ docker build -t bitnami/couchdb:latest 'https://github.com/bitnami/bitnami-docker-couchdb.git#master:3/debian-11'
```
...
If you encountered a problem running this container, you can file an [issue](https://github.com/bitnami/bitnami-docker-couchdb/issues/new). Be sure to include the following information in your issue:
