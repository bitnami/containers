...
# Parse configuration
export PARSE_DASHBOARD_ENABLE_HTTPS="${PARSE_DASHBOARD_ENABLE_HTTPS:-yes}"
...
export PARSE_DASHBOARD_PARSE_MASTER_KEY="${PARSE_DASHBOARD_PARSE_MASTER_KEY:-}"
...
export PARSE_DASHBOARD_PASSWORD="${PARSE_DASHBOARD_PASSWORD:-}"
