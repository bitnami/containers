FROM bitnami/minideb-extras-base:stretch-r317
...
RUN . ./libcomponent.sh && component_unpack "mariadb-galera" "10.3.17-0" --checksum 422da3d56ec7b463c606331a6cf8920f9267767413f02d940303d17ea94fad80
RUN mkdir /docker-entrypoint-initdb.d

COPY rootfs /
RUN /postunpack.sh
ENV BITNAMI_APP_NAME="mariadb-galera" \
    BITNAMI_IMAGE_VERSION="10.3.17-debian-9-r0" \
