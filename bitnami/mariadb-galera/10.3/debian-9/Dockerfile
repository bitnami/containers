...
RUN . ./libcomponent.sh && component_unpack "mariadb-galera" "10.3.21-1" --checksum 1d0a7828ade3757980e9cd117dcd7729b077525174deefb871ea438200a6a8d5
...
ENV BITNAMI_APP_NAME="mariadb-galera" \
    BITNAMI_IMAGE_VERSION="10.3.21-debian-9-r13" \
