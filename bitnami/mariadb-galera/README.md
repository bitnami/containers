...
* [`10.4-debian-10`, `10.4.12-debian-10-r55`, `10.4`, `10.4.12` (10.4/debian-10/Dockerfile)](https://github.com/bitnami/bitnami-docker-mariadb-galera/blob/10.4.12-debian-10-r55/10.4/debian-10/Dockerfile)
* [`10.3-debian-10`, `10.3.22-debian-10-r56`, `10.3`, `10.3.22`, `latest` (10.3/debian-10/Dockerfile)](https://github.com/bitnami/bitnami-docker-mariadb-galera/blob/10.3.22-debian-10-r56/10.3/debian-10/Dockerfile)
* [`10.2-debian-10`, `10.2.31-debian-10-r55`, `10.2`, `10.2.31` (10.2/debian-10/Dockerfile)](https://github.com/bitnami/bitnami-docker-mariadb-galera/blob/10.2.31-debian-10-r55/10.2/debian-10/Dockerfile)
* [`10.1-debian-10`, `10.1.44-debian-10-r55`, `10.1`, `10.1.44` (10.1/debian-10/Dockerfile)](https://github.com/bitnami/bitnami-docker-mariadb-galera/blob/10.1.44-debian-10-r55/10.1/debian-10/Dockerfile)
...
$ docker run --name mariadb \
  --env ALLOW_EMPTY_PASSWORD=yes \
  --env MARIADB_EXTRA_FLAGS='--max-connect-errors=1000 --max_connections=155' \
    bitnami/mariadb-galera:latest
```
...
$ docker run --name mariadb \
  ...
  --env MARIADB_PASSWORD=my_password \
  --env MARIADB_DATABASE=my_database \
  bitnami/mariadb-galera:latest
```
...
$ docker run --name mariadb-galera-0 \
  ...
  --env MARIADB_GALERA_CLUSTER_NAME=my_galera \
  --env MARIADB_GALERA_MARIABACKUP_USER=my_mariabackup_user \
  --env MARIADB_GALERA_MARIABACKUP_PASSWORD=my_mariabackup_password \
...
$ docker run --name mariadb-galera-1 --link mariadb-galera-0:mariadb-galera \
  --env MARIADB_GALERA_CLUSTER_NAME=my_galera \
  --env MARIADB_GALERA_CLUSTER_ADDRESS=gcomm://mariadb-galera \
  --env MARIADB_GALERA_MARIABACKUP_USER=my_mariabackup_user \
  --env MARIADB_GALERA_MARIABACKUP_PASSWORD=my_mariabackup_password \
  bitnami/mariadb-galera:latest
```
...
$ docker run --name mariadb \
    -p 3306:3306 \
    --env ALLOW_EMPTY_PASSWORD=yes \
    --volume /path/to/my_custom.cnf:/opt/bitnami/mariadb/conf/my_custom.cnf:ro \
...
$ docker run --name mariadb \
  --env ALLOW_EMPTY_PASSWORD=yes \
  --volume /path/to/my.cnf:/opt/bitnami/mariadb/conf/my.cnf:ro \
  bitnami/mariadb-galera:latest
```
