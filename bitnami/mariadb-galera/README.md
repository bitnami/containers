...
* [`10.2-centos-7`, `10.2.27-centos-7-r16` (10.2/centos-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-mariadb-galera/blob/10.2.27-centos-7-r16/10.2/centos-7/Dockerfile)
