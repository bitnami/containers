...
* [`10.2-centos-7`, `10.2.29-centos-7-r8` (10.2/centos-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-mariadb-galera/blob/10.2.29-centos-7-r8/10.2/centos-7/Dockerfile)
