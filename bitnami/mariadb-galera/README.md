...
* [`10.3-centos-7`, `10.3.20-centos-7-r32` (10.3/centos-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-mariadb-galera/blob/10.3.20-centos-7-r32/10.3/centos-7/Dockerfile)
