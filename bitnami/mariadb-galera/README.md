...
* [`10.4-debian-10`, `10.4.12-debian-10-r65`, `10.4`, `10.4.12` (10.4/debian-10/Dockerfile)](https://github.com/bitnami/bitnami-docker-mariadb-galera/blob/10.4.12-debian-10-r65/10.4/debian-10/Dockerfile)
* [`10.3-debian-10`, `10.3.22-debian-10-r65`, `10.3`, `10.3.22`, `latest` (10.3/debian-10/Dockerfile)](https://github.com/bitnami/bitnami-docker-mariadb-galera/blob/10.3.22-debian-10-r65/10.3/debian-10/Dockerfile)
* [`10.2-debian-10`, `10.2.31-debian-10-r64`, `10.2`, `10.2.31` (10.2/debian-10/Dockerfile)](https://github.com/bitnami/bitnami-docker-mariadb-galera/blob/10.2.31-debian-10-r64/10.2/debian-10/Dockerfile)
* [`10.1-debian-10`, `10.1.44-debian-10-r64`, `10.1`, `10.1.44` (10.1/debian-10/Dockerfile)](https://github.com/bitnami/bitnami-docker-mariadb-galera/blob/10.1.44-debian-10-r64/10.1/debian-10/Dockerfile)
...
- `MARIADB_ENABLE_SSL_RT`: Whether to enable SSL for replication traffic. Defaults to `no`.
- `MARIADB_SSL_RT_CERT_FILE`: File containing the certificate file for the SSL traffic. No defaults.
- `MARIADB_SSL_RT_KEY_FILE`: File containing the key for certificate. No defaults.
- `MARIADB_SSL_RT_CA_FILE`: File containing the CA of the certificate. No defaults.
...
$ docker run --name mariadb \
  ...
  -e MARIADB_SSL_RT_CERT=/bitnami/mariadb/certs/cert.pem \
  -e MARIADB_SSL_RT_KEY=/bitnami/mariadb/certs/key.pem \
  -e MARIADB_SSL_RT_CA=/bitnami/mariadb/certs/ca.pem \
  bitnami/mariadb-galera:latest
```
