...
* [`10.1-centos-7`, `10.1.43-centos-7-r19` (10.1/centos-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-mariadb-galera/blob/10.1.43-centos-7-r19/10.1/centos-7/Dockerfile)
