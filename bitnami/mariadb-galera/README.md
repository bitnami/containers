...
* [`10.3-centos-7`, `10.3.18-centos-7-r14` (10.3/centos-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-mariadb-galera/blob/10.3.18-centos-7-r14/10.3/centos-7/Dockerfile)
