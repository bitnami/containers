...
* [`2019-ol-7`, `2019.5.14-ol-7-r3` (2019/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-minio/blob/2019.5.14-ol-7-r3/2019/ol-7/Dockerfile)
* [`2019-debian-9`, `2019.5.14-debian-9-r0`, `2019`, `2019.5.14`, `2019.5.14-r0`, `latest` (2019/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-minio/blob/2019.5.14-debian-9-r0/2019/debian-9/Dockerfile)
...
```bash
$ docker build -t bitnami/minio:latest https://github.com/bitnami/bitnami-docker-minio.git
```
