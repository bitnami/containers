...
1. Launch the Apache Airflow Scheduler web container
...
1. Launch the Apache Airflow Scheduler scheduler container
...
1. Launch the Apache Airflow Scheduler worker container
...
1. Create the Apache Airflow Scheduler container
