...
* [`2`, `2-debian-10`, `2.1.4`, `2.1.4-debian-10-r26`, `latest` (2/debian-10/Dockerfile)](https://github.com/bitnami/bitnami-docker-airflow-scheduler/blob/2.1.4-debian-10-r26/2/debian-10/Dockerfile)
* [`1`, `1-debian-10`, `1.10.15`, `1.10.15-debian-10-r193` (1/debian-10/Dockerfile)](https://github.com/bitnami/bitnami-docker-airflow-scheduler/blob/1.10.15-debian-10-r193/1/debian-10/Dockerfile)
...
- `AIRFLOW_SECRET_KEY`: Airflow Scheduler Secret key. No defaults.
- `AIRFLOW_WEBSERVER_HOST`: Airflow Scheduler webserver host. Default: **airflow**
...
- `REDIS_USER`: USER that Airflow Scheduler will use to connect with Redis(TM). No defaults.
- `REDIS_PASSWORD`: Password that Airflow Scheduler will use to connect with Redis(TM). No defaults.
