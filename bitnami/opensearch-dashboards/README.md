# OpenSearch Dashboards packaged by Bitnami
...
Looking to use OpenSearch Dashboards in production? Try [VMware Application Catalog](https://bitnami.com/enterprise), the enterprise edition of Bitnami Application Catalog.
