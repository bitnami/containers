...
export PHPMYADMIN_EXEC_TIME_LIMIT="${PHPMYADMIN_EXEC_TIME_LIMIT:-}"
export PHPMYADMIN_MEMORY_LIMIT="${PHPMYADMIN_MEMORY_LIMIT:-}"
...
export DATABASE_ALLOW_NO_PASSWORD="${DATABASE_ALLOW_NO_PASSWORD:-no}"
