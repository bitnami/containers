# Bitnami package for Spring Cloud Data Flow Shell
...
Looking to use Spring Cloud Data Flow Shell in production? Try [VMware Tanzu Application Catalog](https://bitnami.com/enterprise), the enterprise edition of Bitnami Application Catalog.
