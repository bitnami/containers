...
- [`2`, `2-debian-11`, `2.8.8`, `2.8.8-debian-11-r10`, `latest` (2/debian-11/Dockerfile)](https://github.com/bitnami/containers/blob/main/bitnami/discourse/2/debian-11/Dockerfile)
...
- `DISCOURSE_REDIS_USE_SSL`: Defines if SSL should be used to communicate with Redis(R). Default: **false**
