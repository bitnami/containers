...
LABEL com.vmware.cp.artifact.flavor="sha256:c50c90cfd9d12b445b011e6ad529f1ad3daea45c26d20b00732fae3cd71f6a83" \
      ...
      org.opencontainers.image.created="2024-06-10T02:32:20Z" \
      ...
      org.opencontainers.image.ref.name="4.4.1-debian-12-r0" \
...
RUN mkdir -p /tmp/bitnami/pkg/cache/ ; cd /tmp/bitnami/pkg/cache/ ; \
    COMPONENTS=( \
      ...
      "php-8.1.29-2-linux-${OS_ARCH}-debian-12" \
      "apache-2.4.59-2-linux-${OS_ARCH}-debian-12" \
      "postgresql-client-13.15.0-2-linux-${OS_ARCH}-debian-12" \
      "mysql-client-11.3.2-3-linux-${OS_ARCH}-debian-12" \
      "libphp-8.1.29-0-linux-${OS_ARCH}-debian-12" \
      "moodle-4.4.1-0-linux-${OS_ARCH}-debian-12" \
    ) ; \
