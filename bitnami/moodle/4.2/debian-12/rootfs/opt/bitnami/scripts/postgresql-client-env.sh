...
export POSTGRESQL_CLIENT_SSL_CERTIFICATE="${POSTGRESQL_CLIENT_SSL_CERTIFICATE:-/tmp/postgresql.crt}"
export PGSSLCERT="${PGSSLCERT:-${POSTGRESQL_CLIENT_SSL_CERTIFICATE}}"
