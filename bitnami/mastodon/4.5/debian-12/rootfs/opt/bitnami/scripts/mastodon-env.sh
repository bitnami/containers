...
export MASTODON_ADMIN_PASSWORD="${MASTODON_ADMIN_PASSWORD:-}"
export MASTODON_ADMIN_EMAIL="${MASTODON_ADMIN_EMAIL:-user@bitnami.org}"
export MASTODON_ALLOW_ALL_DOMAINS="${MASTODON_ALLOW_ALL_DOMAINS:-false}"
MASTODON_SECRET_KEY_BASE="${MASTODON_SECRET_KEY_BASE:-"${SECRET_KEY_BASE:-}"}"
export MASTODON_SECRET_KEY_BASE="${MASTODON_SECRET_KEY_BASE:-}"
...
export MASTODON_OTP_SECRET="${MASTODON_OTP_SECRET:-}"
