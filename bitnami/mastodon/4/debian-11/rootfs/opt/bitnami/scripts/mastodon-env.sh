...
export REDIS_HOST="$MASTODON_REDIS_HOST" # only used during the first initialization
...
export REDIS_PORT="$MASTODON_REDIS_PORT_NUMBER" # only used during the first initialization
MASTODON_REDIS_PASSWORD="${MASTODON_REDIS_PASSWORD:-"${REDIS_PASSWORD:-}"}"
export MASTODON_REDIS_PASSWORD="${MASTODON_REDIS_PASSWORD:-}"
export REDIS_PASSWORD="$MASTODON_REDIS_PASSWORD" # only used during the first initialization
...
export MASTODON_DAEMON_GROUP="bitnami"
