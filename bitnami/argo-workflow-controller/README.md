...
* [`3`, `3-scratch`, `3.3.8`, `3.3.8-scratch-r2`, `latest` (3/scratch/Dockerfile)](https://github.com/bitnami/bitnami-docker-argo-workflow-controller/blob/3.3.8-scratch-r2/3/scratch/      Dockerfile)
