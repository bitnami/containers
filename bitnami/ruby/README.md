...
# Supported tags and respective `Dockerfile` links
 ...
 - [`2.5`, `2.5.1-r3`, `latest` (2.5/Dockerfile)](https://github.com/bitnami/bitnami-docker-ruby/blob/2.5.1-r3/2.5/Dockerfile), [`2.5-prod`, `2.5.1-r3-prod` (2.5/prod/Dockerfile)](https://github.com/bitnami/bitnami-docker-ruby/blob/2.5.1-r3/2.5/prod/Dockerfile)
