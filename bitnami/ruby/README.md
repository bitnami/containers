...
* [`2.6-ol-7-prod`, `2.6.2-ol-7-r8-prod` (2.6-prod/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-ruby/blob/2.6.2-ol-7-r8-prod/2.6-prod/ol-7/Dockerfile)
...
* [`2.6-debian-9-prod`, `2.6.2-debian-9-r9-prod`, `2.6-prod`, `2.6.2-prod`, `2.6.2-r9-prod` (2.6-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-ruby/blob/2.6.2-debian-9-r9-prod/2.6-prod/debian-9/Dockerfile)
...
* [`2.5-ol-7`, `2.5.5-ol-7-r7` (2.5/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-ruby/blob/2.5.5-ol-7-r7/2.5/ol-7/Dockerfile)
...
* [`2.4-ol-7-prod`, `2.4.5-ol-7-r43-prod` (2.4-prod/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-ruby/blob/2.4.5-ol-7-r43-prod/2.4-prod/ol-7/Dockerfile)
* [`2.4-ol-7`, `2.4.5-ol-7-r138` (2.4/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-ruby/blob/2.4.5-ol-7-r138/2.4/ol-7/Dockerfile)
* [`2.4-debian-9-prod`, `2.4.5-debian-9-r41-prod`, `2.4-prod`, `2.4.5-prod`, `2.4.5-r41-prod` (2.4-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-ruby/blob/2.4.5-debian-9-r41-prod/2.4-prod/debian-9/Dockerfile)
...
* [`2.3-debian-9-prod`, `2.3.8-debian-9-r43-prod`, `2.3-prod`, `2.3.8-prod`, `2.3.8-r43-prod` (2.3-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-ruby/blob/2.3.8-debian-9-r43-prod/2.3-prod/debian-9/Dockerfile)
* [`2.3-debian-9`, `2.3.8-debian-9-r143`, `2.3`, `2.3.8`, `2.3.8-r143` (2.3/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-ruby/blob/2.3.8-debian-9-r143/2.3/debian-9/Dockerfile)
