...
* [`2.6-ol-7-prod`, `2.6.5-ol-7-r103-prod` (2.6-prod/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-ruby/blob/2.6.5-ol-7-r103-prod/2.6-prod/ol-7/Dockerfile)
* [`2.6-ol-7`, `2.6.5-ol-7-r102` (2.6/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-ruby/blob/2.6.5-ol-7-r102/2.6/ol-7/Dockerfile)
...
* [`2.6-debian-9-prod`, `2.6.5-debian-9-r79-prod`, `2.6-prod`, `2.6.5-prod`, `2.6.5-r79-prod`, `latest-prod` (2.6-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-ruby/blob/2.6.5-debian-9-r79-prod/2.6-prod/debian-9/Dockerfile)
