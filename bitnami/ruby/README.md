...
* [`2.4-ol-7`, `2.4.6-ol-7-r33` (2.4/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-ruby/blob/2.4.6-ol-7-r33/2.4/ol-7/Dockerfile)
* [`2.4-ol-7-prod`, `2.4.6-ol-7-r32-prod` (2.4-prod/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-ruby/blob/2.4.6-ol-7-r32-prod/2.4-prod/ol-7/Dockerfile)
* [`2.4-debian-9-prod`, `2.4.6-debian-9-r25-prod`, `2.4-prod`, `2.4.6-prod`, `2.4.6-r25-prod` (2.4-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-ruby/blob/2.4.6-debian-9-r25-prod/2.4-prod/debian-9/Dockerfile)
...
* [`2.3-debian-9-prod`, `2.3.8-debian-9-r77-prod`, `2.3-prod`, `2.3.8-prod`, `2.3.8-r77-prod` (2.3-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-ruby/blob/2.3.8-debian-9-r77-prod/2.3-prod/debian-9/Dockerfile)
