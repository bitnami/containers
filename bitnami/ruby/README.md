...
# Supported tags and respective `Dockerfile` links
 ...
 - [`2.4`, `2.4.4-r32` (2.4/Dockerfile)](https://github.com/bitnami/bitnami-docker-ruby/blob/2.4.4-r32/2.4/Dockerfile), [`2.4-prod`, `2.4.4-r32-prod` (2.4/prod/Dockerfile)](https://github.com/bitnami/bitnami-docker-ruby/blob/2.4.4-r32/2.4/prod/Dockerfile)
