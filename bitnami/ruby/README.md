...
* [`2.5-debian-9-prod`, `2.5.7-debian-9-r1-prod`, `2.5-prod`, `2.5.7-prod`, `2.5.7-r1-prod` (2.5-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-ruby/blob/2.5.7-debian-9-r1-prod/2.5-prod/debian-9/Dockerfile)
...
* [`2.4-debian-9-prod`, `2.4.9-debian-9-r0-prod`, `2.4-prod`, `2.4.9-prod`, `2.4.9-r0-prod` (2.4-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-ruby/blob/2.4.9-debian-9-r0-prod/2.4-prod/debian-9/Dockerfile)
* [`2.4-debian-9`, `2.4.9-debian-9-r0`, `2.4`, `2.4.9`, `2.4.9-r0` (2.4/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-ruby/blob/2.4.9-debian-9-r0/2.4/debian-9/Dockerfile)
