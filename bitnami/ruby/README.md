...
* [`2.6-debian-9-prod`, `2.6.4-debian-9-r4-prod`, `2.6-prod`, `2.6.4-prod`, `2.6.4-r4-prod`, `latest-prod` (2.6-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-ruby/blob/2.6.4-debian-9-r4-prod/2.6-prod/debian-9/Dockerfile)
...
* [`2.5-debian-9`, `2.5.6-debian-9-r4`, `2.5`, `2.5.6`, `2.5.6-r4` (2.5/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-ruby/blob/2.5.6-debian-9-r4/2.5/debian-9/Dockerfile)
