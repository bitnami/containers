...
* [`2.6-debian-9-prod`, `2.6.5-debian-9-r87-prod`, `2.6-prod`, `2.6.5-prod`, `2.6.5-r87-prod` (2.6-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-ruby/blob/2.6.5-debian-9-r87-prod/2.6-prod/debian-9/Dockerfile)
...
* [`2.4-ol-7-prod`, `2.4.9-ol-7-r111-prod` (2.4-prod/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-ruby/blob/2.4.9-ol-7-r111-prod/2.4-prod/ol-7/Dockerfile)
