...
# Supported tags and respective `Dockerfile` links
 ...
 - [`2.1`, `2.1.10-r14` (2.1/Dockerfile)](https://github.com/bitnami/bitnami-docker-ruby/blob/2.1.10-r14/2.1/Dockerfile), [`2.1-prod`, `2.1.10-r14-prod` (2.1/prod/Dockerfile)](https://github.com/bitnami/bitnami-docker-ruby/blob/2.1.10-r14/2.1/prod/Dockerfile)
