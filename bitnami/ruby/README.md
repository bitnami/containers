...
* [`2.6-ol-7-prod`, `2.6.3-ol-7-r25-prod` (2.6-prod/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-ruby/blob/2.6.3-ol-7-r25-prod/2.6-prod/ol-7/Dockerfile)
...
* [`2.6-debian-9-prod`, `2.6.3-debian-9-r18-prod`, `2.6-prod`, `2.6.3-prod`, `2.6.3-r18-prod`, `latest-prod` (2.6-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-ruby/blob/2.6.3-debian-9-r18-prod/2.6-prod/debian-9/Dockerfile)
...
* [`2.5-ol-7`, `2.5.5-ol-7-r58` (2.5/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-ruby/blob/2.5.5-ol-7-r58/2.5/ol-7/Dockerfile)
...
* [`2.3-debian-9-prod`, `2.3.8-debian-9-r86-prod`, `2.3-prod`, `2.3.8-prod`, `2.3.8-r86-prod` (2.3-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-ruby/blob/2.3.8-debian-9-r86-prod/2.3-prod/debian-9/Dockerfile)
