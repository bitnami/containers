...
* [`2.6-ol-7-prod`, `2.6.1-ol-7-r6-prod` (2.6-prod/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-ruby/blob/2.6.1-ol-7-r6-prod/2.6-prod/ol-7/Dockerfile)
...
* [`2.6-debian-9-prod`, `2.6.1-debian-9-r4-prod`, `2.6-prod`, `2.6.1-prod`, `2.6.1-r4-prod` (2.6-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-ruby/blob/2.6.1-debian-9-r4-prod/2.6-prod/debian-9/Dockerfile)
* [`2.5-ol-7-prod`, `2.5.3-ol-7-r6-prod` (2.5-prod/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-ruby/blob/2.5.3-ol-7-r6-prod/2.5-prod/ol-7/Dockerfile)
* [`2.5-ol-7`, `2.5.3-ol-7-r102` (2.5/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-ruby/blob/2.5.3-ol-7-r102/2.5/ol-7/Dockerfile)
* [`2.5-debian-9-prod`, `2.5.3-debian-9-r5-prod`, `2.5-prod`, `2.5.3-prod`, `2.5.3-r5-prod`, `latest-prod` (2.5-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-ruby/blob/2.5.3-debian-9-r5-prod/2.5-prod/debian-9/Dockerfile)
