...
* [`2.5-debian-9-prod`, `2.5.6-debian-9-r20-prod`, `2.5-prod`, `2.5.6-prod`, `2.5.6-r20-prod` (2.5-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-ruby/blob/2.5.6-debian-9-r20-prod/2.5-prod/debian-9/Dockerfile)
