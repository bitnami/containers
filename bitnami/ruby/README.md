...
* [`2.5-debian-9-prod`, `2.5.3-debian-9-r4-prod`, `2.5-prod`, `2.5.3-prod`, `2.5.3-r4-prod`, `latest-prod` (2.5-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-ruby/blob/2.5.3-debian-9-r4-prod/2.5-prod/debian-9/Dockerfile)
