...
* [`2.6-ol-7-prod`, `2.6.5-ol-7-r53-prod` (2.6-prod/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-ruby/blob/2.6.5-ol-7-r53-prod/2.6-prod/ol-7/Dockerfile)
* [`2.6-ol-7`, `2.6.5-ol-7-r53` (2.6/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-ruby/blob/2.6.5-ol-7-r53/2.6/ol-7/Dockerfile)
...
* [`2.6-debian-9-prod`, `2.6.5-debian-9-r41-prod`, `2.6-prod`, `2.6.5-prod`, `2.6.5-r41-prod`, `latest-prod` (2.6-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-ruby/blob/2.6.5-debian-9-r41-prod/2.6-prod/debian-9/Dockerfile)
* [`2.5-ol-7-prod`, `2.5.7-ol-7-r54-prod` (2.5-prod/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-ruby/blob/2.5.7-ol-7-r54-prod/2.5-prod/ol-7/Dockerfile)
* [`2.5-ol-7`, `2.5.7-ol-7-r53` (2.5/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-ruby/blob/2.5.7-ol-7-r53/2.5/ol-7/Dockerfile)
...
* [`2.4-ol-7-prod`, `2.4.9-ol-7-r54-prod` (2.4-prod/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-ruby/blob/2.4.9-ol-7-r54-prod/2.4-prod/ol-7/Dockerfile)
* [`2.4-ol-7`, `2.4.9-ol-7-r53` (2.4/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-ruby/blob/2.4.9-ol-7-r53/2.4/ol-7/Dockerfile)
...
* [`2.4-debian-9-prod`, `2.4.9-debian-9-r41-prod`, `2.4-prod`, `2.4.9-prod`, `2.4.9-r41-prod` (2.4-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-ruby/blob/2.4.9-debian-9-r41-prod/2.4-prod/debian-9/Dockerfile)
