...
* [`2.6-debian-9-prod`, `2.6.2-debian-9-r26-prod`, `2.6-prod`, `2.6.2-prod`, `2.6.2-r26-prod` (2.6-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-ruby/blob/2.6.2-debian-9-r26-prod/2.6-prod/debian-9/Dockerfile)
...
* [`2.4-debian-9`, `2.4.6-debian-9-r7`, `2.4`, `2.4.6`, `2.4.6-r7` (2.4/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-ruby/blob/2.4.6-debian-9-r7/2.4/debian-9/Dockerfile)
* [`2.3-ol-7-prod`, `2.3.8-ol-7-r60-prod` (2.3-prod/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-ruby/blob/2.3.8-ol-7-r60-prod/2.3-prod/ol-7/Dockerfile)
