...
* [`2.6-debian-9-prod`, `2.6.2-debian-9-r21-prod`, `2.6-prod`, `2.6.2-prod`, `2.6.2-r21-prod` (2.6-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-ruby/blob/2.6.2-debian-9-r21-prod/2.6-prod/debian-9/Dockerfile)
...
* [`2.5-ol-7`, `2.5.5-ol-7-r19` (2.5/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-ruby/blob/2.5.5-ol-7-r19/2.5/ol-7/Dockerfile)
...
* [`2.3-debian-9-prod`, `2.3.8-debian-9-r55-prod`, `2.3-prod`, `2.3.8-prod`, `2.3.8-r55-prod` (2.3-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-ruby/blob/2.3.8-debian-9-r55-prod/2.3-prod/debian-9/Dockerfile)
