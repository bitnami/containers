...
* [`2.7-ol-7`, `2.7.0-ol-7-r25` (2.7/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-ruby/blob/2.7.0-ol-7-r25/2.7/ol-7/Dockerfile)
...
* [`2.7-debian-10-prod`, `2.7.0-debian-10-r12-prod`, `2.7-prod`, `2.7.0-prod`, `latest-prod` (2.7-prod/debian-10/Dockerfile)](https://github.com/bitnami/bitnami-docker-ruby/blob/2.7.0-debian-10-r12-prod/2.7-prod/debian-10/Dockerfile)
...
* [`2.6-ol-7`, `2.6.5-ol-7-r129` (2.6/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-ruby/blob/2.6.5-ol-7-r129/2.6/ol-7/Dockerfile)
...
* [`2.6-debian-10-prod`, `2.6.5-debian-10-r12-prod`, `2.6-prod`, `2.6.5-prod` (2.6-prod/debian-10/Dockerfile)](https://github.com/bitnami/bitnami-docker-ruby/blob/2.6.5-debian-10-r12-prod/2.6-prod/debian-10/Dockerfile)
* [`2.6-debian-10`, `2.6.5-debian-10-r12`, `2.6`, `2.6.5` (2.6/debian-10/Dockerfile)](https://github.com/bitnami/bitnami-docker-ruby/blob/2.6.5-debian-10-r12/2.6/debian-10/Dockerfile)
...
* [`2.5-ol-7-prod`, `2.5.7-ol-7-r127-prod` (2.5-prod/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-ruby/blob/2.5.7-ol-7-r127-prod/2.5-prod/ol-7/Dockerfile)
* [`2.5-debian-10-prod`, `2.5.7-debian-10-r12-prod`, `2.5-prod`, `2.5.7-prod` (2.5-prod/debian-10/Dockerfile)](https://github.com/bitnami/bitnami-docker-ruby/blob/2.5.7-debian-10-r12-prod/2.5-prod/debian-10/Dockerfile)
...
* [`2.4-ol-7`, `2.4.9-ol-7-r133` (2.4/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-ruby/blob/2.4.9-ol-7-r133/2.4/ol-7/Dockerfile)
* [`2.4-ol-7-prod`, `2.4.9-ol-7-r127-prod` (2.4-prod/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-ruby/blob/2.4.9-ol-7-r127-prod/2.4-prod/ol-7/Dockerfile)
