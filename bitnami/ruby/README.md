...
# Supported tags and respective `Dockerfile` links
 ...
 - [`2.5`, `2.5.1-r4`, `latest` (2.5/Dockerfile)](https://github.com/bitnami/bitnami-docker-ruby/blob/2.5.1-r4/2.5/Dockerfile), [`2.5-prod`, `2.5.1-r4-prod` (2.5/prod/Dockerfile)](https://github.com/bitnami/bitnami-docker-ruby/blob/2.5.1-r4/2.5/prod/Dockerfile)
 - [`2.4`, `2.4.4-r4` (2.4/Dockerfile)](https://github.com/bitnami/bitnami-docker-ruby/blob/2.4.4-r4/2.4/Dockerfile), [`2.4-prod`, `2.4.4-r4-prod` (2.4/prod/Dockerfile)](https://github.com/bitnami/bitnami-docker-ruby/blob/2.4.4-r4/2.4/prod/Dockerfile)
 - [`2.3`, `2.3.7-r4` (2.3/Dockerfile)](https://github.com/bitnami/bitnami-docker-ruby/blob/2.3.7-r4/2.3/Dockerfile), [`2.3-prod`, `2.3.7-r4-prod` (2.3/prod/Dockerfile)](https://github.com/bitnami/bitnami-docker-ruby/blob/2.3.7-r4/2.3/prod/Dockerfile)
