...
```bash
$ curl -LO https://raw.githubusercontent.com/bitnami/bitnami-docker-harbor-clair/master/docker-compose.yml
$ docker-compose up
```
...
* [`1-ol-7`, `1.9.3-ol-7-r21` (1/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-harbor-clair/blob/1.9.3-ol-7-r21/1/ol-7/Dockerfile)
* [`1-debian-9`, `1.9.3-debian-9-r15`, `1`, `1.9.3`, `1.9.3-r15`, `latest` (1/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-harbor-clair/blob/1.9.3-debian-9-r15/1/debian-9/Dockerfile)
* [`1-centos-7`, `1.9.3-centos-7-r0` (1/centos-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-harbor-clair/blob/1.9.3-centos-7-r0/1/centos-7/Dockerfile)
* [`1-photon-3`, `1.0.0-photon-3-r0` (1/photon-3/Dockerfile)](https://github.com/bitnami/bitnami-docker-harbor-clair/blob/1.0.0-photon-3-r0/1/photon-3/Dockerfile)
...
If you encountered a problem running this container, you can file an [issue](https://github.com/bitnami/bitnami-docker-harbor-clair/issues). For us to provide better support, be sure to include the following information in your issue:
