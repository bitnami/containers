...
# Supported tags and respective `Dockerfile` links
 ...
 - [`11`, `11.0.0-r22`, `latest` (11/Dockerfile)](https://github.com/bitnami/bitnami-docker-wildfly/blob/11.0.0-r22/11/Dockerfile)
 - [`10`, `10.1.0-r27` (10/Dockerfile)](https://github.com/bitnami/bitnami-docker-wildfly/blob/10.1.0-r27/10/Dockerfile)
