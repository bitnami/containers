...
* [`18-ol-7`, `18.0.1-ol-7-r45` (18/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-wildfly/blob/18.0.1-ol-7-r45/18/ol-7/Dockerfile)
* [`18-debian-9`, `18.0.1-debian-9-r32`, `18`, `18.0.1`, `18.0.1-r32`, `latest` (18/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-wildfly/blob/18.0.1-debian-9-r32/18/debian-9/Dockerfile)
...
```bash
$ docker build -t bitnami/wildfly:latest 'https://github.com/bitnami/bitnami-docker-wildfly.git#master:18/debian-9'
```
