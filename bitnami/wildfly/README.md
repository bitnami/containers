...
* [`12`, `12.0.0-r37` (12/Dockerfile)](https://github.com/bitnami/bitnami-docker-wildfly/blob/12.0.0-r37/12/Dockerfile)
...
* [`11`, `11.0.0-r46`, `latest` (11/Dockerfile)](https://github.com/bitnami/bitnami-docker-wildfly/blob/11.0.0-r46/11/Dockerfile)
