...
# Supported tags and respective `Dockerfile` links
 ...
 - [`12`, `12.0.0-r26` (12/Dockerfile)](https://github.com/bitnami/bitnami-docker-wildfly/blob/12.0.0-r26/12/Dockerfile)
 - [`11`, `11.0.0-r33`, `latest` (11/Dockerfile)](https://github.com/bitnami/bitnami-docker-wildfly/blob/11.0.0-r33/11/Dockerfile)
