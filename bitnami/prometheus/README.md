...
* [`2-photon-3`, `2.14.0-photon-3-r0` (2/photon-3/Dockerfile)](https://github.com/bitnami/bitnami-docker-prometheus/blob/2.14.0-photon-3-r0/2/photon-3/Dockerfile)
* [`2-ol-7`, `2.14.0-ol-7-r34` (2/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-prometheus/blob/2.14.0-ol-7-r34/2/ol-7/Dockerfile)
* [`2-debian-9`, `2.14.0-debian-9-r29`, `2`, `2.14.0`, `2.14.0-r29`, `latest` (2/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-prometheus/blob/2.14.0-debian-9-r29/2/debian-9/Dockerfile)
...
```bash
$ docker build -t bitnami/prometheus:latest 'https://github.com/bitnami/bitnami-docker-prometheus.git#master:2/debian-9'
```
