...
* [`2`, `2-debian-11`, `2.37.0`, `2.37.0-debian-11-r2`, `latest` (2/debian-11/Dockerfile)](https://github.com/bitnami/bitnami-docker-prometheus/blob/2.37.0-debian-11-r2/2/debian-11/Dockerfile)
...
```console
$ docker build -t bitnami/prometheus:latest 'https://github.com/bitnami/bitnami-docker-prometheus.git#master:2/debian-11'
```
