...
elasticsearch_env_vars=(
    ...
    ELASTICSEARCH_FIPS_REQUIRED_PROVIDERS
...
export ELASTICSEARCH_FIPS_REQUIRED_PROVIDERS="${ELASTICSEARCH_FIPS_REQUIRED_PROVIDERS:-}"
export ES_KEYSTORE_PASSPHRASE_FILE="${ES_KEYSTORE_PASSPHRASE_FILE:-}"
