...
| `ELASTICSEARCH_PASSWORD`                          | Password for "elastic" user.                                                                                              | `nil`                                          |
...
| `ELASTICSEARCH_FIPS_REQUIRED_PROVIDERS`           | Comma-separated list of required FIPS security providers to enforce at startup (e.g. "BCFIPS,BCJSSE"). Requires ES 8.13+. | `nil`                                          |
| `ES_KEYSTORE_PASSPHRASE_FILE`                     | Path to a file containing the password for the Elasticsearch secure settings keystore (required in FIPS restricted mode). | `nil`                                          |
