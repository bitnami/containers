...
# Paths
export ELASTICSEARCH_VOLUME_DIR="${ELASTICSEARCH_VOLUME_DIR:-/bitnami/elasticsearch}"
export DB_VOLUME_DIR="$ELASTICSEARCH_VOLUME_DIR"
export ELASTICSEARCH_BASE_DIR="${ELASTICSEARCH_VOLUME_DIR:-/opt/bitnami/elasticsearch}"
export DB_BASE_DIR="$ELASTICSEARCH_BASE_DIR"
export ELASTICSEARCH_CONF_DIR="${ELASTICSEARCH_CONF_DIR:-${DB_BASE_DIR}/config}"
export DB_CONF_DIR="$ELASTICSEARCH_CONF_DIR"
export ELASTICSEARCH_DEFAULT_CONF_DIR="${ELASTICSEARCH_DEFAULT_CONF_DIR:-${DB_BASE_DIR}/config.default}"
...
export ELASTICSEARCH_LOGS_DIR="${ELASTICSEARCH_LOGS_DIR:-${DB_BASE_DIR}/logs}"
export DB_LOGS_DIR="$ELASTICSEARCH_LOGS_DIR"
export ELASTICSEARCH_PLUGINS_DIR="${ELASTICSEARCH_PLUGINS_DIR:-${DB_BASE_DIR}/plugins}"
export DB_PLUGINS_DIR="$ELASTICSEARCH_PLUGINS_DIR"
export ELASTICSEARCH_DEFAULT_PLUGINS_DIR="${ELASTICSEARCH_DEFAULT_PLUGINS_DIR:-${DB_BASE_DIR}/plugins.default}"
export DB_DEFAULT_PLUGINS_DIR="$ELASTICSEARCH_DEFAULT_PLUGINS_DIR"
export ELASTICSEARCH_DATA_DIR="${ELASTICSEARCH_DATA_DIR:-${DB_VOLUME_DIR}/data}"
...
export ELASTICSEARCH_TMP_DIR="${ELASTICSEARCH_TMP_DIR:-${DB_BASE_DIR}/tmp}"
export DB_TMP_DIR="$ELASTICSEARCH_TMP_DIR"
export ELASTICSEARCH_BIN_DIR="${ELASTICSEARCH_BIN_DIR:-${DB_BASE_DIR}/bin}"
export DB_BIN_DIR="$ELASTICSEARCH_BIN_DIR"
export ELASTICSEARCH_MOUNTED_PLUGINS_DIR="${ELASTICSEARCH_MOUNTED_PLUGINS_DIR:-${DB_VOLUME_DIR}/plugins}"
export DB_MOUNTED_PLUGINS_DIR="$ELASTICSEARCH_MOUNTED_PLUGINS_DIR"
export ELASTICSEARCH_CONF_FILE="${ELASTICSEARCH_CONF_FILE:-${DB_CONF_DIR}/elasticsearch.yml}"
export DB_CONF_FILE="$ELASTICSEARCH_CONF_FILE"
export ELASTICSEARCH_LOG_FILE="${ELASTICSEARCH_LOG_FILE:-${DB_LOGS_DIR}/elasticsearch.log}"
export DB_LOG_FILE="$ELASTICSEARCH_LOG_FILE"
export ELASTICSEARCH_PID_FILE="${ELASTICSEARCH_PID_FILE:-${DB_TMP_DIR}/elasticsearch.pid}"
export DB_PID_FILE="$ELASTICSEARCH_PID_FILE"
export ELASTICSEARCH_INITSCRIPTS_DIR="${ELASTICSEARCH_INITSCRIPTS_DIR:-/docker-entrypoint-initdb.d}"
