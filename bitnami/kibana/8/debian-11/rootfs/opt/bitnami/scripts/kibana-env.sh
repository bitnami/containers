...
export SERVER_PUBLICBASEURL="$KIBANA_SERVER_PUBLICBASEURL"
export KIBANA_XPACK_SECURITY_ENCRYPTIONKEY="${KIBANA_XPACK_SECURITY_ENCRYPTIONKEY:-}"
export XPACK_SECURITY_ENCRYPTIONKEY="$KIBANA_XPACK_SECURITY_ENCRYPTIONKEY"
export KIBANA_XPACK_REPORTING_ENCRYPTIONKEY="${KIBANA_XPACK_REPORTING_ENCRYPTIONKEY:-}"
export XPACK_REPORTING_ENCRYPTIONKEY="$KIBANA_XPACK_REPORTING_ENCRYPTIONKEY"
export KIBANA_NEWSFEED_ENABLED="${KIBANA_NEWSFEED_ENABLED:-true}"
export NEWSFEED_ENABLED="$KIBANA_NEWSFEED_ENABLED"
export KIBANA_ELASTICSEARCH_REQUESTTIMEOUT="${KIBANA_ELASTICSEARCH_REQUESTTIMEOUT:-30000}"
export ELASTICSEARCH_REQUESTTIMEOUT="$KIBANA_ELASTICSEARCH_REQUESTTIMEOUT"
