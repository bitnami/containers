...
* [`0`, `0-debian-11`, `0.7.1`, `0.7.1-debian-11-r19`, `latest` (0/debian-11/Dockerfile)](https://github.com/bitnami/bitnami-docker-configmap-reload/blob/0.7.1-debian-11-r19/0/debian-11/Dockerfile)
...
```console
$ docker build -t bitnami/configmap-reload:latest 'https://github.com/bitnami/bitnami-docker-configmap-reload.git#master:0/debian-11'
```
