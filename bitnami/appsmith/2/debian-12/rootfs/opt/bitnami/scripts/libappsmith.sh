...
appsmith_initialize() {
    ...
    chmod 600 "$APPSMITH_CONF_FILE" || true
...
appsmith_backend_start_bg() {
    ...
    # This is done in a subshell so the auto-exported configuration variables stay
    # scoped to the backend process and do not leak into the rest of the environment.
    (
