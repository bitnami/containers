# Flux Image Automation Controller packaged by Bitnami
...
Looking to use Flux Image Automation Controller in production? Try [VMware Application Catalog](https://bitnami.com/enterprise), the enterprise edition of Bitnami Application Catalog.
