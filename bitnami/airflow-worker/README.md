...
* [`1-rhel-7`, `1.10.2-rhel-7-r11` (1/rhel-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-airflow-worker-scheduler/blob/1.10.2-rhel-7-r11/1/rhel-7/Dockerfile)
* [`1-ol-7`, `1.10.2-ol-7-r21` (1/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-airflow-worker-scheduler/blob/1.10.2-ol-7-r21/1/ol-7/Dockerfile)
* [`1-debian-9`, `1.10.2-debian-9-r27`, `1`, `1.10.2`, `1.10.2-r27`, `latest` (1/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-airflow-worker-scheduler/blob/1.10.2-debian-9-r27/1/debian-9/Dockerfile)
...
The recommended way to run Airflow Worker is using Docker Compose using the following `docker-compose.yml` template:
...
- `AIRFLOW_WEBSERVER_HOST`: Airflow Worker webserver host. Default: **127.0.0.1**
...
If you encountered a problem running this container, you can file an [issue](https://github.com/bitnami/bitnami-docker-airflow-worker/issues). For us to provide better support, be sure to include the following information in your issue:
