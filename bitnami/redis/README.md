...
* [`5.0-ol-7`, `5.0.5-ol-7-r182` (5.0/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-redis/blob/5.0.5-ol-7-r182/5.0/ol-7/Dockerfile)
...
* [`5.0-centos-7`, `5.0.5-centos-7-r161` (5.0/centos-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-redis/blob/5.0.5-centos-7-r161/5.0/centos-7/Dockerfile)
...
* [`4.0-centos-7`, `4.0.14-centos-7-r168` (4.0/centos-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-redis/blob/4.0.14-centos-7-r168/4.0/centos-7/Dockerfile)
