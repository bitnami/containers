...
* [`5.0-ol-7`, `5.0.5-ol-7-r164` (5.0/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-redis/blob/5.0.5-ol-7-r164/5.0/ol-7/Dockerfile)
...
* [`5.0-centos-7`, `5.0.5-centos-7-r143` (5.0/centos-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-redis/blob/5.0.5-centos-7-r143/5.0/centos-7/Dockerfile)
* [`4.0-ol-7`, `4.0.14-ol-7-r212` (4.0/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-redis/blob/4.0.14-ol-7-r212/4.0/ol-7/Dockerfile)
...
* [`4.0-centos-7`, `4.0.14-centos-7-r148` (4.0/centos-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-redis/blob/4.0.14-centos-7-r148/4.0/centos-7/Dockerfile)
