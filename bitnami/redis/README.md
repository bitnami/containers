...
* [`5.0-centos-7`, `5.0.5-centos-7-r129` (5.0/centos-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-redis/blob/5.0.5-centos-7-r129/5.0/centos-7/Dockerfile)
