...
* [`5.0-ol-7`, `5.0.5-ol-7-r22` (5.0/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-redis/blob/5.0.5-ol-7-r22/5.0/ol-7/Dockerfile)
...
* [`4.0-centos-7`, `4.0.14-centos-7-r8` (4.0/centos-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-redis/blob/4.0.14-centos-7-r8/4.0/centos-7/Dockerfile)
