...
* [`5.0-ol-7`, `5.0.5-ol-7-r15` (5.0/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-redis/blob/5.0.5-ol-7-r15/5.0/ol-7/Dockerfile)
* [`5.0-debian-9`, `5.0.5-debian-9-r14`, `5.0`, `5.0.5`, `5.0.5-r14`, `latest` (5.0/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-redis/blob/5.0.5-debian-9-r14/5.0/debian-9/Dockerfile)
* [`5.0-centos-7`, `5.0.5-centos-7-r0` (5.0/centos-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-redis/blob/5.0.5-centos-7-r0/5.0/centos-7/Dockerfile)
...
* [`4.0-debian-9`, `4.0.14-debian-9-r52`, `4.0`, `4.0.14`, `4.0.14-r52` (4.0/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-redis/blob/4.0.14-debian-9-r52/4.0/debian-9/Dockerfile)
* [`4.0-centos-7`, `4.0.14-centos-7-r0` (4.0/centos-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-redis/blob/4.0.14-centos-7-r0/4.0/centos-7/Dockerfile)
