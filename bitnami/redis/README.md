...
* [`4.0-debian-9`, `4.0.11-debian-9-r1`, `4.0`, `4.0.11`, `4.0.11-r1`, `latest` (4.0/Dockerfile)](https://github.com/bitnami/bitnami-docker-redis/blob/4.0.11-debian-9-r1/4.0/Dockerfile)
