...
* [`5.0-centos-7`, `5.0.6-centos-7-r3` (5.0/centos-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-redis/blob/5.0.6-centos-7-r3/5.0/centos-7/Dockerfile)
...
* [`4.0-centos-7`, `4.0.14-centos-7-r182` (4.0/centos-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-redis/blob/4.0.14-centos-7-r182/4.0/centos-7/Dockerfile)
