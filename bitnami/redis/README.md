...
* [`5.0-ol-7`, `5.0.5-ol-7-r152` (5.0/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-redis/blob/5.0.5-ol-7-r152/5.0/ol-7/Dockerfile)
...
* [`5.0-centos-7`, `5.0.5-centos-7-r131` (5.0/centos-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-redis/blob/5.0.5-centos-7-r131/5.0/centos-7/Dockerfile)
