...
* [`5.0-centos-7`, `5.0.5-centos-7-r142` (5.0/centos-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-redis/blob/5.0.5-centos-7-r142/5.0/centos-7/Dockerfile)
...
* [`4.0-centos-7`, `4.0.14-centos-7-r147` (4.0/centos-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-redis/blob/4.0.14-centos-7-r147/4.0/centos-7/Dockerfile)
