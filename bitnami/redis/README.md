...
* [`4.0-centos-7`, `4.0.14-centos-7-r217` (4.0/centos-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-redis/blob/4.0.14-centos-7-r217/4.0/centos-7/Dockerfile)
