...
* [`1`, `1-debian-11`, `1.58.1`, `1.58.1-debian-11-r11`, `latest` (1/debian-11/Dockerfile)](https://github.com/bitnami/bitnami-docker-rclone/blob/1.58.1-debian-11-r11/1/debian-11/Dockerfile)
...
```console
$ docker build -t bitnami/rclone:latest 'https://github.com/bitnami/bitnami-docker-rclone.git#master:1/debian-11'
```
