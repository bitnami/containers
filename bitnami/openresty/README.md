...
* [`1.21`, `1.21-debian-11`, `1.21.4-1`, `1.21.4-1-debian-11-r10` (1.21/debian-11/Dockerfile)](https://github.com/bitnami/bitnami-docker-openresty/blob/1.21.4-1-debian-11-r10/1.21/debian-11/Dockerfile)
* [`1.19`, `1.19-debian-11`, `1.19.9-1`, `1.19.9-1-debian-11-r10`, `latest` (1.19/debian-11/Dockerfile)](https://github.com/bitnami/bitnami-docker-openresty/blob/1.19.9-1-debian-11-r10/1.19/debian-11/Dockerfile)
...
```console
$ docker build -t bitnami/openresty:latest 'https://github.com/bitnami/bitnami-docker-openresty.git#master:1.19/debian-11'
```
