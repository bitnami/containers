...
* [`1-scratch`, `1.9.1-scratch-r0`, `1`, `1.9.1`, `latest` (1/scratch/Dockerfile)](https://github.com/bitnami/bitnami-docker-kubeapps-apprepository-controller/blob/1.9.1/1/scratch/Dockerfile)
