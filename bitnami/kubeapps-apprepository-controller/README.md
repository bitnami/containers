...
* `1.0.0-beta.4-scratch-r0`, `1.0.0-beta.4-scratch`, `1.0.0-beta.4-r0`, `1.0.0-beta.4`, `1`, `latest` [1/scratch/Dockerfile](https://github.com/bitnami/bitnami-docker-kubeapps-apprepository-controller/blob/1.0.0-beta.4-scratch-r0/1/scratch/Dockerfile)
