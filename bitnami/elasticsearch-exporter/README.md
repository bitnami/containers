...
* [`1`, `1.0.2-r42`, `latest` (1/Dockerfile)](https://github.com/bitnami/bitnami-docker-elasticsearch-exporter/blob/1.0.2-r42/1/Dockerfile)
* [`1-ol-7`, `1.0.2-ol-7-r11` (1/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-elasticsearch-exporter/blob/1.0.2-ol-7-r11/1/ol-7/Dockerfile)
