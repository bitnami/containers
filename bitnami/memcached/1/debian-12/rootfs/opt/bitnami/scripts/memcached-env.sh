...
memcached_env_vars=(
    ...
    MEMCACHED_THREADS
    MEMCACHED_TLS_ENABLED
    MEMCACHED_TLS_CERT_FILE
    MEMCACHED_TLS_KEY_FILE
    MEMCACHED_TLS_CA_FILE
    MEMCACHED_TLS_VERIFY_MODE
)
...
# TLS
export MEMCACHED_TLS_ENABLED="${MEMCACHED_TLS_ENABLED:-no}"
export MEMCACHED_TLS_CERT_FILE="${MEMCACHED_TLS_CERT_FILE:-}"
export MEMCACHED_TLS_KEY_FILE="${MEMCACHED_TLS_KEY_FILE:-}"
export MEMCACHED_TLS_CA_FILE="${MEMCACHED_TLS_CA_FILE:-}"
export MEMCACHED_TLS_VERIFY_MODE="${MEMCACHED_TLS_VERIFY_MODE:-0}"
