...
> NOTE: Debian 8 images have been deprecated in favor of Debian 9 images. Bitnami will not longer publish new Docker images based on Debian 8.
 ...
 - [`1.8`, `1.8.181-debian-9-r11` (1.8/Dockerfile)](https://github.com/bitnami/bitnami-docker-java/blob/1.8.181-debian-9-r11/1.8/Dockerfile), [`1.8-prod`, `1.8.181-debian-9-r11-prod` (1.8/prod/Dockerfile)](https://github.com/bitnami/bitnami-docker-java/blob/1.8.181-debian-9-r11/1.8/prod/Dockerfile)
