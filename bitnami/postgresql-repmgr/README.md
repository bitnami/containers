...
* [`11-centos-7`, `11.6.0-centos-7-r7` (11/centos-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-postgresql-repmgr/blob/11.6.0-centos-7-r7/11/centos-7/Dockerfile)
