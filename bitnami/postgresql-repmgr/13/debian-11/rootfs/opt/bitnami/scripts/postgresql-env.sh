...
postgresql_env_vars=(
    ...
    REPMGR_LOG_STATUS_INTERVAL
    REPMGR_PRIMARY_VISIBILITY_CONSENSUS
    REPMGR_WITNESS_NODE
    REPMGR_WITNESS_PORT
    PGBOUNCER_PROMOTE_RELOAD_ENABLED
    PGBOUNCER_NODES_PSQL
    PGBOUNCER_NODES_SSH
    PGBOUNCER_DATABASE_INI
    PGBOUNCER_DATABASE_INI_TEMP
    PGBOUNCER_CONTAINER_USERNAME
    PGBOUNCER_CONTAINER_PASSWORD
    PGBOUNCER_DATABASES
)
...
export REPMGR_LOG_STATUS_INTERVAL="${REPMGR_LOG_STATUS_INTERVAL:-60}"
...
export PGBOUNCER_PROMOTE_RELOAD_ENABLED="${PGBOUNCER_PROMOTE_RELOAD_ENABLED:-false}"
export PGBOUNCER_NODES_PSQL="${PGBOUNCER_NODES_PSQL:-}"
export PGBOUNCER_NODES_SSH="${PGBOUNCER_NODES_SSH:-}"
export PGBOUNCER_DATABASE_INI="${PGBOUNCER_DATABASE_INI:-}"
export PGBOUNCER_DATABASE_INI_TEMP="/tmp/pgbouncer.database.ini"
export PGBOUNCER_CONTAINER_USERNAME="${PGBOUNCER_CONTAINER_USERNAME:-}"
export PGBOUNCER_CONTAINER_PASSWORD="${PGBOUNCER_CONTAINER_PASSWORD:-}"
export PGBOUNCER_DATABASES="${PGBOUNCER_DATABASES:-}"
