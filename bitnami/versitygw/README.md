...
```console
docker run --name versitygw bitnami/versitygw:latest
```
...
The recommended way to get the Bitnami Versity S3 Gateway Docker Image is to pull the prebuilt image from the [Docker Hub Registry](https://hub.docker.com/r/bitnami/versitygw).

```console
docker pull bitnami/versitygw:latest
```

To use a specific version, you can pull a versioned tag. You can view the [list of available versions](https://hub.docker.com/r/bitnami/versitygw/tags/) in the Docker Hub Registry.

```console
docker pull bitnami/versitygw:[TAG]
```
