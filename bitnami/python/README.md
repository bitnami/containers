...
* [`3.7-debian-9-prod`, `3.7.2-debian-9-r38-prod`, `3.7-prod`, `3.7.2-prod`, `3.7.2-r38-prod`, `latest-prod` (3.7-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-python/blob/3.7.2-debian-9-r38-prod/3.7-prod/debian-9/Dockerfile)
...
* [`3.6-ol-7`, `3.6.8-ol-7-r82` (3.6/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-python/blob/3.6.8-ol-7-r82/3.6/ol-7/Dockerfile)
