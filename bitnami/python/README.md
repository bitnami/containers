...
* [`3.6-debian-10-prod`, `3.6.10-debian-10-r119-prod`, `3.6-prod`, `3.6.10-prod` (3.6-prod/debian-10/Dockerfile)](https://github.com/bitnami/bitnami-docker-python/blob/3.6.10-debian-10-r119-prod/3.6-prod/debian-10/Dockerfile)
...
* [`2-debian-10-prod`, `2.7.18-debian-10-r33-prod`, `2-prod`, `2.7.18-prod` (2-prod/debian-10/Dockerfile)](https://github.com/bitnami/bitnami-docker-python/blob/2.7.18-debian-10-r33-prod/2-prod/debian-10/Dockerfile)
