...
* [`3.7-ol-7-prod`, `3.7.4-ol-7-r98-prod` (3.7-prod/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-python/blob/3.7.4-ol-7-r98-prod/3.7-prod/ol-7/Dockerfile)
...
* [`3.7-debian-9`, `3.7.4-debian-9-r94`, `3.7`, `3.7.4`, `3.7.4-r94`, `latest` (3.7/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-python/blob/3.7.4-debian-9-r94/3.7/debian-9/Dockerfile)
* [`3.6-ol-7-prod`, `3.6.9-ol-7-r106-prod` (3.6-prod/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-python/blob/3.6.9-ol-7-r106-prod/3.6-prod/ol-7/Dockerfile)
* [`3.6-ol-7`, `3.6.9-ol-7-r106` (3.6/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-python/blob/3.6.9-ol-7-r106/3.6/ol-7/Dockerfile)
* [`3.6-debian-9-prod`, `3.6.9-debian-9-r99-prod`, `3.6-prod`, `3.6.9-prod`, `3.6.9-r99-prod` (3.6-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-python/blob/3.6.9-debian-9-r99-prod/3.6-prod/debian-9/Dockerfile)
...
* [`2-ol-7-prod`, `2.7.16-ol-7-r218-prod` (2-prod/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-python/blob/2.7.16-ol-7-r218-prod/2-prod/ol-7/Dockerfile)
...
* [`2-debian-9-prod`, `2.7.16-debian-9-r203-prod`, `2-prod`, `2.7.16-prod`, `2.7.16-r203-prod` (2-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-python/blob/2.7.16-debian-9-r203-prod/2-prod/debian-9/Dockerfile)
* [`2-debian-9`, `2.7.16-debian-9-r201`, `2`, `2.7.16`, `2.7.16-r201` (2/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-python/blob/2.7.16-debian-9-r201/2/debian-9/Dockerfile)
