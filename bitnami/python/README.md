...
* [`3.6-debian-9-prod`, `3.6.8-debian-9-r89-prod`, `3.6-prod`, `3.6.8-prod`, `3.6.8-r89-prod` (3.6-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-python/blob/3.6.8-debian-9-r89-prod/3.6-prod/debian-9/Dockerfile)
...
* [`2-ol-7-prod`, `2.7.16-ol-7-r74-prod` (2-prod/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-python/blob/2.7.16-ol-7-r74-prod/2-prod/ol-7/Dockerfile)
* [`2-ol-7`, `2.7.16-ol-7-r73` (2/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-python/blob/2.7.16-ol-7-r73/2/ol-7/Dockerfile)
