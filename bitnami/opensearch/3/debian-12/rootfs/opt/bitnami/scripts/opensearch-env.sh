...
opensearch_env_vars=(
    ...
    OPENSEARCH_SECURE_SETTINGS_KEYSTORE_PASSWORD
...
export OPENSEARCH_ACTION_DESTRUCTIVE_REQUIRES_NAME="${OPENSEARCH_ACTION_DESTRUCTIVE_REQUIRES_NAME:-}"
export DB_ACTION_DESTRUCTIVE_REQUIRES_NAME="$OPENSEARCH_ACTION_DESTRUCTIVE_REQUIRES_NAME"
...
export OPENSEARCH_SECURE_SETTINGS_KEYSTORE_PASSWORD="${OPENSEARCH_SECURE_SETTINGS_KEYSTORE_PASSWORD:-FIPS_password_123!}"
