...
sonarqube_env_vars=(
    ...
    SONARQUBE_ENABLE_DEFAULT_PLUGINS
    SONARQUBE_ACCEPT_RISK_CONSENT
    SONARQUBE_USERNAME
    SONARQUBE_PASSWORD
    SONARQUBE_EMAIL
    SONARQUBE_SMTP_HOST
...
export SONARQUBE_PLUGINS_DIR="${SONARQUBE_BASE_DIR}/extensions/plugins"
...
export SONARQUBE_CE_JAVA_ADD_OPTS="${SONARQUBE_CE_JAVA_ADD_OPTS:-} ${JAVA_TOOL_OPTIONS:-}"
export SONARQUBE_ELASTICSEARCH_JAVA_ADD_OPTS="${SONARQUBE_ELASTICSEARCH_JAVA_ADD_OPTS:-}"
export SONARQUBE_WEB_JAVA_ADD_OPTS="${SONARQUBE_WEB_JAVA_ADD_OPTS:-} ${JAVA_TOOL_OPTIONS:-}"
...
export SONARQUBE_ENABLE_DEFAULT_PLUGINS="${SONARQUBE_ENABLE_DEFAULT_PLUGINS:-no}"
export SONARQUBE_ACCEPT_RISK_CONSENT="${SONARQUBE_ACCEPT_RISK_CONSENT:-no}"
