...
* [`4.2-centos-7`, `4.2.2-centos-7-r39` (4.2/centos-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-mongodb/blob/4.2.2-centos-7-r39/4.2/centos-7/Dockerfile)
...
* [`4.0-centos-7`, `4.0.14-centos-7-r27` (4.0/centos-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-mongodb/blob/4.0.14-centos-7-r27/4.0/centos-7/Dockerfile)
...
* [`3.6-centos-7`, `3.6.16-centos-7-r46` (3.6/centos-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-mongodb/blob/3.6.16-centos-7-r46/3.6/centos-7/Dockerfile)
