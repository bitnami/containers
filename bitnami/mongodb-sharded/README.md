...
* [`5.0`, `5.0-debian-11`, `5.0.9`, `5.0.9-debian-11-r0`, `latest` (5.0/debian-11/Dockerfile)](https://github.com/bitnami/bitnami-docker-mongodb/blob/5.0.9-debian-11-r0/5.0/debian-11/Dockerfile)
* [`4.4`, `4.4-debian-10`, `4.4.15`, `4.4.15-debian-10-r4` (4.4/debian-10/Dockerfile)](https://github.com/bitnami/bitnami-docker-mongodb/blob/4.4.15-debian-10-r4/4.4/debian-10/Dockerfile)
* [`4.2`, `4.2-debian-10`, `4.2.21`, `4.2.21-debian-10-r5` (4.2/debian-10/Dockerfile)](https://github.com/bitnami/bitnami-docker-mongodb/blob/4.2.21-debian-10-r5/4.2/debian-10/Dockerfile)
...
```console
$ docker build -t bitnami/mongodb-sharded:latest 'https://github.com/bitnami/bitnami-docker-mongodb-sharded.git#master:5.0/debian-11'
```
