...
* [`5.0`, `5.0-debian-10`, `5.0.8`, `5.0.8-debian-10-r19`, `latest` (5.0/debian-10/Dockerfile)](https://github.com/bitnami/bitnami-docker-mongodb/blob/5.0.8-debian-10-r19/5.0/debian-10/Dockerfile)
* [`4.4`, `4.4-debian-10`, `4.4.14`, `4.4.14-debian-10-r11` (4.4/debian-10/Dockerfile)](https://github.com/bitnami/bitnami-docker-mongodb/blob/4.4.14-debian-10-r11/4.4/debian-10/Dockerfile)
* [`4.2`, `4.2-debian-10`, `4.2.20`, `4.2.20-debian-10-r14` (4.2/debian-10/Dockerfile)](https://github.com/bitnami/bitnami-docker-mongodb/blob/4.2.20-debian-10-r14/4.2/debian-10/Dockerfile)
...
```console
$ docker build -t bitnami/mongodb-sharded:latest 'https://github.com/bitnami/bitnami-docker-mongodb-sharded.git#master:5.0/debian-10'
```
