...
* [`3.6-centos-7`, `3.6.15-centos-7-r22` (3.6/centos-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-mongodb/blob/3.6.15-centos-7-r22/3.6/centos-7/Dockerfile)
