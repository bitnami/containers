...
* [`4.0-centos-7`, `4.0.14-centos-7-r22` (4.0/centos-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-mongodb/blob/4.0.14-centos-7-r22/4.0/centos-7/Dockerfile)
