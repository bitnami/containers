...
* [`4.2-centos-7`, `4.2.1-centos-7-r14` (4.2/centos-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-mongodb/blob/4.2.1-centos-7-r14/4.2/centos-7/Dockerfile)
