...
* [`4.2-ol-7`, `4.2.1-ol-7-r27` (4.2/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-mongodb/blob/4.2.1-ol-7-r27/4.2/ol-7/Dockerfile)
...
* [`4.2-centos-7`, `4.2.1-centos-7-r28` (4.2/centos-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-mongodb/blob/4.2.1-centos-7-r28/4.2/centos-7/Dockerfile)
