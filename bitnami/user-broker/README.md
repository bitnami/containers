...
* [`0`, `0.1.22-r3`, `latest` (0/Dockerfile)](https://github.com/bitnami/bitnami-docker-user-broker/blob/0.1.22-r3/0/Dockerfile)
* [`0-ol-7`, `0.1.22-ol-7-r3` (0/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-user-broker/blob/0.1.22-ol-7-r3/0/ol-7/Dockerfile)
