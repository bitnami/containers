...
```console
docker pull bitnami/victoriametrics-vmselect:latest
```

To use a specific version, you can pull a versioned tag. You can view the [list of available versions](https://hub.docker.com/r/bitnami/victoriametrics-vmselect/tags/) in the Docker Hub Registry.

```console
docker pull bitnami/victoriametrics-vmselect:[TAG]
```
