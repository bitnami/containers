...
* [`1`, `1-debian-10`, `1.16.0`, `1.16.0-debian-10-r30`, `latest` (1/debian-10/Dockerfile)](https://github.com/bitnami/bitnami-docker-pgbouncer/blob/1.16.0-debian-10-r30/1/debian-10/Dockerfile)
...
- `PGBOUNCER_SET_USER`: If you want the above backend PostgreSQL username to be included in the database string, set this to `True`.
...
- `PGBOUNCER_DEFAULT_POOL_SIZE` : you can use this to set `default_pool_size` in the auto-generated `pgbouncer.ini`. This can be useful for solving certain connection issues. See https://www.pgbouncer.org/config.html for more details.
