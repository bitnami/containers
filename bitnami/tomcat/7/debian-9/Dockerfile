...
RUN bitnami-pkg unpack tomcat-7.0.94-0 --checksum 1d25518cde06c9375e0af05c386615f001ac0eb7beedd87f341df4fe13b90c10
RUN ln -sf /opt/bitnami/tomcat/data /app

COPY rootfs /
ENV BITNAMI_APP_NAME="tomcat" \
    BITNAMI_IMAGE_VERSION="7.0.94-debian-9-r54" \
