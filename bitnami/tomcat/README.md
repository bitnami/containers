...
> NOTE: Debian 8 images have been deprecated in favor of Debian 9 images. Bitnami will not longer publish new Docker images based on Debian 8.
 ...
 - [`9.0`, `9.0.10-ol-7-r32` (9.0/Dockerfile)](https://github.com/bitnami/bitnami-docker-tomcat/blob/9.0.10-ol-7-r32/9.0/Dockerfile)
 ...
 - [`8.5`, `8.5.32-ol-7-r32` (8.5/Dockerfile)](https://github.com/bitnami/bitnami-docker-tomcat/blob/8.5.32-ol-7-r32/8.5/Dockerfile)
 - [`8.5`, `8.5.32-debian-9-r30` (8.5/Dockerfile)](https://github.com/bitnami/bitnami-docker-tomcat/blob/8.5.32-debian-9-r30/8.5/Dockerfile)
 - [`8.0`, `8.0.53-ol-7-r24` (8.0/Dockerfile)](https://github.com/bitnami/bitnami-docker-tomcat/blob/8.0.53-ol-7-r24/8.0/Dockerfile)
 - [`8.0`, `8.0.53-debian-9-r27` (8.0/Dockerfile)](https://github.com/bitnami/bitnami-docker-tomcat/blob/8.0.53-debian-9-r27/8.0/Dockerfile)
 - [`7`, `7.0.90-ol-7-r23` (7/Dockerfile)](https://github.com/bitnami/bitnami-docker-tomcat/blob/7.0.90-ol-7-r23/7/Dockerfile)
 - [`7`, `7.0.90-debian-9-r27` (7/Dockerfile)](https://github.com/bitnami/bitnami-docker-tomcat/blob/7.0.90-debian-9-r27/7/Dockerfile)
