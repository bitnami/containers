...
# Supported tags and respective `Dockerfile` links
 ...
 - [`9.0`, `9.0.7-r10` (9.0/Dockerfile)](https://github.com/bitnami/bitnami-docker-tomcat/blob/9.0.7-r10/9.0/Dockerfile)
 - [`8.5`, `8.5.30-r9`, `latest` (8.5/Dockerfile)](https://github.com/bitnami/bitnami-docker-tomcat/blob/8.5.30-r9/8.5/Dockerfile)
 - [`8.0`, `8.0.51-r10` (8.0/Dockerfile)](https://github.com/bitnami/bitnami-docker-tomcat/blob/8.0.51-r10/8.0/Dockerfile)
 - [`7`, `7.0.86-r10` (7/Dockerfile)](https://github.com/bitnami/bitnami-docker-tomcat/blob/7.0.86-r10/7/Dockerfile)
