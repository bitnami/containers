...
# Supported tags and respective `Dockerfile` links
 ...
 - [`9.0`, `9.0.0-M22-r0` (9.0/Dockerfile)](https://github.com/bitnami/bitnami-docker-tomcat/blob/9.0.0-M22-r0/9.0/Dockerfile)
 - [`8.5`, `8.5.16-r0` (8.5/Dockerfile)](https://github.com/bitnami/bitnami-docker-tomcat/blob/8.5.16-r0/8.5/Dockerfile)
 - [`8.0`, `8.0.45-r0`, `latest` (8.0/Dockerfile)](https://github.com/bitnami/bitnami-docker-tomcat/blob/8.0.45-r0/8.0/Dockerfile)
 - [`7`, `7.0.79-r0` (7/Dockerfile)](https://github.com/bitnami/bitnami-docker-tomcat/blob/7.0.79-r0/7/Dockerfile)
