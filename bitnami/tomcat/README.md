...
# Supported tags and respective `Dockerfile` links
 ...
 - [`9.0`, `9.0.7-r2` (9.0/Dockerfile)](https://github.com/bitnami/bitnami-docker-tomcat/blob/9.0.7-r2/9.0/Dockerfile)
 - [`8.5`, `8.5.30-r0`, `latest` (8.5/Dockerfile)](https://github.com/bitnami/bitnami-docker-tomcat/blob/8.5.30-r0/8.5/Dockerfile)
 - [`8.0`, `8.0.51-r1` (8.0/Dockerfile)](https://github.com/bitnami/bitnami-docker-tomcat/blob/8.0.51-r1/8.0/Dockerfile)
 - [`7`, `7.0.86-r1` (7/Dockerfile)](https://github.com/bitnami/bitnami-docker-tomcat/blob/7.0.86-r1/7/Dockerfile)
