...
# Supported tags and respective `Dockerfile` links
 ...
 - [`9.0`, `9.0.0.M19-r1` (9.0/Dockerfile)](https://github.com/bitnami/bitnami-docker-tomcat/blob/9.0.0.M19-r1/9.0/Dockerfile)
 - [`8.0`, `8.0.43-r1`, `latest` (8.0/Dockerfile)](https://github.com/bitnami/bitnami-docker-tomcat/blob/8.0.43-r1/8.0/Dockerfile)
 - [`7`, `7.0.77-r1` (7/Dockerfile)](https://github.com/bitnami/bitnami-docker-tomcat/blob/7.0.77-r1/7/Dockerfile)
