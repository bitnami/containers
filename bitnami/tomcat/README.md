...
# Supported tags and respective `Dockerfile` links
 ...
 - [`9.0`, `8.0.43-r0`, `latest` (9.0/Dockerfile)](https://github.com/bitnami/bitnami-docker-tomcat/blob/8.0.43-r0/9.0/Dockerfile)
 - [`8.0`, `8.0.43-r2` (8.0/Dockerfile)](https://github.com/bitnami/bitnami-docker-tomcat/blob/8.0.43-r2/8.0/Dockerfile)
 - [`7`, `8.0.43-r0` (7/Dockerfile)](https://github.com/bitnami/bitnami-docker-tomcat/blob/8.0.43-r0/7/Dockerfile)
