...
# Supported tags and respective `Dockerfile` links
 ...
 - [`9.0`, `9.0.8-r36` (9.0/Dockerfile)](https://github.com/bitnami/bitnami-docker-tomcat/blob/9.0.8-r36/9.0/Dockerfile)
 ...
 - [`8.0`, `8.0.52-r31` (8.0/Dockerfile)](https://github.com/bitnami/bitnami-docker-tomcat/blob/8.0.52-r31/8.0/Dockerfile)
 - [`8.0`, `8.0.52-ol-7-r1` (8.0/Dockerfile)](https://github.com/bitnami/bitnami-docker-tomcat/blob/8.0.52-ol-7-r1/8.0/Dockerfile)
 - [`7`, `7.0.88-r20` (7/Dockerfile)](https://github.com/bitnami/bitnami-docker-tomcat/blob/7.0.88-r20/7/Dockerfile)
