...
# Supported tags and respective `Dockerfile` links
 ...
 - [`9.0`, `9.0.8-r16` (9.0/Dockerfile)](https://github.com/bitnami/bitnami-docker-tomcat/blob/9.0.8-r16/9.0/Dockerfile)
 - [`8.5`, `8.5.31-r17`, `latest` (8.5/Dockerfile)](https://github.com/bitnami/bitnami-docker-tomcat/blob/8.5.31-r17/8.5/Dockerfile)
 - [`8.0`, `8.0.52-r12` (8.0/Dockerfile)](https://github.com/bitnami/bitnami-docker-tomcat/blob/8.0.52-r12/8.0/Dockerfile)
