...
# Supported tags and respective `Dockerfile` links
 ...
 - [`8.5`, `8.5.32-ol-7-r15` (8.5/Dockerfile)](https://github.com/bitnami/bitnami-docker-tomcat/blob/8.5.32-ol-7-r15/8.5/Dockerfile)
 - [`8.5`, `8.5.32-debian-9-r9` (8.5/Dockerfile)](https://github.com/bitnami/bitnami-docker-tomcat/blob/8.5.32-debian-9-r9/8.5/Dockerfile)
 ...
 - [`8.0`, `8.0.53-ol-7-r7` (8.0/Dockerfile)](https://github.com/bitnami/bitnami-docker-tomcat/blob/8.0.53-ol-7-r7/8.0/Dockerfile)
 - [`8.0`, `8.0.53-debian-9-r7` (8.0/Dockerfile)](https://github.com/bitnami/bitnami-docker-tomcat/blob/8.0.53-debian-9-r7/8.0/Dockerfile)
 - [`8.0`, `8.0.53-debian-8-r7` (8.0/Dockerfile)](https://github.com/bitnami/bitnami-docker-tomcat/blob/8.0.53-debian-8-r7/8.0/Dockerfile)
