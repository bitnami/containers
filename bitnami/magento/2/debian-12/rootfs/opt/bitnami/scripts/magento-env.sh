...
magento_env_vars=(
    ...
    MAGENTO_OPENSEARCH_HOST
    MAGENTO_OPENSEARCH_PORT_NUMBER
    MAGENTO_OPENSEARCH_USE_HTTPS
    MAGENTO_OPENSEARCH_ENABLE_AUTH
    MAGENTO_OPENSEARCH_USER
    MAGENTO_OPENSEARCH_PASSWORD
...
MAGENTO_OPENSEARCH_HOST="${MAGENTO_OPENSEARCH_HOST:-"${OPENSEARCH_HOST:-}"}"
export MAGENTO_OPENEARCH_HOST="${MAGENTO_OPENSEARCH_HOST:-opensearch}" # only used during the first initialization
MAGENTO_OPENSEARCH_PORT_NUMBER="${MAGENTO_OPENSEARCH_PORT_NUMBER:-"${OPENSEARCH_PORT_NUMBER:-}"}"
export MAGENTO_OPENSEARCH_PORT_NUMBER="${MAGENTO_OPENSEARCH_PORT_NUMBER:-9200}" # only used during the first initialization
export MAGENTO_OPENSEARCH_USE_HTTPS="${MAGENTO_OPENSEARCH_USE_HTTPS:-no}" # only used during the first initialization
export MAGENTO_OPENSEARCH_ENABLE_AUTH="${MAGENTO_OPENSEARCH_ENABLE_AUTH:-no}" # only used during the first initialization
export MAGENTO_OPENSEARCH_USER="${MAGENTO_OPENSEARCH_USER:-}" # only used during the first initialization
export MAGENTO_OPENSEARCH_PASSWORD="${MAGENTO_OPENSEARCH_PASSWORD:-}" # only used during the first initialization
