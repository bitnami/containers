...
* [`2`, `2-debian-11`, `2.8.1`, `2.8.1-debian-11-r23`, `latest` (2/debian-11/Dockerfile)](https://github.com/bitnami/bitnami-docker-kong/blob/2.8.1-debian-11-r23/2/debian-11/Dockerfile)
...
```console
$ docker build -t bitnami/kong:latest 'https://github.com/bitnami/bitnami-docker-kong.git#master:2/debian-11'
```
