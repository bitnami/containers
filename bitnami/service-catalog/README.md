...
* [`0-debian-9`, `0.1.28-debian-9-r2`, `0`, `0.1.28`, `0.1.28-r2`, `latest` (0/Dockerfile)](https://github.com/bitnami/bitnami-docker-service-catalog/blob/0.1.28-debian-9-r2/0/Dockerfile)
