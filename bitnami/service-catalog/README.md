...
* [`0-debian-9`, `0.1.26-debian-9-r0`, `0`, `0.1.26`, `0.1.26-r0`, `latest` (0/Dockerfile)](https://github.com/bitnami/bitnami-docker-service-catalog/blob/0.1.26-debian-9-r0/0/Dockerfile)
