...
* [`0-debian-9`, `0.1.24-debian-9-r1`, `0`, `0.1.24`, `0.1.24-r1`, `latest` (0/Dockerfile)](https://github.com/bitnami/bitnami-docker-service-catalog/blob/0.1.24-debian-9-r1/0/Dockerfile)
