...
* [`0-debian-9`, `0.1.28-debian-9-r6`, `0`, `0.1.28`, `0.1.28-r6`, `latest` (0/Dockerfile)](https://github.com/bitnami/bitnami-docker-service-catalog/blob/0.1.28-debian-9-r6/0/Dockerfile)
