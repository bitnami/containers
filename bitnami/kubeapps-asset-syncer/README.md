...
* [`1-scratch`, `1.10.0-scratch-r0`, `1`, `1.10.0`, `latest` (1/scratch/Dockerfile)](https://github.com/bitnami/bitnami-docker-kubeapps-asset-syncer/blob/1.10.0/1/scratch/Dockerfile)
