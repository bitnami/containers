...
* [`2`, `2-debian-11`, `2.8.4`, `2.8.4-debian-11-r17`, `latest` (2/debian-11/Dockerfile)](https://github.com/bitnami/bitnami-docker-spring-cloud-skipper/blob/2.8.4-debian-11-r17/2/debian-11/Dockerfile)
...
```console
$ docker build -t bitnami/spring-cloud-skipper:latest 'https://github.com/bitnami/bitnami-docker-spring-cloud-skipper.git#master:2/debian-11'
```
