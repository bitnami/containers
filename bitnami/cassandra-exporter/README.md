...
* [`2-debian-9`, `2.3.0-debian-9-r0`, `2`, `2.3.0`, `2.3.0-r0`, `latest` (2/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-cassandra-exporter/blob/2.3.0-debian-9-r0/2/debian-9/Dockerfile)
...
```bash
$ docker build -t bitnami/cassandra-exporter:latest https://github.com/bitnami/bitnami-docker-cassandra-exporter.git
```
