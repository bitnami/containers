...
# How to deploy Cassandra Exporter in Kubernetes?
...
* [`2-debian-9`, `2.3.0-debian-9-r131`, `2`, `2.3.0`, `2.3.0-r131`, `latest` (2/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-cassandra-exporter/blob/2.3.0-debian-9-r131/2/debian-9/Dockerfile)
...
```bash
$ docker build -t bitnami/cassandra-exporter:latest 'https://github.com/bitnami/bitnami-docker-cassandra-exporter.git#master:2/debian-9'
```
...
If you encountered a problem running this container, you can file an [issue](https://github.com/bitnami/bitnami-docker-cassandra-exporter/issues). For us to provide better support, be sure to include the following information in your issue:
