...
## What is Bitnami Object Storage Operator based on MinIO&reg;?
...
The recommended way to get the Bitnami Bitnami Object Storage Operator based on MinIO&reg; Docker Image is to pull the prebuilt image from the [Docker Hub Registry](https://hub.docker.com/r/bitnami/minio-operator).
