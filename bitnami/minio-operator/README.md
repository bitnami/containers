# Storage based on MinIO&reg; Operator

## What is Storage based on MinIO&reg; Operator?
...
[Overview of Storage based on MinIO&reg; Operator](https://min.io/)
...
Looking to use Storage based on MinIO&reg; Operator in production? Try [VMware Tanzu Application Catalog](https://bitnami.com/enterprise), the commercial edition of the Bitnami catalog.
...
The recommended way to get the Bitnami Storage based on MinIO&reg; Operator Docker Image is to pull the prebuilt image from the [Docker Hub Registry](https://hub.docker.com/r/bitnami/minio-operator).
...
Check the [official Storage based on MinIO&reg; Operator documentation](https://min.io/) for more information.
