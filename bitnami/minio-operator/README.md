...
## What is Bitnami Object Storage based on MinIO&reg; Operator?
...
The recommended way to get the Bitnami Bitnami Object Storage based on MinIO&reg; Operator Docker Image is to pull the prebuilt image from the [Docker Hub Registry](https://hub.docker.com/r/bitnami/minio-operator).
...
Check the [official Bitnami Object Storage based on MinIO&reg; Operator documentation](https://min.io/) for more information.
