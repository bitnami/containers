...
* [`3`, `3-debian-11`, `3.3.8`, `3.3.8-debian-11-r10`, `latest` (3/debian-11/Dockerfile)](https://github.com/bitnami/bitnami-docker-phpbb/blob/3.3.8-debian-11-r10/3/debian-11/Dockerfile)
...
```console
$ docker build -t bitnami/phpbb:latest 'https://github.com/bitnami/bitnami-docker-phpbb.git#master:3/debian-11'
```
