...
> charts-syncer is a CLI that syncs chart packages and associated container images between chart repositories.

[Overview of charts-syncer](https://github.com/bitnami/charts-syncer)
...
Looking to use charts-syncer in production? Try [VMware Tanzu Application Catalog](https://bitnami.com/enterprise), the commercial edition of the Bitnami catalog.
...
To run commands inside this container you can use `docker run`, for example to execute `charts-syncer help` you can follow the example below:

```console
docker run --rm --name charts-syncer bitnami/charts-syncer:latest help
```
