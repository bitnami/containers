...
* [`0-debian-9`, `0.2.1-debian-9-r0`, `0`, `0.2.1`, `0.2.1-r0`, `latest` (0/Dockerfile)](https://github.com/bitnami/bitnami-docker-metrics-server/blob/0.2.1-debian-9-r0/0/Dockerfile)
