...
# Supported tags and respective `Dockerfile` links
 ...
 - [`10`, `10.4.1-r6` (10/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/10.4.1-r6/10/Dockerfile), [`10-prod`, `10.4.1-r6-prod` (10/prod/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/10.4.1-r6/10/prod/Dockerfile)
 ...
 - [`6`, `6.14.3-r5` (6/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/6.14.3-r5/6/Dockerfile), [`6-prod`, `6.14.3-r5-prod` (6/prod/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/6.14.3-r5/6/prod/Dockerfile)
