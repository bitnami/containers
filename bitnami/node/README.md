...
# Supported tags and respective `Dockerfile` links
 ...
 - [`10`, `10.3.0-r1` (10/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/10.3.0-r1/10/Dockerfile), [`10-prod`, `10.3.0-r1-prod` (10/prod/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/10.3.0-r1/10/prod/Dockerfile)
