...
* [`10-debian-9-prod`, `10.15.2-debian-9-r4-prod`, `10-prod`, `10.15.2-prod`, `10.15.2-r4-prod` (10-prod/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/10.15.2-debian-9-r4-prod/10-prod/debian-9/Dockerfile)
