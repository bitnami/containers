...
# Supported tags and respective `Dockerfile` links
 ...
 - [`10`, `10.5.0-r1` (10/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/10.5.0-r1/10/Dockerfile), [`10-prod`, `10.5.0-r1-prod` (10/prod/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/10.5.0-r1/10/prod/Dockerfile)
 - [`10`, `10.5.0-ol-7-r1` (10/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/10.5.0-ol-7-r1/10/Dockerfile), [`10-prod`, `10.5.0-ol-7-r1-prod` (10/prod/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/10.5.0-ol-7-r1/10/prod/Dockerfile)
