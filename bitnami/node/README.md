...
# Supported tags and respective `Dockerfile` links
 ...
 - [`4`, `4.8.5-r0` (4/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/4.8.5-r0/4/Dockerfile), [`4-prod`, `4.8.5-r0-prod` (4/prod/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/4.8.5-r0/4/prod/Dockerfile)
