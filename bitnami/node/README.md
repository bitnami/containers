...
# Supported tags and respective `Dockerfile` links
 ...
 - [`10`, `10.4.0-r1` (10/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/10.4.0-r1/10/Dockerfile), [`10-prod`, `10.4.0-r1-prod` (10/prod/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/10.4.0-r1/10/prod/Dockerfile)
