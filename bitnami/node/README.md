...
# Supported tags and respective `Dockerfile` links
 ...
 - [`10`, `10.1.0-r9` (10/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/10.1.0-r9/10/Dockerfile), [`10-prod`, `10.1.0-r9-prod` (10/prod/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/10.1.0-r9/10/prod/Dockerfile)
 - [`9`, `9.11.1-r22` (9/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/9.11.1-r22/9/Dockerfile), [`9-prod`, `9.11.1-r22-prod` (9/prod/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/9.11.1-r22/9/prod/Dockerfile)
 - [`8`, `8.11.1-r24` (8/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/8.11.1-r24/8/Dockerfile), [`8-prod`, `8.11.1-r24-prod` (8/prod/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/8.11.1-r24/8/prod/Dockerfile)
