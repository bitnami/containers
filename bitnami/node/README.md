...
# Supported tags and respective `Dockerfile` links
 ...
 - [`6`, `6.14.1-r7`, `latest` (6/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/6.14.1-r7/6/Dockerfile), [`6-prod`, `6.14.1-r7-prod` (6/prod/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/6.14.1-r7/6/prod/Dockerfile)
