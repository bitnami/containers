...
# Supported tags and respective `Dockerfile` links
 ...
 - [`9`, `9.10.1-r0` (9/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/9.10.1-r0/9/Dockerfile), [`9-prod`, `9.10.1-r0-prod` (9/prod/Dockerfile)](https://github.com/bitnami/bitnami-docker-node/blob/9.10.1-r0/9/prod/Dockerfile)
