...
redis_cluster_env_vars=(
    ...
    REDIS_DNS_RETRIES
    REDIS_NODES
    REDIS_CLUSTER_CREATOR_WAIT_TIME_AFTER_NODE_READY
    REDIS_TLS_PORT
)
...
export REDIS_CLUSTER_CREATOR_WAIT_TIME_AFTER_NODE_READY="${REDIS_CLUSTER_CREATOR_WAIT_TIME_AFTER_NODE_READY:-0}"
