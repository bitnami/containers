...
```console
docker run --name chainloop-control-plane bitnami/chainloop-control-plane:latest
```
...
```console
docker pull bitnami/chainloop-control-plane:latest
```

To use a specific version, you can pull a versioned tag. You can view the [list of available versions](https://hub.docker.com/r/bitnami/chainloop-control-plane/tags/) in the Docker Hub Registry.

```console
docker pull bitnami/chainloop-control-plane:[TAG]
```
...
```console
docker run --rm --name chainloop-control-plane bitnami/chainloop-control-plane:latest help
```
