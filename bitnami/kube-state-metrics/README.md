...
* [`1-debian-8`, `1.3.1-debian-8-r52` (1/debian-8/Dockerfile)](https://github.com/bitnami/bitnami-docker-kube-state-metrics/blob/1.3.1-debian-8-r52/1/debian-8/Dockerfile)
