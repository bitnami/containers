...
* [`1-ol-7`, `1.4.0-ol-7-r0` (1/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-kube-state-metrics/blob/1.4.0-ol-7-r0/1/ol-7/Dockerfile)
* [`1-debian-9`, `1.4.0-debian-9-r0`, `1`, `1.4.0`, `1.4.0-r0`, `latest` (1/Dockerfile)](https://github.com/bitnami/bitnami-docker-kube-state-metrics/blob/1.4.0-debian-9-r0/1/Dockerfile)
