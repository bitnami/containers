...
* [`1`, `1.3.1-r32`, `latest` (1/Dockerfile)](https://github.com/bitnami/bitnami-docker-kube-state-metrics/blob/1.3.1-r32/1/Dockerfile)
* [`1-ol-7`, `1.3.1-ol-7-r4` (1/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-kube-state-metrics/blob/1.3.1-ol-7-r4/1/ol-7/Dockerfile)
