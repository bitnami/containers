...
* [`1.13-ol-7`, `1.13.8-ol-7-r11` (1.13/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-golang/blob/1.13.8-ol-7-r11/1.13/ol-7/Dockerfile)
* [`1.13-debian-10`, `1.13.8-debian-10-r10`, `1.13`, `1.13.8`, `latest` (1.13/debian-10/Dockerfile)](https://github.com/bitnami/bitnami-docker-golang/blob/1.13.8-debian-10-r10/1.13/debian-10/Dockerfile)
* [`1.12-ol-7`, `1.12.17-ol-7-r10` (1.12/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-golang/blob/1.12.17-ol-7-r10/1.12/ol-7/Dockerfile)
* [`1.12-debian-10`, `1.12.17-debian-10-r10`, `1.12`, `1.12.17` (1.12/debian-10/Dockerfile)](https://github.com/bitnami/bitnami-docker-golang/blob/1.12.17-debian-10-r10/1.12/debian-10/Dockerfile)
...
```bash
$ docker build -t bitnami/golang:latest 'https://github.com/bitnami/bitnami-docker-golang.git#master:1.13/debian-10'
```
...
If you encountered a problem running this container, you can file an [issue](https://github.com/bitnami/bitnami-docker-golang/issues). For us to provide better support, be sure to include the following information in your issue:
