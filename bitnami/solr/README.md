...
* [`8-ol-7`, `8.2.0-ol-7-r113` (8/ol-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-solr/blob/8.2.0-ol-7-r113/8/ol-7/Dockerfile)
* [`8-debian-9`, `8.2.0-debian-9-r97`, `8`, `8.2.0`, `8.2.0-r97`, `latest` (8/debian-9/Dockerfile)](https://github.com/bitnami/bitnami-docker-solr/blob/8.2.0-debian-9-r97/8/debian-9/Dockerfile)
...
```bash
$ docker build -t bitnami/solr:latest 'https://github.com/bitnami/bitnami-docker-solr.git#master:8/debian-9'
```
