...
Deploying Bitnami applications as Helm Charts is the easiest way to get started with our applications on Kubernetes. Read more about the installation in the [Bitnami TestLink Chart GitHub repository](https://github.com/bitnami/charts/tree/master/bitnami/testlink).
...
* [`1-debian-10`, `1.9.20-debian-10-r142`, `1`, `1.9.20`, `latest` (1/debian-10/Dockerfile)](https://github.com/bitnami/bitnami-docker-testlink/blob/1.9.20-debian-10-r142/1/debian-10/Dockerfile)
...
If you encountered a problem running this container, you can file an [issue](https://github.com/bitnami/bitnami-docker-testlink/issues/new). For us to provide better support, be sure to include the following information in your issue:
