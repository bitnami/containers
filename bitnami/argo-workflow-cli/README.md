...
* [`3`, `3-scratch`, `3.2.7`, `3.2.7-scratch-r2`, `latest` (3/scratch/Dockerfile)](https://github.com/bitnami/bitnami-docker-argo-workflows/blob/3.2.7-scratch-r2/3/scratch/      Dockerfile)
