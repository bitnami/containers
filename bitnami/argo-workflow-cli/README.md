...
* [`3`, `3-scratch`, `3.3.5`, `3.3.5-scratch-r0`, `latest` (3/scratch/Dockerfile)](https://github.com/bitnami/bitnami-docker-argo-workflows/blob/3.3.5-scratch-r0/3/scratch/      Dockerfile)
