...
* [`3`, `3-scratch`, `3.3.8`, `3.3.8-scratch-r8`, `latest` (3/scratch/Dockerfile)](https://github.com/bitnami/containers/blob/main/bitnami/argo-workflows/3/scratch/      Dockerfile)
