...
* [`3`, `3-scratch`, `3.3.1`, `3.3.1-scratch-r1`, `latest` (3/scratch/Dockerfile)](https://github.com/bitnami/bitnami-docker-argo-workflows/blob/3.3.1-scratch-r1/3/scratch/      Dockerfile)
