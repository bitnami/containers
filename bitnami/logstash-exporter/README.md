...
* [`0-centos-7`, `0.1.2-centos-7-r49` (0/centos-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-logstash-exporter/blob/0.1.2-centos-7-r49/0/centos-7/Dockerfile)
