# Flux Helm Controller packaged by Bitnami
...
Looking to use Flux Helm Controller in production? Try [VMware Application Catalog](https://bitnami.com/enterprise), the enterprise edition of Bitnami Application Catalog.
