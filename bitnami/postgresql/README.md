...
* [`10`, `10.4.0-r11`, `latest` (10/Dockerfile)](https://github.com/bitnami/bitnami-docker-postgresql/blob/10.4.0-r11/10/Dockerfile)
* [`9.6`, `9.6.9-r12` (9.6/Dockerfile)](https://github.com/bitnami/bitnami-docker-postgresql/blob/9.6.9-r12/9.6/Dockerfile)
