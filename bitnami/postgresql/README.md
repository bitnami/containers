...
* [`11-centos-7`, `11.4.0-centos-7-r1` (11/centos-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-postgresql/blob/11.4.0-centos-7-r1/11/centos-7/Dockerfile)
