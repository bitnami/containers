...
* [`9.6-centos-7`, `9.6.13-centos-7-r14` (9.6/centos-7/Dockerfile)](https://github.com/bitnami/bitnami-docker-postgresql/blob/9.6.13-centos-7-r14/9.6/centos-7/Dockerfile)
