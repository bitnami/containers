...
# Install libreary dependencies
info "Installing gramine python depedencies"
/opt/bitnami/python/bin/pip install  click jinja2 toml protobuf===3.20.0 cryptography
