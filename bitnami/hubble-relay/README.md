...
```console
docker pull bitnami/hubble-relay:latest
```

To use a specific version, you can pull a versioned tag. You can view the [list of available versions](https://hub.docker.com/r/bitnami/hubble-relay/tags/) in the Docker Hub Registry.

```console
docker pull bitnami/hubble-relay:[TAG]
```
