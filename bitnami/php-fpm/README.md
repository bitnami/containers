...
# Supported tags and respective `Dockerfile` links
 ...
 - [`7.1`, `7.1.17-r2`, `latest` (7.1/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.1.17-r2/7.1/Dockerfile), [`7.1-prod`, `7.1.17-r2-prod` (7.1/prod/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.1.17-r2/7.1/prod/Dockerfile)
