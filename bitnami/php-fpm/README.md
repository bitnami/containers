...
* [`7.2`, `7.2.5-r14` (7.2/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.2.5-r14/7.2/Dockerfile)
* [`7.2-prod`, `7.2.5-r14-prod` (7.2/prod/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.2.5-r14/7.2/prod/Dockerfile)
...
* [`7.0`, `7.0.30-r14` (7.0/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.0.30-r14/7.0/Dockerfile)
* [`7.0-prod`, `7.0.30-r14-prod` (7.0/prod/Dockerfile)](https://github.com/bitnami/bitnami-docker-php-fpm/blob/7.0.30-r14/7.0/prod/Dockerfile)
