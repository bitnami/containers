...
neo4j_env_vars=(
    ...
    NEO4J_CLUSTERING_ENABLED
    NEO4J_CLUSTER_DISCOVERY_TYPE
    NEO4J_CLUSTER_DISCOVERY_ENDPOINTS
    NEO4J_CLUSTER_MINIMUM_SIZE
    NEO4J_CLUSTER_DISCOVERY_LABEL_SELECTOR
    NEO4J_CLUSTER_DISCOVERY_SERVICE_PORT_NAME
    NEO4J_CLUSTER_DISCOVERY_PORT_NUMBER
    NEO4J_CLUSTER_TRANSACTION_PORT_NUMBER
    NEO4J_CLUSTER_RAFT_PORT_NUMBER
    NEO4J_CLUSTER_ROUTING_PORT_NUMBER
    NEO4J_CLUSTER_ADVERTISED_ADDRESS
    NEO4J_METRICS_PROMETHEUS_ENABLED
    NEO4J_METRICS_PROMETHEUS_PORT_NUMBER
    NEO4J_BACKUP_ENABLED
    NEO4J_BACKUP_PORT_NUMBER
    NEO4J_BACKUP_ADVERTISED_ADDRESS
)
...
export NEO4J_APOC_IMPORT_FILE_USE_NEO4J_CONFIG="${NEO4J_APOC_IMPORT_FILE_USE_NEO4J_CONFIG:-true}"
...
# Neo4j clustering configuration (Enterprise Edition only)
export NEO4J_CLUSTERING_ENABLED="${NEO4J_CLUSTERING_ENABLED:-false}"
export NEO4J_CLUSTER_DISCOVERY_TYPE="${NEO4J_CLUSTER_DISCOVERY_TYPE:-}"
export NEO4J_CLUSTER_DISCOVERY_ENDPOINTS="${NEO4J_CLUSTER_DISCOVERY_ENDPOINTS:-}"
export NEO4J_CLUSTER_MINIMUM_SIZE="${NEO4J_CLUSTER_MINIMUM_SIZE:-3}"
export NEO4J_CLUSTER_DISCOVERY_LABEL_SELECTOR="${NEO4J_CLUSTER_DISCOVERY_LABEL_SELECTOR:-}"
export NEO4J_CLUSTER_DISCOVERY_SERVICE_PORT_NAME="${NEO4J_CLUSTER_DISCOVERY_SERVICE_PORT_NAME:-tcp-discovery}"
export NEO4J_CLUSTER_DISCOVERY_PORT_NUMBER="${NEO4J_CLUSTER_DISCOVERY_PORT_NUMBER:-5000}"
export NEO4J_CLUSTER_TRANSACTION_PORT_NUMBER="${NEO4J_CLUSTER_TRANSACTION_PORT_NUMBER:-6000}"
export NEO4J_CLUSTER_RAFT_PORT_NUMBER="${NEO4J_CLUSTER_RAFT_PORT_NUMBER:-7000}"
export NEO4J_CLUSTER_ROUTING_PORT_NUMBER="${NEO4J_CLUSTER_ROUTING_PORT_NUMBER:-7688}"
export NEO4J_CLUSTER_ADVERTISED_ADDRESS="${NEO4J_CLUSTER_ADVERTISED_ADDRESS:-}"

# Neo4j metrics configuration
export NEO4J_METRICS_PROMETHEUS_ENABLED="${NEO4J_METRICS_PROMETHEUS_ENABLED:-false}"
export NEO4J_METRICS_PROMETHEUS_PORT_NUMBER="${NEO4J_METRICS_PROMETHEUS_PORT_NUMBER:-2004}"

# Neo4j backup configuration (Enterprise Edition only)
export NEO4J_BACKUP_ENABLED="${NEO4J_BACKUP_ENABLED:-false}"
export NEO4J_BACKUP_PORT_NUMBER="${NEO4J_BACKUP_PORT_NUMBER:-6362}"
export NEO4J_BACKUP_ADVERTISED_ADDRESS="${NEO4J_BACKUP_ADVERTISED_ADDRESS:-}"
