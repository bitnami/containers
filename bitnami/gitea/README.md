...
| `GITEA_HTTP_ADDR`                               | Gitea HTTP listen address                                                                                         | `0.0.0.0`                                                |
...
| `GITEA_REVERSE_PROXY_TRUSTED_PROXIES`           | List of IPs to trust when reading X-Forwarded-* headers.                                                          | `nil`                                                    |
| `GITEA_REVERSE_PROXY_LIMIT`                     | How many reverse‑proxy headers Gitea will trust.                                                                  | `1`                                                      |
