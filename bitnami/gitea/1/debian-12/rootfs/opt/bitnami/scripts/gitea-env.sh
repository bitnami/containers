...
export GITEA_HTTP_ADDR="${GITEA_HTTP_ADDR:-0.0.0.0}"
...
export GITEA_PASSWORD_HASH_ALGO="${GITEA_PASSWORD_HASH_ALGO:-pbkdf2_hi}"
export GITEA_LFS_START_SERVER="${GITEA_LFS_START_SERVER:-false}"
export GITEA_REVERSE_PROXY_TRUSTED_PROXIES="${GITEA_REVERSE_PROXY_TRUSTED_PROXIES:-}"
export GITEA_REVERSE_PROXY_LIMIT="${GITEA_REVERSE_PROXY_LIMIT:-1}"
